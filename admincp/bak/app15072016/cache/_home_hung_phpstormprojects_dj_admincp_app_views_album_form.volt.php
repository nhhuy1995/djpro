                            ...
                            <div>
                                <div class="form-group fg-float">
                                    <label class="radio radio-inline m-r-20">
                                        <input type="radio" value="album" name="type" <?php if ($object['type'] == 'album' || empty($object['type'])) { ?> checked <?php } ?>>
                                        <i class="input-helper"></i>
                                        Album
                                    </label>
                                    <label class="radio radio-inline m-r-20">
                                        <input type="radio" value="playlist" name="type" <?php if ($object['type'] == 'playlist') { ?> checked <?php } ?>>
                                        <i class="input-helper"></i>
                                        Playlist
                                    </label>
                                </div>
