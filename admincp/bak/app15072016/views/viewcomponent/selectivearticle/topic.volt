<div class="container">
    ...
    <div class="card">
        <div class="card-header">
            <h2>Danh sách chọn lọc Chủ đề</h2>
                ...
                <form method="post" action="">
                    ...
                    <div class="tab-content">
                                            ...
                                            {% for newsDetail in slideshow %}
                                                <div class="lv-item media">
                                                    <div class="checkbox pull-left">
                                                        <label>
                                                            <input name="slideshow[]" type="hidden"
                                                                   class="newsIdInSlide"
                        ...
                        <div class="form-group m-t-10">
                            <div class="fg-line">
                                <input type="text" class="form-control newLinkToAdd"
                                       placeholder="Gõ tiêu đề của tin tức vào đây..." onkeyup="getcategory(this);">
                            </div>
                            <div class="suggestion" style="display: none;">
                                <div onclick="$(this).parent().hide()" class="closebtn"><i class="md md-close"></i>
                                </div>
                                <ul id="sugges_data">
                                </ul>
                            </div>
...
<script type="text/javascript">
    ...
    function getcategory(obj) {
        ...
        thread = setTimeout(function () {
            ...
            $('#sugges_data').html('');
            if (q.length) {
                $.get("/incoming/getlistalbum", {q: q,type: type}, function (re) {
                    var data = re.data;
                    if (data.length > 0) {
