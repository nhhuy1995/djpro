    ...
    <div class="card">
        ...
        <div class="card-body card-padding">
            <div role="tabpanel">
                ...
                <input name="_id" value="{{ settingObj['_id'] }}" type="hidden" id="input_menu_id">
                    ...
                    <div id="home11" class="tab-pane active" role="tabpanel">
                        <div class="card-body">
                            <div class="form-group fg-float">
                                <div class="fg-line">
                                    <input type="text" name="name" value="{{ settingObj['name'] }}"
                            ...
                            <div class="form-group fg-float">
                                <div class="fg-line">
                                    <input type="text" name="name" value="{{ settingObj['key'] }}"
                                           class="input-sm form-control fg-input" required id="input_menu_key">
                                </div>
                                <label class="fg-label">Key lưu trữ trong database</label>

                                <div class="m-t-10 pull-right c-red">Key lưu trữ trong database. Suy nghĩ kỹ trước khi
                                    chỉnh sửa
                                </div>
                            </div>
                            ...
                            <div class="form-group fg-float">
                                <div class="fg-line">
                                    <input type="text" name="name" value="{{ settingObj['description'] }}"
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-8 listview ">
                                    ...
                                    <div class="lv-body">
                                        <div class="lv-body">
                                            <ol class="sortable" id="listOfMenuItem" class="lv-item media">
                                                {%- macro addMenuItem(value) %}
                                                    {% if value['catid'] != "" %}
                                                        {% set elemType = 'category' %}
                                                    {% else %}
                                                        {% set elemType = 'link' %}
                                                    {% endif %}
                                                    <li id="menuItem_{{ value['item_id'] }}" class="menu-item-in-list">
                                                        <div class="lv-item media">
                                                            <div class="media-body">
                                                                <div class="lv-title">{{ value['title'] }}</div>
                                                                <div class="lv-actions actions">
                                                                    <a aria-expanded="true" href="javascript:void(0)"
                                                                       onclick="displayPopUpEdit(this)">
                                                        ...
                                                        <span data-type="{{ value['type'] }}"
                                                              data-link="{{ value['link'] }}"
                                                              data-catid="{{ value['cat_id'] }}"
                                                              data-indexmenu="{{ value['item_id'] }}"
                                                              data-title="{{ value['title'] }}"></span>
                                                        {% if value['child'] is defined %}
                                                            <ol>
                                                                {% for subvalue in  value['child'] %}
                                                                    {{ addMenuItem(subvalue) }}
                                                                {% endfor %}
                                                            </ol>
                                                        {% endif %}
                                                    </li>
                                                {%- endmacro %}
                                                {% for item in  settingObj['value'] %}
                                                    {{ addMenuItem(item) }}
                                                {% endfor %}
                                            </ol>
                                        </div>
                                ...
                                <div class="col-sm-4 m-b-25 p-relative" id="toolbarRightTab">
                                    {#<div class="modal-backdrop in p-absolute" id="overLayEdit" style="display: none"></div>#}
                                    <div role="tabpanel">
                                        <ul role="tablist" class="tab-nav" style="overflow: hidden;" tabindex="2"
                                            id="tablistdetail2">
                                            <li class="active">
                                                <a data-toggle="tab" role="tab" aria-controls="addItemTab1"
                                                   href="#addItemLink" aria-expanded="true">
                                                    Add Link
                                                </a>
                                            </li>
                                            <li><a data-toggle="tab" role="tab" aria-controls="addItemCategory"
                                                   href="#addItemCategory">Add Category</a></li>
                                        </ul>
                                        <div class="tab-content">
                                            <div id="addItemLink" class="tab-pane active" role="tabpanel">
                                                <div class="form-group m-t-10">
                                                    <div class="fg-line">
                                                        <input type="text" id="inputTitleCustomLink"
                                                               class="form-control" placeholder="Gõ tiêu đề của link">
                                                    </div>
                                                    <div class="fg-line m-t-5">
                                                        <input type="text" id="inputRealCustomLink" class="form-control"
                                                               placeholder="Nhập đường link">
                                                    </div>
                                                    <input type="hidden" name="menuItemId" id="inputMenuItemId">
                                                    <a id="buttonAddLink" onclick="addCustomLinkMenu(this)"
                                                       href="javascript:void(0)"
                                                       class="btn bgm-teal pull-right m-t-5 waves-effect"> Add link To
                                                        Menu</a>
                                                </div>
                                            </div>
                                            <div id="addItemCategory" class="tab-pane" role="tabpanel">
                                                <div class="form-group m-t-10">
                                                    <div class="fg-line">
                                                        <input type="text" onkeyup="getcategoryToAdd(this);"
                                                               placeholder="Gõ tiêu đề của tin tức vào đây..."
                                                               class="form-control input-name-category">
                                                    </div>
                                                    <div style="display: none; width: 90%;" class="suggestion">
                                                        <div class="closebtn" onclick="$(this).parent().hide()"><i
                                                                    class="md md-close"></i></div>
                                                        <ul class="sugges_data">
                                                        </ul>
                                                    </div>
                                                    <a onclick="addCategoryToMenu(this)" href="javascript:void(0)"
                                                       class="btn bgm-teal pull-right m-t-5 waves-effect"> Add Category
                                                        To Menu</a>
                                                </div>
                                            </div>
                                        </div>
                ...
                <div class="form-group fg-float margin-top-10" style="display: inline;">
                    <a class="btn btn-primary waves-effect" href="javascript:void(0)" onclick="updateMainMenu()">Chấp
                        nhận</a>
                </div>
...
<script type="text/template" id="templateMenuItem">
    <li id="menuItem_<%= indexMenu %>" class="menu-item-in-list">
        ...
        <span data-type="<%= type %>" data-link="<%= link %>" data-catid="<%= catid %>"
              data-indexmenu="<%= indexMenu %>" data-title="<%= title %>"></span>
    </li>
</script>
<script type="text/template" id="popupEditLinkItem">
    <div class="pop-up-edit-item">
        <div class="form-group m-t-10">
            <div class="fg-line">
                <input type="text" placeholder="Gõ tiêu đề của link" class="form-control" id="inputEditTitleLinkItem"
                       value="<%= title %>">
            </div>
            <div class="fg-line m-t-5">
                <input type="text" placeholder="Nhập đường link" class="form-control" id="inputEditUrlLinkItem"
                       value="<%= link %>">
            </div>
...
<script type="text/template" id="popupEditCatItem">
    <div class="pop-up-edit-item">
        <div class="form-group m-t-10">
            <div class="fg-line">
                <input type="text" onkeyup="getcategoryToAdd(this);" placeholder="Gõ tiêu đề của tin tức vào đây..."
                       class="form-control input-name-category" value="<%= title %>">
            </div>
            <div style="display: none; width: 90%;" class="suggestion">
...
//    }
                ...
                $.get("/incoming/getlistcategory", {q: q}, function (re) {
                    ...
                    if (data.length > 0) {
                        data.forEach(function (entry) {
                            var htmlx = '<li onclick="' + callback + '(this)" data-name="' + entry.name + '" data-id="' + entry._id + '">' + entry.name + '<span style="float:right;">Thể loại: '+entry.typeconvert+'</span></li>';
    ...
    function removeMenuItem(obj) {
        $(obj).parents('.menu-item-in-list').first().remove();
    }
