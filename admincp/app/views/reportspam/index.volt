                ...
                <form action="{{ controllink['delete'] }}" method="post" id="mainform">
                    <table id="data-table-selection" class="table table-striped">
                        ...
                        <tr>
                            ...
                            <th data-column-id="medialink">Media</th>
                        ...
                        {% for item in listFeedback %}
                            <tr>
                                ...
                                <td><a href="{{ item['media_link'] }}" target="_blank">{{ item['media_name'] }}</a> <br>
                                <td><a href="{{ item['user_link'] }}" target="_blank">{{ item['username'] }}</a><br>
