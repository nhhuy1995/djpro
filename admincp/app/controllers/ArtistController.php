...
class ArtistController extends ControllerBase
{
    public function indexAction()
    {
        ...
        foreach ($listArtist as $key => $item) {
            $listArtist[$key]['link'] = DOMAIN.Makelink::link_view_artist($item['username'],$item['_id']);
            ...
            if (!$userObj) {
                $listArtist[$key]['usercreate'] = array(
                    "_id" => "",
                ...
                $listArtist[$key]['usercreate'] = array(
                    ...
                    "user_link" => DOMAIN.Makelink::link_view_member($userObj->username,$userObj->getId())
                );
            }
        }
