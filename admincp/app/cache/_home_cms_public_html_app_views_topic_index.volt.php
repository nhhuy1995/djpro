                ...
                <form action="<?php echo $controllink['delete']; ?>" method="post" id="mainform">
                    <table id="data-table-selection" class="table table-striped">
                        ...
                        <tr>
                            ...
                            <th data-column-id="sort">Thông tin</th>
                        ...
                        <?php foreach ($listtopic as $item) { ?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <span style="color: #b3b3ac">Ngày đăng: <?php echo date('d-m-Y | H:i:s', $item['datecreate']); ?></span><br/>

                                    <span style="color: #b3b3ac">Tổng số ca khúc: <?php echo $item['countsong']; ?></span>
                                </td>
                                <td>
                                    <span style="color: #b3b3ac">Lượt nghe: <b style="color: black;"><?php echo $item['view']; ?></b></span><br/>
                                    <span style="color: #b3b3ac">Lượt thích: <b style="color: black;"><?php echo $item['like']; ?></b></span><br/>
                                    <span style="color: #b3b3ac">Vị trí: <b style="color: black;"><?php echo $item['sort']; ?></b></span><br/>
                                </td>
                                ...
                                <td>
                                    <a href="/topic/<?php echo $controllink['update']; ?>&id=<?php echo $item['_id']; ?>">Sửa</a> |
                                    <a href="/topic/<?php echo $controllink['delete']; ?>&id=<?php echo $item['_id']; ?>" class="btndelete">Xóa</a>
                                </td>
                            </tr>
...
<script>
    ...
    function changeStatus(obj) {
        ...
        $.get('/incoming/changestatustopic', {id: id, value: status}, function (re) {
        });
    }
</script>
