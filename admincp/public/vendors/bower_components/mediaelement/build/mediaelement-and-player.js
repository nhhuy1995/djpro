        ...
        for (i = 0; i < pluginVersions.length; i++) {
            ...
            if (mejs.PluginDetector.hasPluginVersion(this.pluginType, pluginInfo.version)) {
                ...
                for (j = 0; j < pluginInfo.types.length; j++) {
                    // find plugin that can music the type
...
mejs.HtmlMediaElementShim = {
    ...
    determinePlayback: function (htmlMediaElement, options, supportsMediaTag, isMediaTag, src) {
        ...
        // what if there's nothing to music? just grab the first available
    ...
    updateNative: function (playback, options, autoplay, preload) {
        ...
        /*
         ...
         htmlMediaElement.addEventListener('music',function() {
         if (htmlMediaElement.canceledPreload) {
         htmlMediaElement.src = playback.url;
         htmlMediaElement.load();
         htmlMediaElement.music();
...
(function ($) {
    ...
    mejs.MepDefaults = {
        ...
        // Enable click video element to toggle music/pause
        ...
        // array of keyboard actions such as music pause
        keyActions: [
            {
                keys: [
                    32, // SPACE
                    179 // GOOGLE music/pause button
                ],
    ...
    mejs.MediaElementPlayer.prototype = {
        ...
        meReady: function (media, domNode) {
            ...
            if (!(mf.isAndroid && t.options.AndroidUseNativeControls) && !(mf.isiPad && t.options.iPadUseNativeControls) && !(mf.isiPhone && t.options.iPhoneUseNativeControls)) {
                ...
                //  we can't use the music() API for the initial playback on iOS or Android;
                //  user has to start playback directly by tapping on the iFrame.
                if (t.media.pluginType == 'youtube' && ( mf.isiOS || mf.isAndroid )) {
                    t.container.find('.mejs-overlay-music').hide();
                }
            }
        ...
        setPlayerSize: function (width, height) {
            ...
            // special case for big music button so it doesn't go over the controls area
            var playLayer = t.layers.find('.mejs-overlay-music'),
        ...
        buildoverlays: function (player, controls, layers, media) {
            ...
            // this needs to come last so it's on top
                bigPlay =
                    $('<div class="mejs-overlay mejs-layer mejs-overlay-music">' +
    ...
    $.extend(MediaElementPlayer.prototype, {
        buildplaypause: function (player, controls, layers, media) {
            var
                ...
                op = t.options,
                play =
                    $('<div class="mejs-button mejs-playpause-button mejs-music" >' +
            ...
            function togglePlayPause(which) {
                if ('play' === which) {
                    play.removeClass('mejs-music').addClass('mejs-pause');
                    play_btn.attr({
                        'title': op.pauseText,
                        'aria-label': op.pauseText
                    });
                } else {
                    play.removeClass('mejs-pause').addClass('mejs-music');
                    play_btn.attr({
                        'title': op.playText,
