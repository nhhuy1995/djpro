...
!function (e, a, t) {
    ...
    var j = "9.9.5", T = !0, I = 0, O = function () {
        var e = 0;
        return function (a, t) {
        ...
        contextActions: {
            ...
            t.on("click", ".modalAV", function (a) {
                ...
                bootbox.confirm(a.attr("data-confirm"), e("#cancel").val(), e("#ok").val(), function (t) {
                    if (1 == t) {
                        w("delete_file", a.attr("data-path"), a.attr("data-thumb"), "", "", "");
                ...
                bootbox.confirm(a.attr("data-confirm"), e("#cancel").val(), e("#ok").val(), function (t) {
                    if (1 == t) {
                        w("delete_folder", a.attr("data-path"), a.attr("data-thumb"), "", "", "");
    ...
    e(document).ready(function () {
        ...
        c = c.toLowerCase();
        var d = "", s = ["ogg", "mp3", "wav"], f = ["mp4", "ogg", "webm"], p = e("#return_relative_url").val(), u = encodeURL((1 == p ? r : o + i) + a);
        ...
        } else e.inArray(c, ext_img) > -1 ? d = '<img src="' + u + '" alt="' + l + '" />' : e.inArray(c, f) > -1 ? d = '<video controls source src="' + u + '" type="video/' + c + '">' + l + "</video>" : e.inArray(c, s) > -1 ? ("mp3" == c && (c = "mpeg"), d = '<audio controls src="' + u + '" type="audio/' + c + '">' + l + "</audio>") : d = '<a href="' + u + '" title="' + l + '">' + l + "</a>", 1 == e("#crossdomain").val() ? n.postMessage({
            sender: "responsivefilemanager",
            url: u,
            field_id: null,
            html: d
        ...
        var c = a.find("a.rename-file"), d = a.find("a.delete-file"), s = c.attr("data-path"), f = c.attr("data-thumb"), p = s.replace(r, t + "." + o), u = f.replace(r, t + "." + o);
        c.attr("data-path", p), c.attr("data-thumb", u), d.attr("data-path", p), d.attr("data-thumb", u)
        ...
        var c = a.find("a.delete-folder"), d = a.find("a.rename-folder"), s = d.attr("data-path"), f = d.attr("data-thumb"), p = s.lastIndexOf("/"), u = s.substr(0, p + 1) + t;
        c.attr("data-path", u), d.attr("data-path", u);
        var p = f.lastIndexOf("/"), u = f.substr(0, p + 1) + t;
