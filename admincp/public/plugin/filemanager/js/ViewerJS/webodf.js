...
function BrowserRuntime(f) {
    ...
    function h(b, r, c) {
        if (0 !== c.status || c.responseText)if (200 === c.status || 0 === c.status) {
            ...
            c = {err: null, data: c}
        } else c = {err: c.responseText || c.statusText, data: null}; else c = {
            err: "File " + b + " is empty.",
            data: null
        };
        return c
...
odf.StyleInfo = function () {
    ...
    var c = odf.Namespaces.chartns, e = odf.Namespaces.dbns, p = odf.Namespaces.dr3dns, g = odf.Namespaces.drawns, x = odf.Namespaces.formns, t = odf.Namespaces.numberns, y = odf.Namespaces.officens, v = odf.Namespaces.presentationns, s = odf.Namespaces.stylens, w = odf.Namespaces.tablens, u = odf.Namespaces.textns, z = {
        ...
        text: [{ens: s, en: "tab-stop", ans: s, a: "leader-text-style"}, {
            ens: s,
            en: "drop-cap",
            ans: s,
            a: "style-name"
        ...
        paragraph: [{ens: g, en: "caption", ans: g, a: "text-style-name"}, {
            ...
            {ens: g, en: "rect", ans: g, a: "text-style-name"}, {
                ...
                ans: g,
                a: "text-style-name"
            }, {ens: y, en: "annotation", ans: g, a: "text-style-name"}, {
                ens: x,
                en: "column",
                ans: x,
                a: "text-style-name"
        ...
        chart: [{
            ...
            ans: c,
            a: "style-name"
        }, {ens: c, en: "floor", ans: c, a: "style-name"}, {ens: c, en: "footer", ans: c, a: "style-name"}, {
            ens: c,
            en: "grid",
            ans: c,
            a: "style-name"
            ...
            ans: c,
            a: "style-name"
        }, {ens: c, en: "subtitle", ans: c, a: "style-name"}, {ens: c, en: "title", ans: c, a: "style-name"}, {
            ens: c,
            en: "wall",
            ans: c,
            a: "style-name"
        ...
        graphic: [{ens: p, en: "cube", ans: g, a: "style-name"}, {
            ens: p,
            en: "extrude",
            ans: g,
            a: "style-name"
        }, {ens: p, en: "rotate", ans: g, a: "style-name"}, {ens: p, en: "scene", ans: g, a: "style-name"}, {
            ens: p,
            en: "sphere",
            ans: g,
            a: "style-name"
        }, {ens: g, en: "caption", ans: g, a: "style-name"}, {ens: g, en: "circle", ans: g, a: "style-name"}, {
            ens: g,
            en: "connector",
            ans: g,
            a: "style-name"
            ...
            {ens: g, en: "frame", ans: g, a: "style-name"}, {ens: g, en: "g", ans: g, a: "style-name"}, {
                ens: g,
                en: "line",
                ans: g,
                a: "style-name"
                ...
                ans: g,
                a: "style-name"
            }, {ens: g, en: "path", ans: g, a: "style-name"}, {ens: g, en: "polygon", ans: g, a: "style-name"}, {
                ens: g,
                en: "polyline",
                ans: g,
                a: "style-name"
        ...
        presentation: [{
            ens: p, en: "cube", ans: v,
            a: "style-name"
        }, {ens: p, en: "extrude", ans: v, a: "style-name"}, {ens: p, en: "rotate", ans: v, a: "style-name"}, {
            ens: p,
            en: "scene",
            ans: v,
            a: "style-name"
        }, {ens: p, en: "sphere", ans: v, a: "style-name"}, {ens: g, en: "caption", ans: v, a: "style-name"}, {
            ens: g,
            en: "circle",
            ans: v,
            a: "style-name"
        }, {ens: g, en: "connector", ans: v, a: "style-name"}, {
            ens: g,
            en: "control",
            ans: v,
            a: "style-name"
        }, {ens: g, en: "custom-shape", ans: v, a: "style-name"}, {
            ens: g,
            en: "ellipse",
            ans: v,
            a: "style-name"
        }, {ens: g, en: "frame", ans: v, a: "style-name"}, {ens: g, en: "g", ans: v, a: "style-name"},
            {ens: g, en: "line", ans: v, a: "style-name"}, {ens: g, en: "measure", ans: v, a: "style-name"}, {
                ...
                ans: v,
                a: "style-name"
            }, {ens: g, en: "rect", ans: v, a: "style-name"}, {
                ens: g,
                en: "regular-polygon",
                ans: v,
                a: "style-name"
            }, {ens: y, en: "annotation", ans: v, a: "style-name"}],
        "drawing-page": [{ens: g, en: "page", ans: g, a: "style-name"}, {
            ens: v,
            en: "notes",
            ans: g,
            a: "style-name"
        ...
        "list-style": [{ens: u, en: "list", ans: u, a: "style-name"}, {
            ...
            ans: u,
            a: "style-name"
        }, {ens: u, en: "list-item", ans: u, a: "style-override"}, {ens: s, en: "style", ans: s, a: "list-style-name"}],
        data: [{ens: s, en: "style", ans: s, a: "data-style-name"}, {
            ens: s,
            en: "style",
            ans: s,
            a: "percentage-data-style-name"
        }, {ens: v, en: "date-time-decl", ans: s, a: "data-style-name"}, {
            ens: u,
            en: "creation-date",
            ans: s,
            a: "data-style-name"
        ...
        }, {ens: u, en: "database-display", ans: s, a: "data-style-name"}, {
            ens: u,
            en: "date",
            ans: s,
            a: "data-style-name"
        }, {ens: u, en: "editing-duration", ans: s, a: "data-style-name"}, {
            ens: u,
            en: "expression",
            ans: s,
            a: "data-style-name"
        }, {ens: u, en: "meta-field", ans: s, a: "data-style-name"}, {
            ens: u,
            en: "modification-date",
            ans: s,
            a: "data-style-name"
        }, {ens: u, en: "modification-time", ans: s, a: "data-style-name"}, {
            ens: u,
            en: "print-date",
            ans: s,
            a: "data-style-name"
        }, {ens: u, en: "print-time", ans: s, a: "data-style-name"}, {
            ens: u,
            en: "table-formula", ans: s, a: "data-style-name"
        }, {ens: u, en: "time", ans: s, a: "data-style-name"}, {
            ens: u,
            en: "user-defined",
            ans: s,
            a: "data-style-name"
        }, {ens: u, en: "user-field-get", ans: s, a: "data-style-name"}, {
            ens: u,
            en: "user-field-input",
            ans: s,
            a: "data-style-name"
        }, {ens: u, en: "variable-get", ans: s, a: "data-style-name"}, {
            ens: u,
            en: "variable-input",
            ans: s,
            a: "data-style-name"
    ...
    odf.OdfContainer = function c(e, f) {
        ...
        e === odf.OdfContainer.DocumentType.TEXT ? X = V("text") : e === odf.OdfContainer.DocumentType.TEXT_TEMPLATE ? X = V("text", !0) : e === odf.OdfContainer.DocumentType.PRESENTATION ? X = V("presentation") : e === odf.OdfContainer.DocumentType.PRESENTATION_TEMPLATE ? X = V("presentation", !0) : e === odf.OdfContainer.DocumentType.SPREADSHEET ? X = V("spreadsheet") :
            e === odf.OdfContainer.DocumentType.SPREADSHEET_TEMPLATE ? X = V("spreadsheet", !0) : (S = e, X = new core.Zip(S, function (a, b) {
                ...
                a ? $(S, function (b) {
                    a && (X.error = a + "\n" + b, z(c.INVALID))
                }) : T([{path: "styles.xml", handler: C}, {path: "content.xml", handler: D}, {
                    path: "meta.xml",
                    handler: I
                }, {path: "settings.xml", handler: N}, {path: "META-INF/manifest.xml", handler: K}])
            }))
    };
...
odf.StepUtils = function () {
    this.getContentBounds = function (f) {
        ...
        k && (k.nodeType === Node.TEXT_NODE ? (runtime.assert(0 < a, "Empty text node found"), d = {
            ...
            startOffset: a - 1,
            endOffset: a
        }) : d = {container: k, startOffset: 0, endOffset: k.childNodes.length});
        return d
    }
};
...
gui.AnnotationController = function (f, k, a) {
    ...
    this.removeAnnotation = function (b) {
        ...
        if (!0 !== k.getState(gui.CommonConstraints.EDIT.ANNOTATIONS.ONLY_DELETE_OWN) || d === r.getAnnotationCreator(b))d = q.convertDomPointToCursorStep(b, 0, c), g = q.convertDomPointToCursorStep(b, b.childNodes.length), b = new ops.OpRemoveAnnotation,
            b.init({memberid: a, position: d, length: g - d}), g = new ops.OpMoveCursor, g.init({
            memberid: a,
            position: 0 < d ? d - 1 : d,
            length: 0
        }), f.enqueue([b, g])
...
gui.DirectFormattingController = function (f, k, a, d, b, h, n) {
    ...
    function r() {
        var b = J.getCursor(d), c = b && b.getSelectedRange(), e = [], e = [], g = !0, f = {
            directTextStyling: !0,
        ...
        if (e !== q.None) {
            ...
            switch (e) {
                case q.Ctrl:
                    ...
                    break;
                case q.Meta:
                    p.push({keyCode: m.LeftMeta, modifier: q.None}), p.push({
                        keyCode: m.RightMeta,
                        modifier: q.None
                    }), p.push({keyCode: m.MetaInMozilla, modifier: q.None})
            }
...
gui.EventManager = function (f) {
    ...
    var s = runtime.getWindow(), w = {
        beforecut: !0,
        beforepaste: !0,
        longpress: !0,
        drag: !0,
        dragstop: !0
    }, u = {mousedown: !0, mouseup: !0, focus: !0}, z = {}, H = {}, C, D = f.getCanvas().getElement(), I = this, N = {};
    ...
    function m() {
        ...
        if (c = H && f.getSelectionType() === ops.OdtCursor.RangeSelection && !a.collapsed) {
            ...
            if (a) {
                ...
                h = x.top + x.height;
                w = [{x: m.left, y: e + m.height}, {x: m.left, y: e}, {x: r, y: e}, {
                    x: r,
                    y: h - x.height
                }, {x: x.right, y: h - x.height}, {x: x.right, y: h}, {x: w, y: h}, {x: w, y: e + m.height}, {
                    x: m.left,
                    y: e + m.height
                }];
                r = "";
