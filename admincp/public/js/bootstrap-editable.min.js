/**
 * Created by HoangHuy on 7/31/2015.
 */
/*! X-editable - v1.5.0
...
!function (a) {
    ...
    a.extend(a.fn.editableform.Constructor.prototype, {
        initTemplate: function () {
            ...
            b.apply(this);
            var c = null === this.input.options.inputclass || this.input.options.inputclass === !1, d = "input-sm2", e = "text,select,textarea,password,email,url,tel,number,range,time,typeaheadjs".split(",");
    ...
    }), a.fn.editableform.buttons = '<button type="submit" class="btn btn-primary btn-sm editable-submit"><i class="md md-check"></i></button><button type="button" class="btn btn-default btn-sm editable-cancel"><i class="md md-close" ></i></button>', a.fn.editableform.errorGroupClass = "has-error", a.fn.editableform.errorBlockClass = null, a.fn.editableform.engine = "bs3"
}(window.jQuery), function (a) {
    "use strict";
