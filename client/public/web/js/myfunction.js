...
function likeArticle(obj) {
    ...
    $.get("/incoming/likearticle", {atid: atid, checklike: checklike, type: type}, function (re) {
        if (re.status == 200) {
            if (type == 'news' || type == 'images') $('.boutlike').html('<i class="fa fa-thumbs-up" id="icon-like"></i><a href="javascript:void(0)" id="total_likeordislike" onclick="listUserLikeAndDislike(this)" data-type="like" data-articletype="' + type + '" data-id="' + atid + '">' + re.boutlike + '</a>');
            else $('.boutlike').html('<i class="fa fa-thumbs-up"></i> Thích: <a href="javascript:void(0)" id="total_likeordislike" onclick="listUserLikeAndDislike(this)" data-type="like" data-articletype="' + type + '" data-id="' + atid + '">' + re.boutlike + '</a>');
            if (checklike == 0) {
                $(obj).attr('checklike', 1);
...
function dislikeArticle(obj) {
    ...
    $.get("/incoming/dislikearticle", {atid: atid, checklike: checklike, type: type}, function (re) {
        if (re.status == 200) {
            if (type == 'news' || type == 'images') $('.boutdislike').html('<i class="fa fa-thumbs-down" id="icon-like"></i><a href="javascript:void(0)" id="total_likeordislike" onclick="listUserLikeAndDislike(this)" data-type="dislike" data-articletype="' + type + '" data-id="' + atid + '">' + re.boutdislike + '</a>');
            else $('.boutdislike').html('<i class="fa fa-thumbs-down"></i> Không thích: <a href="javascript:void(0)" id="total_likeordislike" onclick="listUserLikeAndDislike(this)" data-type="dislike" data-articletype="' + type + '" data-id="' + atid + '">' + re.boutdislike + '</a>');
