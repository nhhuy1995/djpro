...
!function (a, b) {
    ...
    a.jPlayer.keys = function (b) {
        ...
        NO_SUPPORT: "It is not possible to music any media format provided in setMedia() on this browser using your current options.",
