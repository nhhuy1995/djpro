            ...
            <?php foreach ($listCategory_footer as $item) { ?>
                <div class="col-md-2 col-sm-3 col-xs-6">
                    <ul class="list1">
                        ...
                        <?php if (isset($item['child'])) { ?>
                            <?php $v71428743598780787752iterator = $item['child']; $v71428743598780787752incr = 0; $v71428743598780787752loop = new stdClass(); $v71428743598780787752loop->length = count($v71428743598780787752iterator); $v71428743598780787752loop->index = 1; $v71428743598780787752loop->index0 = 1; $v71428743598780787752loop->revindex = $v71428743598780787752loop->length; $v71428743598780787752loop->revindex0 = $v71428743598780787752loop->length - 1; ?><?php foreach ($v71428743598780787752iterator as $child) { ?><?php $v71428743598780787752loop->first = ($v71428743598780787752incr == 0); $v71428743598780787752loop->index = $v71428743598780787752incr + 1; $v71428743598780787752loop->index0 = $v71428743598780787752incr; $v71428743598780787752loop->revindex = $v71428743598780787752loop->length - $v71428743598780787752incr; $v71428743598780787752loop->revindex0 = $v71428743598780787752loop->length - ($v71428743598780787752incr + 1); $v71428743598780787752loop->last = ($v71428743598780787752incr == ($v71428743598780787752loop->length - 1)); ?>
