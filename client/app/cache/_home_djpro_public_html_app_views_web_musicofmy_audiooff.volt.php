                    ...
                    <div class="tabs tabs-style-linemove">
                        <nav>
                            <ul>
                                ...
                                <li class="tab-current"><a href="/nhac-cho-duyet.html?t=audio" class="icon icon-baihat"><span>Bài hát đã đăng</span></a>
                                </li>
...
<footer>
    <div class="container">
        <div class="row">
            <?php $v47685165227103242891iterator = $listCategory_footer; $v47685165227103242891incr = 0; $v47685165227103242891loop = new stdClass(); $v47685165227103242891loop->length = count($v47685165227103242891iterator); $v47685165227103242891loop->index = 1; $v47685165227103242891loop->index0 = 1; $v47685165227103242891loop->revindex = $v47685165227103242891loop->length; $v47685165227103242891loop->revindex0 = $v47685165227103242891loop->length - 1; ?><?php foreach ($v47685165227103242891iterator as $index => $itemFooterMenu) { ?><?php $v47685165227103242891loop->first = ($v47685165227103242891incr == 0); $v47685165227103242891loop->index = $v47685165227103242891incr + 1; $v47685165227103242891loop->index0 = $v47685165227103242891incr; $v47685165227103242891loop->revindex = $v47685165227103242891loop->length - $v47685165227103242891incr; $v47685165227103242891loop->revindex0 = $v47685165227103242891loop->length - ($v47685165227103242891incr + 1); $v47685165227103242891loop->last = ($v47685165227103242891incr == ($v47685165227103242891loop->length - 1)); ?>
                <?php if ($index % 5 == 0) { ?>
                    <div class="col-md-2 col-sm-3 col-xs-6">
                    <ul class="list1">
                <?php } ?>
                <li><a href="<?php echo $itemFooterMenu['link']; ?>"><?php echo $itemFooterMenu['title']; ?></a></li>
                <?php if ($index % 5 == 4 || $v47685165227103242891loop->last) { ?>
                    </ul>
                    </div>
                <?php } ?>
            <?php $v47685165227103242891incr++; } ?>
