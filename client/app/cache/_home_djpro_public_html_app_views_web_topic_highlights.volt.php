            ...
            <?php foreach ($listCategory_footer as $item) { ?>
                <div class="col-md-2 col-sm-3 col-xs-6">
                    <ul class="list1">
                        ...
                        <?php if (isset($item['child'])) { ?>
                            <?php $v75404789645406915222iterator = $item['child']; $v75404789645406915222incr = 0; $v75404789645406915222loop = new stdClass(); $v75404789645406915222loop->length = count($v75404789645406915222iterator); $v75404789645406915222loop->index = 1; $v75404789645406915222loop->index0 = 1; $v75404789645406915222loop->revindex = $v75404789645406915222loop->length; $v75404789645406915222loop->revindex0 = $v75404789645406915222loop->length - 1; ?><?php foreach ($v75404789645406915222iterator as $child) { ?><?php $v75404789645406915222loop->first = ($v75404789645406915222incr == 0); $v75404789645406915222loop->index = $v75404789645406915222incr + 1; $v75404789645406915222loop->index0 = $v75404789645406915222incr; $v75404789645406915222loop->revindex = $v75404789645406915222loop->length - $v75404789645406915222incr; $v75404789645406915222loop->revindex0 = $v75404789645406915222loop->length - ($v75404789645406915222incr + 1); $v75404789645406915222loop->last = ($v75404789645406915222incr == ($v75404789645406915222loop->length - 1)); ?>
