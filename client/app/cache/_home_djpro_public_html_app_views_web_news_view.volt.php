                                        ...
                                        <li>
                                            ...
                                            <i class="fa fa-thumbs-down"
                                               id="icon-dislike" <?php if ($check_dislike->_id) { ?> style="color: blue;" <?php } ?>></i>
                                                 <a href="javascript:void(0)" id="total_likeordislike" onclick="listUserLikeAndDislike(this)" data-type="dislike" data-articletype="<?php echo $object->type; ?>" data-id="<?php echo $object->_id; ?>"><?php echo $object->dislike; ?></a>
                                                 </span>
                                ...
                                <?php } else { ?>
                                    <ul class="media-func">
                                        ...
                                        <li class="main-nav">
                                            ...
                                            <a href="javascript:void(0)" id="total_likeordislike"><?php echo $object->like; ?></a>
                                            <a class="cd-signin" href="javascript:void(0)">Thích </a>
                                        </li>
                                        <li class="main-nav">
                                            <i class="fa fa-thumbs-down"></i>
                                            <a href="javascript:void(0)" id="total_likeordislike"><?php echo $object->dislike; ?></a>
