...
<footer>
    <div class="container">
        <div class="row">
            <?php $v138154369230716905851iterator = $listCategory_footer; $v138154369230716905851incr = 0; $v138154369230716905851loop = new stdClass(); $v138154369230716905851loop->length = count($v138154369230716905851iterator); $v138154369230716905851loop->index = 1; $v138154369230716905851loop->index0 = 1; $v138154369230716905851loop->revindex = $v138154369230716905851loop->length; $v138154369230716905851loop->revindex0 = $v138154369230716905851loop->length - 1; ?><?php foreach ($v138154369230716905851iterator as $index => $itemFooterMenu) { ?><?php $v138154369230716905851loop->first = ($v138154369230716905851incr == 0); $v138154369230716905851loop->index = $v138154369230716905851incr + 1; $v138154369230716905851loop->index0 = $v138154369230716905851incr; $v138154369230716905851loop->revindex = $v138154369230716905851loop->length - $v138154369230716905851incr; $v138154369230716905851loop->revindex0 = $v138154369230716905851loop->length - ($v138154369230716905851incr + 1); $v138154369230716905851loop->last = ($v138154369230716905851incr == ($v138154369230716905851loop->length - 1)); ?>
                <?php if ($index % 5 == 0) { ?>
                    <div class="col-md-2 col-sm-3 col-xs-6">
                    <ul class="list1">
                <?php } ?>
                <li><a href="<?php echo $itemFooterMenu['link']; ?>"><?php echo $itemFooterMenu['title']; ?></a></li>
                <?php if ($index % 5 == 4 || $v138154369230716905851loop->last) { ?>
                    </ul>
                    </div>
                <?php } ?>
            <?php $v138154369230716905851incr++; } ?>
