            ...
            <?php foreach ($listCategory_footer as $item) { ?>
                <div class="col-md-2 col-sm-3 col-xs-6">
                    <ul class="list1">
                        ...
                        <?php if (isset($item['child'])) { ?>
                            <?php $v85857190467494573712iterator = $item['child']; $v85857190467494573712incr = 0; $v85857190467494573712loop = new stdClass(); $v85857190467494573712loop->length = count($v85857190467494573712iterator); $v85857190467494573712loop->index = 1; $v85857190467494573712loop->index0 = 1; $v85857190467494573712loop->revindex = $v85857190467494573712loop->length; $v85857190467494573712loop->revindex0 = $v85857190467494573712loop->length - 1; ?><?php foreach ($v85857190467494573712iterator as $child) { ?><?php $v85857190467494573712loop->first = ($v85857190467494573712incr == 0); $v85857190467494573712loop->index = $v85857190467494573712incr + 1; $v85857190467494573712loop->index0 = $v85857190467494573712incr; $v85857190467494573712loop->revindex = $v85857190467494573712loop->length - $v85857190467494573712incr; $v85857190467494573712loop->revindex0 = $v85857190467494573712loop->length - ($v85857190467494573712incr + 1); $v85857190467494573712loop->last = ($v85857190467494573712incr == ($v85857190467494573712loop->length - 1)); ?>
