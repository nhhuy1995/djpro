...
<div id="content">
                    ...
                    <div class="tabs tabs-style-linemove">
                        <nav>
                            <ul>
                                ...
                                <li class="tab-current"><a href="/nhac-da-xoa.html?t=playlist"
    ...
    <?php $v84350118423834582651iterator = $item['listartist']; $v84350118423834582651incr = 0; $v84350118423834582651loop = new stdClass(); $v84350118423834582651loop->length = count($v84350118423834582651iterator); $v84350118423834582651loop->index = 1; $v84350118423834582651loop->index0 = 1; $v84350118423834582651loop->revindex = $v84350118423834582651loop->length; $v84350118423834582651loop->revindex0 = $v84350118423834582651loop->length - 1; ?><?php foreach ($v84350118423834582651iterator as $itemchild) { ?><?php $v84350118423834582651loop->first = ($v84350118423834582651incr == 0); $v84350118423834582651loop->index = $v84350118423834582651incr + 1; $v84350118423834582651loop->index0 = $v84350118423834582651incr; $v84350118423834582651loop->revindex = $v84350118423834582651loop->length - $v84350118423834582651incr; $v84350118423834582651loop->revindex0 = $v84350118423834582651loop->length - ($v84350118423834582651incr + 1); $v84350118423834582651loop->last = ($v84350118423834582651incr == ($v84350118423834582651loop->length - 1)); ?>
    <a class="subtitle" href="<?php echo $itemchild['link']; ?>"
       title="<?php echo $itemchild['username']; ?>"><?php echo $itemchild['username']; ?></a><?php if (!$v84350118423834582651loop->last) { ?><span class="bull" style="font-size:12px;">Ft </span><?php } ?>
    <?php $v84350118423834582651incr++; } ?>
...
<footer>
    <div class="container">
        <div class="row">
            <?php $v84350118423834582651iterator = $listCategory_footer; $v84350118423834582651incr = 0; $v84350118423834582651loop = new stdClass(); $v84350118423834582651loop->length = count($v84350118423834582651iterator); $v84350118423834582651loop->index = 1; $v84350118423834582651loop->index0 = 1; $v84350118423834582651loop->revindex = $v84350118423834582651loop->length; $v84350118423834582651loop->revindex0 = $v84350118423834582651loop->length - 1; ?><?php foreach ($v84350118423834582651iterator as $index => $itemFooterMenu) { ?><?php $v84350118423834582651loop->first = ($v84350118423834582651incr == 0); $v84350118423834582651loop->index = $v84350118423834582651incr + 1; $v84350118423834582651loop->index0 = $v84350118423834582651incr; $v84350118423834582651loop->revindex = $v84350118423834582651loop->length - $v84350118423834582651incr; $v84350118423834582651loop->revindex0 = $v84350118423834582651loop->length - ($v84350118423834582651incr + 1); $v84350118423834582651loop->last = ($v84350118423834582651incr == ($v84350118423834582651loop->length - 1)); ?>
                <?php if ($index % 5 == 0) { ?>
                    <div class="col-md-2 col-sm-3 col-xs-6">
                    <ul class="list1">
                <?php } ?>
                <li><a href="<?php echo $itemFooterMenu['link']; ?>"><?php echo $itemFooterMenu['title']; ?></a></li>
                <?php if ($index % 5 == 4 || $v84350118423834582651loop->last) { ?>
                    </ul>
                    </div>
                <?php } ?>
            <?php $v84350118423834582651incr++; } ?>
