                    ...
                    <div class="tabs tabs-style-iconbox">
                        <nav>
                            <ul>
                                ...
                                <li class="{% if _GET['t'] == 'topic' %} tab-current {% endif %}"><a href="/top100.html?t=topic" class="icon icon-chude"><span>Chủ đề</span></a>
                                </li>
                                <li class="{% if _GET['t'] == 'album' %} tab-current {% endif %}"><a href="/top100.html?t=album" class="icon icon-album"><span>Album</span></a>
                                </li>
                                <li class="{% if _GET['t'] == 'playlist' %} tab-current {% endif %}"><a href="/top100.html?t=playlist" class="icon icon-playlist"><span>Playlist</span></a>
                            </ul>
                        </nav>
