                        ...
                        <nav>
                            <ul>
                                <li class=""><a href="/bai-hat-de-cu.html" class="icon icon-baihat"><span>Bài hát</span></a>
                                 ...
                                 <li class=""><a href="/t/bai-hat-de-cu.html" class="icon icon-chude"><span>Chủ đề</span></a></li>
                                 <li class=""><a href="/a/bai-hat-de-cu.html" class="icon icon-album"><span>Album</span></a></li>
                                 <li class="tab-current"><a href="/p/bai-hat-de-cu.html" class="icon icon-playlist"><span>Playlist</span></a></li>
                            </ul>
                        </nav>
                        <div class="content-wrap">
                            {% if listPlaylist|length ==1 %} {%  set cl_listPlaylist = 'style="height:200px"' %} {% endif %}
                            <section id="section-linemove-5" {{ cl_listPlaylist }} class="content-current">
