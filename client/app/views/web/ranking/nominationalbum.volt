                    ...
                    <div class="tabs tabs-style-iconbox">
                        <nav>
                            <ul>
                                ...
                                <li class="{% if _GET['t'] == 'topic' %} tab-current {% endif %}"><a href="/bai-hat-de-cu.html?t=topic" class="icon icon-chude"><span>Chủ đề</span></a></li>
                                <li class="{% if _GET['t'] == 'album' %} tab-current {% endif %}"><a href="/bai-hat-de-cu.html?t=album" class="icon icon-album"><span>Album</span></a></li>
                                <li class="{% if _GET['t'] == 'playlist' %} tab-current {% endif %}"><a href="/bai-hat-de-cu.html?t=playlist" class="icon icon-playlist"><span>Playlist</span></a></li>
                            </ul>
                        </nav>
                        <div class="content-wrap">
                            {% if listAlbum|length ==1 %} {%  set cl_listAlbum = 'style="height:200px"' %} {% endif %}
                            <section id="section-linemove-4" {{ cl_listAlbum }} class="content-current">
                                ...
                                <article class="chart-row {{ cl }}">
                                    <div class="row-primary">
                                        ...
                                        <div class="row-title">
                                            ...
                                            <span><i class="fa fa-headphones"></i> {{ item['nomination'] }} </span>
                                        </div>
