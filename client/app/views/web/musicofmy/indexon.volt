                    ...
                    <div class="tabs tabs-style-linemove">
                        ...
                        <div class="content-wrap">
                            <section id="section-linemove-1" class="content-current">
                                <div class="td_heading"><h2><span class="while"><a href="/nhac-da-duyet.html?t=audio">Bài hát</a> (<span id="clkeyword">{{ countaudio }}</span>)<i class="fa fa-angle-right"></i></span>
                                    </h2></div>
                                ...
                                {% else %}
                                    <p>Chưa cập nhật!</p>
                                {% endif %}
                                <div class="td_heading"><h2><span class="while"><a href="/nhac-da-duyet.html?t=video">Video</a> (<span id="clkeyword">{{ countvideo }}</span>)<i
                                                    class="fa fa-angle-right"></i></span></h2></div>
                                {% if listvideo %}
                                    <div class="row">
