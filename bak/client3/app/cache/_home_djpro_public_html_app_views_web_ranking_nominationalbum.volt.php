            ...
            <?php foreach ($listCategory_footer as $item) { ?>
                <div class="col-md-2 col-sm-3 col-xs-6">
                    <ul class="list1">
                        ...
                        <?php if (isset($item['child'])) { ?>
                            <?php $v161596847346962149272iterator = $item['child']; $v161596847346962149272incr = 0; $v161596847346962149272loop = new stdClass(); $v161596847346962149272loop->length = count($v161596847346962149272iterator); $v161596847346962149272loop->index = 1; $v161596847346962149272loop->index0 = 1; $v161596847346962149272loop->revindex = $v161596847346962149272loop->length; $v161596847346962149272loop->revindex0 = $v161596847346962149272loop->length - 1; ?><?php foreach ($v161596847346962149272iterator as $child) { ?><?php $v161596847346962149272loop->first = ($v161596847346962149272incr == 0); $v161596847346962149272loop->index = $v161596847346962149272incr + 1; $v161596847346962149272loop->index0 = $v161596847346962149272incr; $v161596847346962149272loop->revindex = $v161596847346962149272loop->length - $v161596847346962149272incr; $v161596847346962149272loop->revindex0 = $v161596847346962149272loop->length - ($v161596847346962149272incr + 1); $v161596847346962149272loop->last = ($v161596847346962149272incr == ($v161596847346962149272loop->length - 1)); ?>
