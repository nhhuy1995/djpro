            ...
            <?php foreach ($listCategory_footer as $item) { ?>
                <div class="col-md-2 col-sm-3 col-xs-6">
                    <ul class="list1">
                        ...
                        <?php if (isset($item['child'])) { ?>
                            <?php $v71749004176205111332iterator = $item['child']; $v71749004176205111332incr = 0; $v71749004176205111332loop = new stdClass(); $v71749004176205111332loop->length = count($v71749004176205111332iterator); $v71749004176205111332loop->index = 1; $v71749004176205111332loop->index0 = 1; $v71749004176205111332loop->revindex = $v71749004176205111332loop->length; $v71749004176205111332loop->revindex0 = $v71749004176205111332loop->length - 1; ?><?php foreach ($v71749004176205111332iterator as $child) { ?><?php $v71749004176205111332loop->first = ($v71749004176205111332incr == 0); $v71749004176205111332loop->index = $v71749004176205111332incr + 1; $v71749004176205111332loop->index0 = $v71749004176205111332incr; $v71749004176205111332loop->revindex = $v71749004176205111332loop->length - $v71749004176205111332incr; $v71749004176205111332loop->revindex0 = $v71749004176205111332loop->length - ($v71749004176205111332incr + 1); $v71749004176205111332loop->last = ($v71749004176205111332incr == ($v71749004176205111332loop->length - 1)); ?>
