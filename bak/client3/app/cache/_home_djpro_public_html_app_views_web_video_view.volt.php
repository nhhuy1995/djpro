                                ...
                                <div class="info-pd-top">
                                    <p>
                                        ...
                                        <?php } else { ?>
                                            ...
                                            <i class="fa fa-thumbs-up"></i> Thích:
                                            <a href="javascript:void(0)" class="cd-signin" id="total_likeordislike"><?php echo $object->like; ?></a>
                                            </span>
                                            <span class="boutdislike main-nav" style="color: white;">
                                            <i class="fa fa-thumbs-down"></i> Không
                                            thích: <a href="javascript:void(0)" class="cd-signin" id="total_likeordislike"><?php echo $object->dislike; ?></a>
                                        </span>
                                        <?php } ?>
            ...
            <div class="modal-body">
                <div style="height:300px">
                    <div class="nano">
                        <div class="content">
                            <ul class="down-app">
                                <p>Click vào 1 trong các liên kết bên dưới để Download về máy Video: <strong>Nonstop - Trăm Năm Kiều Vẫn Là Kiều - Nên Lần Đầu Khó Là Điều Tất Nhiên</strong></p>
                                <?php if ($object->link_video_1080) { ?>
                                    <li><a href="javascript:void(0)" onclick="downloadMedia(this)" data-id="<?php echo $object->_id; ?>" data-quality="link_video_1080">1080p</a></li>
                                <?php } ?>
                                <?php if ($object->link_video_720) { ?>
                                    <li><a href="javascript:void(0)" onclick="downloadMedia(this)" data-id="<?php echo $object->_id; ?>" data-quality="link_video_720">720p</a></li>
                                <?php } ?>
                                <?php if ($object->link_video_480) { ?>
                                    <li><a href="javascript:void(0)" onclick="downloadMedia(this)" data-id="<?php echo $object->_id; ?>" data-quality="link_video_480">480p</a></li>
                                <?php } ?>
                                <?php if ($object->link_video_360) { ?>
                                    <li><a href="javascript:void(0)" onclick="downloadMedia(this)" data-id="<?php echo $object->_id; ?>" data-quality="link_video_360">360p</a></li>
                                <?php } ?>
                                <?php if ($object->link_video_240) { ?>
                                    <li><a href="javascript:void(0)" onclick="downloadMedia(this)" data-id="<?php echo $object->_id; ?>" data-quality="link_video_240">240p</a></li>
                                <?php } ?>
                                <?php if ($object->link_video_144) { ?>
                                    <li><a href="javascript:void(0)" onclick="downloadMedia(this)" data-id="<?php echo $object->_id; ?>" data-quality="link_video_144">144</a></li>
                                <?php } ?>
                            </ul>
                        </div>
                    </div>
