...
<div id="content">
                    ...
                    <div class="tabs tabs-style-linemove">
                        <nav>
                            <ul>
                                ...
                                <li class="tab-current"><a href="/nhac-da-xoa.html?t=video"
    ...
    <?php $v165689508269435014061iterator = $item['listartist']; $v165689508269435014061incr = 0; $v165689508269435014061loop = new stdClass(); $v165689508269435014061loop->length = count($v165689508269435014061iterator); $v165689508269435014061loop->index = 1; $v165689508269435014061loop->index0 = 1; $v165689508269435014061loop->revindex = $v165689508269435014061loop->length; $v165689508269435014061loop->revindex0 = $v165689508269435014061loop->length - 1; ?><?php foreach ($v165689508269435014061iterator as $itemchild) { ?><?php $v165689508269435014061loop->first = ($v165689508269435014061incr == 0); $v165689508269435014061loop->index = $v165689508269435014061incr + 1; $v165689508269435014061loop->index0 = $v165689508269435014061incr; $v165689508269435014061loop->revindex = $v165689508269435014061loop->length - $v165689508269435014061incr; $v165689508269435014061loop->revindex0 = $v165689508269435014061loop->length - ($v165689508269435014061incr + 1); $v165689508269435014061loop->last = ($v165689508269435014061incr == ($v165689508269435014061loop->length - 1)); ?>
    <a class="subtitle" href="<?php echo $itemchild['link']; ?>"
       title="<?php echo $itemchild['username']; ?>"><?php echo $itemchild['username']; ?></a><?php if (!$v165689508269435014061loop->last) { ?><span class="bull" style="font-size:12px;">Ft </span><?php } ?>
    <?php $v165689508269435014061incr++; } ?>
...
<footer>
    <div class="container">
        <div class="row">
            <?php $v165689508269435014061iterator = $listCategory_footer; $v165689508269435014061incr = 0; $v165689508269435014061loop = new stdClass(); $v165689508269435014061loop->length = count($v165689508269435014061iterator); $v165689508269435014061loop->index = 1; $v165689508269435014061loop->index0 = 1; $v165689508269435014061loop->revindex = $v165689508269435014061loop->length; $v165689508269435014061loop->revindex0 = $v165689508269435014061loop->length - 1; ?><?php foreach ($v165689508269435014061iterator as $index => $itemFooterMenu) { ?><?php $v165689508269435014061loop->first = ($v165689508269435014061incr == 0); $v165689508269435014061loop->index = $v165689508269435014061incr + 1; $v165689508269435014061loop->index0 = $v165689508269435014061incr; $v165689508269435014061loop->revindex = $v165689508269435014061loop->length - $v165689508269435014061incr; $v165689508269435014061loop->revindex0 = $v165689508269435014061loop->length - ($v165689508269435014061incr + 1); $v165689508269435014061loop->last = ($v165689508269435014061incr == ($v165689508269435014061loop->length - 1)); ?>
                <?php if ($index % 5 == 0) { ?>
                    <div class="col-md-2 col-sm-3 col-xs-6">
                    <ul class="list1">
                <?php } ?>
                <li><a href="<?php echo $itemFooterMenu['link']; ?>"><?php echo $itemFooterMenu['title']; ?></a></li>
                <?php if ($index % 5 == 4 || $v165689508269435014061loop->last) { ?>
                    </ul>
                    </div>
                <?php } ?>
            <?php $v165689508269435014061incr++; } ?>
