            ...
            <?php foreach ($listCategory_footer as $item) { ?>
                <div class="col-md-2 col-sm-3 col-xs-6">
                    <ul class="list1">
                        ...
                        <?php if (isset($item['child'])) { ?>
                            <?php $v8969721660915514502iterator = $item['child']; $v8969721660915514502incr = 0; $v8969721660915514502loop = new stdClass(); $v8969721660915514502loop->length = count($v8969721660915514502iterator); $v8969721660915514502loop->index = 1; $v8969721660915514502loop->index0 = 1; $v8969721660915514502loop->revindex = $v8969721660915514502loop->length; $v8969721660915514502loop->revindex0 = $v8969721660915514502loop->length - 1; ?><?php foreach ($v8969721660915514502iterator as $child) { ?><?php $v8969721660915514502loop->first = ($v8969721660915514502incr == 0); $v8969721660915514502loop->index = $v8969721660915514502incr + 1; $v8969721660915514502loop->index0 = $v8969721660915514502incr; $v8969721660915514502loop->revindex = $v8969721660915514502loop->length - $v8969721660915514502incr; $v8969721660915514502loop->revindex0 = $v8969721660915514502loop->length - ($v8969721660915514502incr + 1); $v8969721660915514502loop->last = ($v8969721660915514502incr == ($v8969721660915514502loop->length - 1)); ?>
