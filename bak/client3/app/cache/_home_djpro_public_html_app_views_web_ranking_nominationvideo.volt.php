            ...
            <?php foreach ($listCategory_footer as $item) { ?>
                <div class="col-md-2 col-sm-3 col-xs-6">
                    <ul class="list1">
                        ...
                        <?php if (isset($item['child'])) { ?>
                            <?php $v161917107924386472852iterator = $item['child']; $v161917107924386472852incr = 0; $v161917107924386472852loop = new stdClass(); $v161917107924386472852loop->length = count($v161917107924386472852iterator); $v161917107924386472852loop->index = 1; $v161917107924386472852loop->index0 = 1; $v161917107924386472852loop->revindex = $v161917107924386472852loop->length; $v161917107924386472852loop->revindex0 = $v161917107924386472852loop->length - 1; ?><?php foreach ($v161917107924386472852iterator as $child) { ?><?php $v161917107924386472852loop->first = ($v161917107924386472852incr == 0); $v161917107924386472852loop->index = $v161917107924386472852incr + 1; $v161917107924386472852loop->index0 = $v161917107924386472852incr; $v161917107924386472852loop->revindex = $v161917107924386472852loop->length - $v161917107924386472852incr; $v161917107924386472852loop->revindex0 = $v161917107924386472852loop->length - ($v161917107924386472852incr + 1); $v161917107924386472852loop->last = ($v161917107924386472852incr == ($v161917107924386472852loop->length - 1)); ?>
