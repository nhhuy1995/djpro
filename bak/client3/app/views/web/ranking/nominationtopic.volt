                        ...
                        <nav>
                            <ul>
                                <li class=""><a href="/bai-hat-de-cu.html" class="icon icon-baihat"><span>Bài hát</span></a>
                                 ...
                                 <li class=""><a href="/v/bai-hat-de-cu.html" class="icon icon-video"><span>Video</span></a></li>
                                 <li class="tab-current"><a href="/t/bai-hat-de-cu.html" class="icon icon-chude"><span>Chủ đề</span></a></li>
                                 <li class=""><a href="/a/bai-hat-de-cu.html" class="icon icon-album"><span>Album</span></a></li>
                                 <li class=""><a href="/p/bai-hat-de-cu.html" class="icon icon-playlist"><span>Playlist</span></a></li>
                            </ul>
                        </nav>
                        <div class="content-wrap">
                            {% if listTopic|length ==1 %} {%  set cl_listTopic = 'style="height:200px"' %} {% endif %}
                            <section id="section-linemove-3" {{ cl_listTopic }} class="content-current">
                                {% for key,item in listTopic %}
