...
class Makelink
{
    ...
    public static function link_view_embed_music($atId)
    {
        return '/ebd_m/' . intval($atId);
    }

    public static function link_view_embed_collection($clId)
    {
        return '/ebd_cl/' . intval($clId);
    }

    public static function link_view_embed_video($videoId)
    {
        return '/ebd_v/' . intval($videoId);
    }
}
