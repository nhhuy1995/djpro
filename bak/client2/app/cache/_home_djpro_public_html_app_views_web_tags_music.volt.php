...
<footer>
    <div class="container">
        <div class="row">
            <?php $v154335255008776519441iterator = $listCategory_footer; $v154335255008776519441incr = 0; $v154335255008776519441loop = new stdClass(); $v154335255008776519441loop->length = count($v154335255008776519441iterator); $v154335255008776519441loop->index = 1; $v154335255008776519441loop->index0 = 1; $v154335255008776519441loop->revindex = $v154335255008776519441loop->length; $v154335255008776519441loop->revindex0 = $v154335255008776519441loop->length - 1; ?><?php foreach ($v154335255008776519441iterator as $index => $itemFooterMenu) { ?><?php $v154335255008776519441loop->first = ($v154335255008776519441incr == 0); $v154335255008776519441loop->index = $v154335255008776519441incr + 1; $v154335255008776519441loop->index0 = $v154335255008776519441incr; $v154335255008776519441loop->revindex = $v154335255008776519441loop->length - $v154335255008776519441incr; $v154335255008776519441loop->revindex0 = $v154335255008776519441loop->length - ($v154335255008776519441incr + 1); $v154335255008776519441loop->last = ($v154335255008776519441incr == ($v154335255008776519441loop->length - 1)); ?>
                <?php if ($index % 5 == 0) { ?>
                    <div class="col-md-2 col-sm-3 col-xs-6">
                    <ul class="list1">
                <?php } ?>
                <li><a href="<?php echo $itemFooterMenu['link']; ?>"><?php echo $itemFooterMenu['title']; ?></a></li>
                <?php if ($index % 5 == 4 || $v154335255008776519441loop->last) { ?>
                    </ul>
                    </div>
                <?php } ?>
            <?php $v154335255008776519441incr++; } ?>
