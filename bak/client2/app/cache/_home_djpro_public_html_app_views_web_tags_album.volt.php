...
<div id="content">
    ...
    <?php $v154147054650843462961iterator = $item['listartist']; $v154147054650843462961incr = 0; $v154147054650843462961loop = new stdClass(); $v154147054650843462961loop->length = count($v154147054650843462961iterator); $v154147054650843462961loop->index = 1; $v154147054650843462961loop->index0 = 1; $v154147054650843462961loop->revindex = $v154147054650843462961loop->length; $v154147054650843462961loop->revindex0 = $v154147054650843462961loop->length - 1; ?><?php foreach ($v154147054650843462961iterator as $itemchild) { ?><?php $v154147054650843462961loop->first = ($v154147054650843462961incr == 0); $v154147054650843462961loop->index = $v154147054650843462961incr + 1; $v154147054650843462961loop->index0 = $v154147054650843462961incr; $v154147054650843462961loop->revindex = $v154147054650843462961loop->length - $v154147054650843462961incr; $v154147054650843462961loop->revindex0 = $v154147054650843462961loop->length - ($v154147054650843462961incr + 1); $v154147054650843462961loop->last = ($v154147054650843462961incr == ($v154147054650843462961loop->length - 1)); ?>
    <a class="subtitle" href="<?php echo $itemchild['link']; ?>"
       title="<?php echo $itemchild['username']; ?>"><?php echo $itemchild['username']; ?></a><?php if (!$v154147054650843462961loop->last) { ?><span class="bull" style="font-size:12px;">Ft </span><?php } ?>
    <?php $v154147054650843462961incr++; } ?>
...
<footer>
    <div class="container">
        <div class="row">
            <?php $v154147054650843462961iterator = $listCategory_footer; $v154147054650843462961incr = 0; $v154147054650843462961loop = new stdClass(); $v154147054650843462961loop->length = count($v154147054650843462961iterator); $v154147054650843462961loop->index = 1; $v154147054650843462961loop->index0 = 1; $v154147054650843462961loop->revindex = $v154147054650843462961loop->length; $v154147054650843462961loop->revindex0 = $v154147054650843462961loop->length - 1; ?><?php foreach ($v154147054650843462961iterator as $index => $itemFooterMenu) { ?><?php $v154147054650843462961loop->first = ($v154147054650843462961incr == 0); $v154147054650843462961loop->index = $v154147054650843462961incr + 1; $v154147054650843462961loop->index0 = $v154147054650843462961incr; $v154147054650843462961loop->revindex = $v154147054650843462961loop->length - $v154147054650843462961incr; $v154147054650843462961loop->revindex0 = $v154147054650843462961loop->length - ($v154147054650843462961incr + 1); $v154147054650843462961loop->last = ($v154147054650843462961incr == ($v154147054650843462961loop->length - 1)); ?>
                <?php if ($index % 5 == 0) { ?>
                    <div class="col-md-2 col-sm-3 col-xs-6">
                    <ul class="list1">
                <?php } ?>
                <li><a href="<?php echo $itemFooterMenu['link']; ?>"><?php echo $itemFooterMenu['title']; ?></a></li>
                <?php if ($index % 5 == 4 || $v154147054650843462961loop->last) { ?>
                    </ul>
                    </div>
                <?php } ?>
            <?php $v154147054650843462961incr++; } ?>
