...
<div id="content">
    <div class="bg-cmmusic">
        <div class="container">
            <ul class="breadcrumbs">
                ...
                <li><a href="/tim-kiem/album.html?q=<?php echo $keyword; ?>"><?php echo $_GET['q']; ?></a></li>
            </ul>
        </div>
        <div class="container">
            <div class="row">
                <div class="col-ldh-9 col-sm-8">
                    <div class="td_headingw"><h2>Danh sách album theo
    ...
    <?php $v72732016093067733751iterator = $item['listartist']; $v72732016093067733751incr = 0; $v72732016093067733751loop = new stdClass(); $v72732016093067733751loop->length = count($v72732016093067733751iterator); $v72732016093067733751loop->index = 1; $v72732016093067733751loop->index0 = 1; $v72732016093067733751loop->revindex = $v72732016093067733751loop->length; $v72732016093067733751loop->revindex0 = $v72732016093067733751loop->length - 1; ?><?php foreach ($v72732016093067733751iterator as $itemchild) { ?><?php $v72732016093067733751loop->first = ($v72732016093067733751incr == 0); $v72732016093067733751loop->index = $v72732016093067733751incr + 1; $v72732016093067733751loop->index0 = $v72732016093067733751incr; $v72732016093067733751loop->revindex = $v72732016093067733751loop->length - $v72732016093067733751incr; $v72732016093067733751loop->revindex0 = $v72732016093067733751loop->length - ($v72732016093067733751incr + 1); $v72732016093067733751loop->last = ($v72732016093067733751incr == ($v72732016093067733751loop->length - 1)); ?>
    <a class="subtitle" href="<?php echo $itemchild['link']; ?>"
       title="<?php echo $itemchild['username']; ?>"><?php echo $itemchild['username']; ?></a><?php if (!$v72732016093067733751loop->last) { ?><span class="bull" style="font-size:12px;">Ft </span><?php } ?>
    <?php $v72732016093067733751incr++; } ?>
...
<footer>
    <div class="container">
        <div class="row">
            <?php $v72732016093067733751iterator = $listCategory_footer; $v72732016093067733751incr = 0; $v72732016093067733751loop = new stdClass(); $v72732016093067733751loop->length = count($v72732016093067733751iterator); $v72732016093067733751loop->index = 1; $v72732016093067733751loop->index0 = 1; $v72732016093067733751loop->revindex = $v72732016093067733751loop->length; $v72732016093067733751loop->revindex0 = $v72732016093067733751loop->length - 1; ?><?php foreach ($v72732016093067733751iterator as $index => $itemFooterMenu) { ?><?php $v72732016093067733751loop->first = ($v72732016093067733751incr == 0); $v72732016093067733751loop->index = $v72732016093067733751incr + 1; $v72732016093067733751loop->index0 = $v72732016093067733751incr; $v72732016093067733751loop->revindex = $v72732016093067733751loop->length - $v72732016093067733751incr; $v72732016093067733751loop->revindex0 = $v72732016093067733751loop->length - ($v72732016093067733751incr + 1); $v72732016093067733751loop->last = ($v72732016093067733751incr == ($v72732016093067733751loop->length - 1)); ?>
                <?php if ($index % 5 == 0) { ?>
                    <div class="col-md-2 col-sm-3 col-xs-6">
                    <ul class="list1">
                <?php } ?>
                <li><a href="<?php echo $itemFooterMenu['link']; ?>"><?php echo $itemFooterMenu['title']; ?></a></li>
                <?php if ($index % 5 == 4 || $v72732016093067733751loop->last) { ?>
                    </ul>
                    </div>
                <?php } ?>
            <?php $v72732016093067733751incr++; } ?>
