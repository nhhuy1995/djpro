...
<div id="content">
                    ...
                    <div class="tabs tabs-style-linemove">
                        <nav>
                            <ul>
                                ...
                                <li class="tab-current"><a href="/nhac-da-duyet.html?t=playlist"
    ...
    <?php $v50647850008574886111iterator = $item['listartist']; $v50647850008574886111incr = 0; $v50647850008574886111loop = new stdClass(); $v50647850008574886111loop->length = count($v50647850008574886111iterator); $v50647850008574886111loop->index = 1; $v50647850008574886111loop->index0 = 1; $v50647850008574886111loop->revindex = $v50647850008574886111loop->length; $v50647850008574886111loop->revindex0 = $v50647850008574886111loop->length - 1; ?><?php foreach ($v50647850008574886111iterator as $itemchild) { ?><?php $v50647850008574886111loop->first = ($v50647850008574886111incr == 0); $v50647850008574886111loop->index = $v50647850008574886111incr + 1; $v50647850008574886111loop->index0 = $v50647850008574886111incr; $v50647850008574886111loop->revindex = $v50647850008574886111loop->length - $v50647850008574886111incr; $v50647850008574886111loop->revindex0 = $v50647850008574886111loop->length - ($v50647850008574886111incr + 1); $v50647850008574886111loop->last = ($v50647850008574886111incr == ($v50647850008574886111loop->length - 1)); ?>
    <a class="subtitle" href="<?php echo $itemchild['link']; ?>"
       title="<?php echo $itemchild['username']; ?>"><?php echo $itemchild['username']; ?></a><?php if (!$v50647850008574886111loop->last) { ?><span class="bull" style="font-size:12px;">Ft </span><?php } ?>
    <?php $v50647850008574886111incr++; } ?>
...
<footer>
    <div class="container">
        <div class="row">
            <?php $v50647850008574886111iterator = $listCategory_footer; $v50647850008574886111incr = 0; $v50647850008574886111loop = new stdClass(); $v50647850008574886111loop->length = count($v50647850008574886111iterator); $v50647850008574886111loop->index = 1; $v50647850008574886111loop->index0 = 1; $v50647850008574886111loop->revindex = $v50647850008574886111loop->length; $v50647850008574886111loop->revindex0 = $v50647850008574886111loop->length - 1; ?><?php foreach ($v50647850008574886111iterator as $index => $itemFooterMenu) { ?><?php $v50647850008574886111loop->first = ($v50647850008574886111incr == 0); $v50647850008574886111loop->index = $v50647850008574886111incr + 1; $v50647850008574886111loop->index0 = $v50647850008574886111incr; $v50647850008574886111loop->revindex = $v50647850008574886111loop->length - $v50647850008574886111incr; $v50647850008574886111loop->revindex0 = $v50647850008574886111loop->length - ($v50647850008574886111incr + 1); $v50647850008574886111loop->last = ($v50647850008574886111incr == ($v50647850008574886111loop->length - 1)); ?>
                <?php if ($index % 5 == 0) { ?>
                    <div class="col-md-2 col-sm-3 col-xs-6">
                    <ul class="list1">
                <?php } ?>
                <li><a href="<?php echo $itemFooterMenu['link']; ?>"><?php echo $itemFooterMenu['title']; ?></a></li>
                <?php if ($index % 5 == 4 || $v50647850008574886111loop->last) { ?>
                    </ul>
                    </div>
                <?php } ?>
            <?php $v50647850008574886111incr++; } ?>
