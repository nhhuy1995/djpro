...
<div id="content">
                    ...
                    <div class="tabs tabs-style-iconbox">
                        <nav>
                            <ul>
                                ...
                                <li class="tabs_artist tab-current"><a href="<?php echo $object->link; ?>?t=album"
                        ...
                        <div class="content-wrap">
                            <section id="section-linemove-3" class="" style="display: block">
                                <div class="td_heading"><h2><span class="while">Album<i
    ...
    <?php $v31057086347299172481iterator = $item['listartist']; $v31057086347299172481incr = 0; $v31057086347299172481loop = new stdClass(); $v31057086347299172481loop->length = count($v31057086347299172481iterator); $v31057086347299172481loop->index = 1; $v31057086347299172481loop->index0 = 1; $v31057086347299172481loop->revindex = $v31057086347299172481loop->length; $v31057086347299172481loop->revindex0 = $v31057086347299172481loop->length - 1; ?><?php foreach ($v31057086347299172481iterator as $itemchild) { ?><?php $v31057086347299172481loop->first = ($v31057086347299172481incr == 0); $v31057086347299172481loop->index = $v31057086347299172481incr + 1; $v31057086347299172481loop->index0 = $v31057086347299172481incr; $v31057086347299172481loop->revindex = $v31057086347299172481loop->length - $v31057086347299172481incr; $v31057086347299172481loop->revindex0 = $v31057086347299172481loop->length - ($v31057086347299172481incr + 1); $v31057086347299172481loop->last = ($v31057086347299172481incr == ($v31057086347299172481loop->length - 1)); ?>
    <a class="subtitle" href="<?php echo $itemchild['link']; ?>"
       title="<?php echo $itemchild['username']; ?>"><?php echo $itemchild['username']; ?></a><?php if (!$v31057086347299172481loop->last) { ?><span class="bull" style="font-size:12px;">Ft </span><?php } ?>
    <?php $v31057086347299172481incr++; } ?>
...
<footer>
    <div class="container">
        <div class="row">
            <?php $v31057086347299172481iterator = $listCategory_footer; $v31057086347299172481incr = 0; $v31057086347299172481loop = new stdClass(); $v31057086347299172481loop->length = count($v31057086347299172481iterator); $v31057086347299172481loop->index = 1; $v31057086347299172481loop->index0 = 1; $v31057086347299172481loop->revindex = $v31057086347299172481loop->length; $v31057086347299172481loop->revindex0 = $v31057086347299172481loop->length - 1; ?><?php foreach ($v31057086347299172481iterator as $index => $itemFooterMenu) { ?><?php $v31057086347299172481loop->first = ($v31057086347299172481incr == 0); $v31057086347299172481loop->index = $v31057086347299172481incr + 1; $v31057086347299172481loop->index0 = $v31057086347299172481incr; $v31057086347299172481loop->revindex = $v31057086347299172481loop->length - $v31057086347299172481incr; $v31057086347299172481loop->revindex0 = $v31057086347299172481loop->length - ($v31057086347299172481incr + 1); $v31057086347299172481loop->last = ($v31057086347299172481incr == ($v31057086347299172481loop->length - 1)); ?>
                <?php if ($index % 5 == 0) { ?>
                    <div class="col-md-2 col-sm-3 col-xs-6">
                    <ul class="list1">
                <?php } ?>
                <li><a href="<?php echo $itemFooterMenu['link']; ?>"><?php echo $itemFooterMenu['title']; ?></a></li>
                <?php if ($index % 5 == 4 || $v31057086347299172481loop->last) { ?>
                    </ul>
                    </div>
                <?php } ?>
            <?php $v31057086347299172481incr++; } ?>
