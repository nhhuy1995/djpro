    ...
    <div class="bg-cmmusic">
        <div class="container">
            <ul class="breadcrumbs">
                ...
                <li><a href="/tim-kiem/nghe-sy.html?q=<?php echo $keyword; ?>"><?php echo $_GET['q']; ?></a></li>
            </ul>
        </div>
        <div class="container">
            <div class="row">
...
<footer>
    <div class="container">
        <div class="row">
            <?php $v2179884959308250931iterator = $listCategory_footer; $v2179884959308250931incr = 0; $v2179884959308250931loop = new stdClass(); $v2179884959308250931loop->length = count($v2179884959308250931iterator); $v2179884959308250931loop->index = 1; $v2179884959308250931loop->index0 = 1; $v2179884959308250931loop->revindex = $v2179884959308250931loop->length; $v2179884959308250931loop->revindex0 = $v2179884959308250931loop->length - 1; ?><?php foreach ($v2179884959308250931iterator as $index => $itemFooterMenu) { ?><?php $v2179884959308250931loop->first = ($v2179884959308250931incr == 0); $v2179884959308250931loop->index = $v2179884959308250931incr + 1; $v2179884959308250931loop->index0 = $v2179884959308250931incr; $v2179884959308250931loop->revindex = $v2179884959308250931loop->length - $v2179884959308250931incr; $v2179884959308250931loop->revindex0 = $v2179884959308250931loop->length - ($v2179884959308250931incr + 1); $v2179884959308250931loop->last = ($v2179884959308250931incr == ($v2179884959308250931loop->length - 1)); ?>
                <?php if ($index % 5 == 0) { ?>
                    <div class="col-md-2 col-sm-3 col-xs-6">
                    <ul class="list1">
                <?php } ?>
                <li><a href="<?php echo $itemFooterMenu['link']; ?>"><?php echo $itemFooterMenu['title']; ?></a></li>
                <?php if ($index % 5 == 4 || $v2179884959308250931loop->last) { ?>
                    </ul>
                    </div>
                <?php } ?>
            <?php $v2179884959308250931incr++; } ?>
