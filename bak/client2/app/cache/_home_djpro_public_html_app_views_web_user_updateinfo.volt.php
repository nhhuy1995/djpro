                                    ...
                                    <form action="" method="post" class="cd-form">
                                        <p class="fieldset">
                                            ...
                                            <input class="full-width has-padding has-border" name="name"
                                                   ...
                                                   id="signup-username" type="text" value="<?php echo $object->username; ?>"
                                        ...
                                        <p class="fieldset">
                                            ...
                                            <input class="full-width has-padding has-border" name="email"
                                                   disabled="disabled" style="background-color: white;"
                                                   id="signup-email" type="email" value="<?php echo $object->email; ?>"
                                        ...
                                        <p class="fieldset">
                                            ...
                                            <input class="full-width has-padding has-border"
                                                   value="<?php echo $object->fullname; ?>" name="fullname"
                                        ...
                                        <p class="fieldset">
                                            ...
                                            <input class="full-width has-padding has-border" name="address"
                                                   id="signup-username" type="text" value="<?php echo $object->address; ?>"
                                                   placeholder="Địa chỉ">
                                            <span class="cd-error-message">Error message here!</span>
                                        </p>
                                        ...
                                        <p class="fieldset">
                                            ...
                                            <input class="full-width has-padding has-border" name="phone"
                                                   id="signup-username" value="<?php echo $object->phone; ?>" type="text"
                                        ...
                                        <p class="fieldset">
                                            ...
                                            <input class="full-width has-padding has-border" name="facebook"
                                                   id="signup-username" type="text" value="<?php echo $object->facebook; ?>"
                                        ...
                                        <p class="fieldset">
                                            ...
                                            <input class="full-width has-padding has-border" name="yahoo"
                                                   id="signup-username" type="text" value="<?php echo $object->yahoo; ?>"
                                        ...
                                        <p class="fieldset">
                                            ...
                                            <input class="full-width has-padding has-border" name="skype"
                                                   id="signup-username" type="text" value="<?php echo $object->skype; ?>"
                                                   placeholder="Skype">
                                            <span class="cd-error-message">Error message here!</span>
                                        </p>
                                        ...
                                        <p class="fieldset">
                                            ...
                                            <input class="full-width has-padding has-border" name="job"
                                                   id="signup-username" type="text" value="<?php echo $object->job; ?>"
                                        ...
                                        <p class="fieldset">
                                            ...
                                            <input class="full-width has-padding has-border" name="hobby"
                                                   id="signup-username" type="text" value="<?php echo $object->hobby; ?>"
                                                   placeholder="Sở thích">
                                            <span class="cd-error-message">Error message here!</span>
                                        </p>

                                        <p class="fieldset">
                                            <input name="sex" <?php if ($object->sex == 'NA') { ?>checked <?php } ?>
                                                   id="signup-username" type="radio" value="NA"> N/A&nbsp;
                                            <input name="sex" <?php if ($object->sex == 'male') { ?>checked <?php } ?>
                                                   id="signup-username" type="radio" value="male"> Nam &nbsp;
                                            <input name="sex" <?php if ($object->sex == 'female') { ?>checked <?php } ?>
                                        ...
                                        <p>
                                            <img src="<?php echo $object->priavatar; ?>" id="previewavatar"
...
<footer>
    <div class="container">
        <div class="row">
            <?php $v176932886453416155901iterator = $listCategory_footer; $v176932886453416155901incr = 0; $v176932886453416155901loop = new stdClass(); $v176932886453416155901loop->length = count($v176932886453416155901iterator); $v176932886453416155901loop->index = 1; $v176932886453416155901loop->index0 = 1; $v176932886453416155901loop->revindex = $v176932886453416155901loop->length; $v176932886453416155901loop->revindex0 = $v176932886453416155901loop->length - 1; ?><?php foreach ($v176932886453416155901iterator as $index => $itemFooterMenu) { ?><?php $v176932886453416155901loop->first = ($v176932886453416155901incr == 0); $v176932886453416155901loop->index = $v176932886453416155901incr + 1; $v176932886453416155901loop->index0 = $v176932886453416155901incr; $v176932886453416155901loop->revindex = $v176932886453416155901loop->length - $v176932886453416155901incr; $v176932886453416155901loop->revindex0 = $v176932886453416155901loop->length - ($v176932886453416155901incr + 1); $v176932886453416155901loop->last = ($v176932886453416155901incr == ($v176932886453416155901loop->length - 1)); ?>
                <?php if ($index % 5 == 0) { ?>
                    <div class="col-md-2 col-sm-3 col-xs-6">
                    <ul class="list1">
                <?php } ?>
                <li><a href="<?php echo $itemFooterMenu['link']; ?>"><?php echo $itemFooterMenu['title']; ?></a></li>
                <?php if ($index % 5 == 4 || $v176932886453416155901loop->last) { ?>
                    </ul>
                    </div>
                <?php } ?>
            <?php $v176932886453416155901incr++; } ?>
