                    ...
                    <div class="topic_chude">
                        <ul class="row">
                            ...
                            <li class="col-md-4 col-sm-4 col-xs-12">
                                <div>
                                    <?php $v75404789645406915222iterator = $item['listtopic']; $v75404789645406915222incr = 0; $v75404789645406915222loop = new stdClass(); $v75404789645406915222loop->length = count($v75404789645406915222iterator); $v75404789645406915222loop->index = 1; $v75404789645406915222loop->index0 = 1; $v75404789645406915222loop->revindex = $v75404789645406915222loop->length; $v75404789645406915222loop->revindex0 = $v75404789645406915222loop->length - 1; ?><?php foreach ($v75404789645406915222iterator as $itemchild) { ?><?php $v75404789645406915222loop->first = ($v75404789645406915222incr == 0); $v75404789645406915222loop->index = $v75404789645406915222incr + 1; $v75404789645406915222loop->index0 = $v75404789645406915222incr; $v75404789645406915222loop->revindex = $v75404789645406915222loop->length - $v75404789645406915222incr; $v75404789645406915222loop->revindex0 = $v75404789645406915222loop->length - ($v75404789645406915222incr + 1); $v75404789645406915222loop->last = ($v75404789645406915222incr == ($v75404789645406915222loop->length - 1)); ?>
                                        <?php if ($v75404789645406915222loop->first) { ?>
                                        ...
                                        <?php } ?>
                                    <?php $v75404789645406915222incr++; } ?>
                                    <ul>
                                        <?php $v75404789645406915222iterator = $item['listtopic']; $v75404789645406915222incr = 0; $v75404789645406915222loop = new stdClass(); $v75404789645406915222loop->length = count($v75404789645406915222iterator); $v75404789645406915222loop->index = 1; $v75404789645406915222loop->index0 = 1; $v75404789645406915222loop->revindex = $v75404789645406915222loop->length; $v75404789645406915222loop->revindex0 = $v75404789645406915222loop->length - 1; ?><?php foreach ($v75404789645406915222iterator as $itemchild) { ?><?php $v75404789645406915222loop->first = ($v75404789645406915222incr == 0); $v75404789645406915222loop->index = $v75404789645406915222incr + 1; $v75404789645406915222loop->index0 = $v75404789645406915222incr; $v75404789645406915222loop->revindex = $v75404789645406915222loop->length - $v75404789645406915222incr; $v75404789645406915222loop->revindex0 = $v75404789645406915222loop->length - ($v75404789645406915222incr + 1); $v75404789645406915222loop->last = ($v75404789645406915222incr == ($v75404789645406915222loop->length - 1)); ?>
                                        <?php if (!$v75404789645406915222loop->first) { ?>
                                        <li>
                                            <h3><a class="name_song"
                                                   href="<?php echo $itemchild['link']; ?>" title="<?php echo $itemchild['name']; ?>"><?php echo $itemchild['name']; ?></a>
                                            </h3>
                                        </li>
                                        <?php } ?>
                                        <?php $v75404789645406915222incr++; } ?>
...
<footer>
    <div class="container">
        <div class="row">
            <?php $v75404789645406915221iterator = $listCategory_footer; $v75404789645406915221incr = 0; $v75404789645406915221loop = new stdClass(); $v75404789645406915221loop->length = count($v75404789645406915221iterator); $v75404789645406915221loop->index = 1; $v75404789645406915221loop->index0 = 1; $v75404789645406915221loop->revindex = $v75404789645406915221loop->length; $v75404789645406915221loop->revindex0 = $v75404789645406915221loop->length - 1; ?><?php foreach ($v75404789645406915221iterator as $index => $itemFooterMenu) { ?><?php $v75404789645406915221loop->first = ($v75404789645406915221incr == 0); $v75404789645406915221loop->index = $v75404789645406915221incr + 1; $v75404789645406915221loop->index0 = $v75404789645406915221incr; $v75404789645406915221loop->revindex = $v75404789645406915221loop->length - $v75404789645406915221incr; $v75404789645406915221loop->revindex0 = $v75404789645406915221loop->length - ($v75404789645406915221incr + 1); $v75404789645406915221loop->last = ($v75404789645406915221incr == ($v75404789645406915221loop->length - 1)); ?>
                <?php if ($index % 5 == 0) { ?>
                    <div class="col-md-2 col-sm-3 col-xs-6">
                    <ul class="list1">
                <?php } ?>
                <li><a href="<?php echo $itemFooterMenu['link']; ?>"><?php echo $itemFooterMenu['title']; ?></a></li>
                <?php if ($index % 5 == 4 || $v75404789645406915221loop->last) { ?>
                    </ul>
                    </div>
                <?php } ?>
            <?php $v75404789645406915221incr++; } ?>
