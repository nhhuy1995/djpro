                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-8 listview ">
                                    ...
                                    <div class="lv-body">
                                        <div class="lv-body">
                                            <ol class="sortable" id="listOfMenuItem" class="lv-item media"><?php function vmacro_addMenuItem($__p) { if (isset($__p[0])) { $value = $__p[0]; } else { if (isset($__p["value"])) { $value = $__p["value"]; } else {  throw new \Phalcon\Mvc\View\Exception("Macro addMenuItem was called without parameter: value");  } }  ?>
                                                    <?php if ($value['catid'] != '') { ?>
                                                    ...
                                                    <li id="menuItem_<?php echo $value['item_id']; ?>" class="menu-item-in-list">
                                                        ...
                                                        <span data-type="<?php echo $value['type']; ?>"
                                                              data-link="<?php echo $value['link']; ?>"
                                                              data-catid="<?php echo $value['cat_id']; ?>"
                                                              data-indexmenu="<?php echo $value['item_id']; ?>"
                                                              data-title="<?php echo $value['title']; ?>"></span>
                                                        <?php if (isset($value['child'])) { ?>
                                                            <ol>
                                                                <?php foreach ($value['child'] as $subvalue) { ?>
                                                                    <?php echo vmacro_addMenuItem(array($subvalue)); ?>
                                                                <?php } ?>
                                                            </ol>
                                                        <?php } ?>
                                                    </li><?php } ?>
                                                <?php foreach ($settingObj['value'] as $item) { ?>
                                                    <?php echo vmacro_addMenuItem(array($item)); ?>
                                                <?php } ?>
                                            </ol>
                                        </div>
                                    </div>
