        ...
        <div class="container">
            <div class="row">
                <div class="col-ldh-9 col-sm-8">
                    <div class="td_headingw"><h2><a href="<?php echo $category->link; ?>"><?php echo $category->name; ?></a><i class="fa fa-angle-right"></i></h2></div>
                    <?php if ($listartist) { ?>
                    <div class="row">
                               ...
                               <a href="<?php echo $item['link']; ?>" title=""><i class="fa fa-plus"></i></a>
                                    ...
                                    <div class="details2">
                                        <h3><a href="<?php echo $item['link']; ?>" class="title tooltip-top"
                                               title="Đàm Vĩnh Hưng"><?php echo $item['username']; ?>
...
<footer>
    <div class="container">
        <div class="row">
            <?php $v74348287412729005251iterator = $listCategory_footer; $v74348287412729005251incr = 0; $v74348287412729005251loop = new stdClass(); $v74348287412729005251loop->length = count($v74348287412729005251iterator); $v74348287412729005251loop->index = 1; $v74348287412729005251loop->index0 = 1; $v74348287412729005251loop->revindex = $v74348287412729005251loop->length; $v74348287412729005251loop->revindex0 = $v74348287412729005251loop->length - 1; ?><?php foreach ($v74348287412729005251iterator as $index => $itemFooterMenu) { ?><?php $v74348287412729005251loop->first = ($v74348287412729005251incr == 0); $v74348287412729005251loop->index = $v74348287412729005251incr + 1; $v74348287412729005251loop->index0 = $v74348287412729005251incr; $v74348287412729005251loop->revindex = $v74348287412729005251loop->length - $v74348287412729005251incr; $v74348287412729005251loop->revindex0 = $v74348287412729005251loop->length - ($v74348287412729005251incr + 1); $v74348287412729005251loop->last = ($v74348287412729005251incr == ($v74348287412729005251loop->length - 1)); ?>
                <?php if ($index % 5 == 0) { ?>
                    <div class="col-md-2 col-sm-3 col-xs-6">
                    <ul class="list1">
                <?php } ?>
                <li><a href="<?php echo $itemFooterMenu['link']; ?>"><?php echo $itemFooterMenu['title']; ?></a></li>
                <?php if ($index % 5 == 4 || $v74348287412729005251loop->last) { ?>
                    </ul>
                    </div>
                <?php } ?>
            <?php $v74348287412729005251incr++; } ?>
