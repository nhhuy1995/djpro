...
<div id="content">
    <div class="bg-cmmusic">
        <div class="container">
            <ul class="breadcrumbs">
                ...
                <li><a href="/playlist-moi.html">Playlist mới nhất</a></li>
            </ul>
        </div>
        <div class="container">
            <div class="row">
    ...
    <?php $v156625804860220686921iterator = $item['listartist']; $v156625804860220686921incr = 0; $v156625804860220686921loop = new stdClass(); $v156625804860220686921loop->length = count($v156625804860220686921iterator); $v156625804860220686921loop->index = 1; $v156625804860220686921loop->index0 = 1; $v156625804860220686921loop->revindex = $v156625804860220686921loop->length; $v156625804860220686921loop->revindex0 = $v156625804860220686921loop->length - 1; ?><?php foreach ($v156625804860220686921iterator as $itemchild) { ?><?php $v156625804860220686921loop->first = ($v156625804860220686921incr == 0); $v156625804860220686921loop->index = $v156625804860220686921incr + 1; $v156625804860220686921loop->index0 = $v156625804860220686921incr; $v156625804860220686921loop->revindex = $v156625804860220686921loop->length - $v156625804860220686921incr; $v156625804860220686921loop->revindex0 = $v156625804860220686921loop->length - ($v156625804860220686921incr + 1); $v156625804860220686921loop->last = ($v156625804860220686921incr == ($v156625804860220686921loop->length - 1)); ?>
    <a class="subtitle" href="<?php echo $itemchild['link']; ?>"
       title="<?php echo $itemchild['username']; ?>"><?php echo $itemchild['username']; ?></a><?php if (!$v156625804860220686921loop->last) { ?><span class="bull" style="font-size:12px;">Ft </span><?php } ?>
    <?php $v156625804860220686921incr++; } ?>
...
<footer>
    <div class="container">
        <div class="row">
            <?php $v156625804860220686921iterator = $listCategory_footer; $v156625804860220686921incr = 0; $v156625804860220686921loop = new stdClass(); $v156625804860220686921loop->length = count($v156625804860220686921iterator); $v156625804860220686921loop->index = 1; $v156625804860220686921loop->index0 = 1; $v156625804860220686921loop->revindex = $v156625804860220686921loop->length; $v156625804860220686921loop->revindex0 = $v156625804860220686921loop->length - 1; ?><?php foreach ($v156625804860220686921iterator as $index => $itemFooterMenu) { ?><?php $v156625804860220686921loop->first = ($v156625804860220686921incr == 0); $v156625804860220686921loop->index = $v156625804860220686921incr + 1; $v156625804860220686921loop->index0 = $v156625804860220686921incr; $v156625804860220686921loop->revindex = $v156625804860220686921loop->length - $v156625804860220686921incr; $v156625804860220686921loop->revindex0 = $v156625804860220686921loop->length - ($v156625804860220686921incr + 1); $v156625804860220686921loop->last = ($v156625804860220686921incr == ($v156625804860220686921loop->length - 1)); ?>
                <?php if ($index % 5 == 0) { ?>
                    <div class="col-md-2 col-sm-3 col-xs-6">
                    <ul class="list1">
                <?php } ?>
                <li><a href="<?php echo $itemFooterMenu['link']; ?>"><?php echo $itemFooterMenu['title']; ?></a></li>
                <?php if ($index % 5 == 4 || $v156625804860220686921loop->last) { ?>
                    </ul>
                    </div>
                <?php } ?>
            <?php $v156625804860220686921incr++; } ?>
