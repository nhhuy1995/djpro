...
<footer>
    <div class="container">
        <div class="row">
            <?php $v5852812704452739261iterator = $listCategory_footer; $v5852812704452739261incr = 0; $v5852812704452739261loop = new stdClass(); $v5852812704452739261loop->length = count($v5852812704452739261iterator); $v5852812704452739261loop->index = 1; $v5852812704452739261loop->index0 = 1; $v5852812704452739261loop->revindex = $v5852812704452739261loop->length; $v5852812704452739261loop->revindex0 = $v5852812704452739261loop->length - 1; ?><?php foreach ($v5852812704452739261iterator as $index => $itemFooterMenu) { ?><?php $v5852812704452739261loop->first = ($v5852812704452739261incr == 0); $v5852812704452739261loop->index = $v5852812704452739261incr + 1; $v5852812704452739261loop->index0 = $v5852812704452739261incr; $v5852812704452739261loop->revindex = $v5852812704452739261loop->length - $v5852812704452739261incr; $v5852812704452739261loop->revindex0 = $v5852812704452739261loop->length - ($v5852812704452739261incr + 1); $v5852812704452739261loop->last = ($v5852812704452739261incr == ($v5852812704452739261loop->length - 1)); ?>
                <?php if ($index % 5 == 0) { ?>
                    <div class="col-md-2 col-sm-3 col-xs-6">
                    <ul class="list1">
                <?php } ?>
                <li><a href="<?php echo $itemFooterMenu['link']; ?>"><?php echo $itemFooterMenu['title']; ?></a></li>
                <?php if ($index % 5 == 4 || $v5852812704452739261loop->last) { ?>
                    </ul>
                    </div>
                <?php } ?>
            <?php $v5852812704452739261incr++; } ?>
