            ...
            <div class="row">
                ...
                <div class="col-ldh-9 col-sm-8">
                    ...
                    <div class="tabs tabs-style-iconbox">
                        <nav>
                            <ul>
                                <li class="tab-current"><a href="/bxh.html" class="icon icon-baihat"><span>Bài hát</span></a>
                                </li>
                                <li class=""><a href="/bxh.html?t=video"
                                                class="icon icon-video"><span>Video</span></a></li>
                                <li class=""><a href="/bxh.html?t=topic"
                                                class="icon icon-chude"><span>Chủ đề</span></a></li>
                                <li class=""><a href="/bxh.html?t=album"
                                                class="icon icon-album"><span>Album</span></a></li>
                                <li class=""><a href="/bxh.html?t=playlist"
                                ...
                                <article class="chart-row <?php echo $cl; ?>">
                                    <div class="row-primary">
                                        ...
                                        <div class="row-title">
                                            ...
                                            <h3>
                                                <?php if ($item['artist']) { ?>
                                                <?php $v8969721660915514502iterator = $item['artist']; $v8969721660915514502incr = 0; $v8969721660915514502loop = new stdClass(); $v8969721660915514502loop->length = count($v8969721660915514502iterator); $v8969721660915514502loop->index = 1; $v8969721660915514502loop->index0 = 1; $v8969721660915514502loop->revindex = $v8969721660915514502loop->length; $v8969721660915514502loop->revindex0 = $v8969721660915514502loop->length - 1; ?><?php foreach ($v8969721660915514502iterator as $itemchild) { ?><?php $v8969721660915514502loop->first = ($v8969721660915514502incr == 0); $v8969721660915514502loop->index = $v8969721660915514502incr + 1; $v8969721660915514502loop->index0 = $v8969721660915514502incr; $v8969721660915514502loop->revindex = $v8969721660915514502loop->length - $v8969721660915514502incr; $v8969721660915514502loop->revindex0 = $v8969721660915514502loop->length - ($v8969721660915514502incr + 1); $v8969721660915514502loop->last = ($v8969721660915514502incr == ($v8969721660915514502loop->length - 1)); ?>
                                                <a href="<?php echo $itemchild['link']; ?>"
                                                   title="<?php echo $itemchild['username']; ?>"><?php echo $itemchild['username']; ?></a>
                                                <?php if (!$v8969721660915514502loop->last) { ?><span
                                                        style="font-weight: normal;">ft</span><?php } ?>
                                                    <?php $v8969721660915514502incr++; } ?>
                                                <?php } ?>
                                            </h3>
...
<footer>
    <div class="container">
        <div class="row">
            <?php $v8969721660915514501iterator = $listCategory_footer; $v8969721660915514501incr = 0; $v8969721660915514501loop = new stdClass(); $v8969721660915514501loop->length = count($v8969721660915514501iterator); $v8969721660915514501loop->index = 1; $v8969721660915514501loop->index0 = 1; $v8969721660915514501loop->revindex = $v8969721660915514501loop->length; $v8969721660915514501loop->revindex0 = $v8969721660915514501loop->length - 1; ?><?php foreach ($v8969721660915514501iterator as $index => $itemFooterMenu) { ?><?php $v8969721660915514501loop->first = ($v8969721660915514501incr == 0); $v8969721660915514501loop->index = $v8969721660915514501incr + 1; $v8969721660915514501loop->index0 = $v8969721660915514501incr; $v8969721660915514501loop->revindex = $v8969721660915514501loop->length - $v8969721660915514501incr; $v8969721660915514501loop->revindex0 = $v8969721660915514501loop->length - ($v8969721660915514501incr + 1); $v8969721660915514501loop->last = ($v8969721660915514501incr == ($v8969721660915514501loop->length - 1)); ?>
                <?php if ($index % 5 == 0) { ?>
                    <div class="col-md-2 col-sm-3 col-xs-6">
                    <ul class="list1">
                <?php } ?>
                <li><a href="<?php echo $itemFooterMenu['link']; ?>"><?php echo $itemFooterMenu['title']; ?></a></li>
                <?php if ($index % 5 == 4 || $v8969721660915514501loop->last) { ?>
                    </ul>
                    </div>
                <?php } ?>
            <?php $v8969721660915514501incr++; } ?>
