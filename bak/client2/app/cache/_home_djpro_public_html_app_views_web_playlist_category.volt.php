...
<div id="content">
    <div class="bg-cmmusic">
        <div class="container">
            <ul class="breadcrumbs">
                ...
                <?php if ($category->type == 'topic') { ?>
                    <li><a href="/chu-de.html">Chủ đề</a></li>
                <?php } elseif ($category->type == 'playlist') { ?>
                    <li><a href="/playlist.html">Playlist</a></li>
                <?php } elseif ($category->type == 'album') { ?>
        ...
        <div class="container">
            <div class="row">
                <div class="col-ldh-9 col-sm-8">
                    <div class="td_headingw"><h2><a href="<?php echo $category->link; ?>"><?php echo $category->name; ?></a><i
    ...
    <?php $v67052695168639273361iterator = $item['listartist']; $v67052695168639273361incr = 0; $v67052695168639273361loop = new stdClass(); $v67052695168639273361loop->length = count($v67052695168639273361iterator); $v67052695168639273361loop->index = 1; $v67052695168639273361loop->index0 = 1; $v67052695168639273361loop->revindex = $v67052695168639273361loop->length; $v67052695168639273361loop->revindex0 = $v67052695168639273361loop->length - 1; ?><?php foreach ($v67052695168639273361iterator as $itemchild) { ?><?php $v67052695168639273361loop->first = ($v67052695168639273361incr == 0); $v67052695168639273361loop->index = $v67052695168639273361incr + 1; $v67052695168639273361loop->index0 = $v67052695168639273361incr; $v67052695168639273361loop->revindex = $v67052695168639273361loop->length - $v67052695168639273361incr; $v67052695168639273361loop->revindex0 = $v67052695168639273361loop->length - ($v67052695168639273361incr + 1); $v67052695168639273361loop->last = ($v67052695168639273361incr == ($v67052695168639273361loop->length - 1)); ?>
    <a class="subtitle" href="<?php echo $itemchild['link']; ?>"
       title="<?php echo $itemchild['username']; ?>"><?php echo $itemchild['username']; ?></a><?php if (!$v67052695168639273361loop->last) { ?><span class="bull" style="font-size:12px;">Ft </span><?php } ?>
    <?php $v67052695168639273361incr++; } ?>
...
<footer>
    <div class="container">
        <div class="row">
            <?php $v67052695168639273361iterator = $listCategory_footer; $v67052695168639273361incr = 0; $v67052695168639273361loop = new stdClass(); $v67052695168639273361loop->length = count($v67052695168639273361iterator); $v67052695168639273361loop->index = 1; $v67052695168639273361loop->index0 = 1; $v67052695168639273361loop->revindex = $v67052695168639273361loop->length; $v67052695168639273361loop->revindex0 = $v67052695168639273361loop->length - 1; ?><?php foreach ($v67052695168639273361iterator as $index => $itemFooterMenu) { ?><?php $v67052695168639273361loop->first = ($v67052695168639273361incr == 0); $v67052695168639273361loop->index = $v67052695168639273361incr + 1; $v67052695168639273361loop->index0 = $v67052695168639273361incr; $v67052695168639273361loop->revindex = $v67052695168639273361loop->length - $v67052695168639273361incr; $v67052695168639273361loop->revindex0 = $v67052695168639273361loop->length - ($v67052695168639273361incr + 1); $v67052695168639273361loop->last = ($v67052695168639273361incr == ($v67052695168639273361loop->length - 1)); ?>
                <?php if ($index % 5 == 0) { ?>
                    <div class="col-md-2 col-sm-3 col-xs-6">
                    <ul class="list1">
                <?php } ?>
                <li><a href="<?php echo $itemFooterMenu['link']; ?>"><?php echo $itemFooterMenu['title']; ?></a></li>
                <?php if ($index % 5 == 4 || $v67052695168639273361loop->last) { ?>
                    </ul>
                    </div>
                <?php } ?>
            <?php $v67052695168639273361incr++; } ?>
