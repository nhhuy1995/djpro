        ...
        <div class="container">
            <div class="row">
                <div class="col-ldh-9 col-sm-8">
                    ...
                    <div data-special-type="app" class="player-container">
                        <ul id="playlist" class="song-list">
                            <?php foreach ($listAudioSelectvie as $item) { ?>
                                <li>
                                    <span class="song-title"><a href="<?php echo $item['link']; ?>" class="tooltip-top"
                                                                title="<?php echo $item['name']; ?>"><?php echo $item['name']; ?></a></span>
                                <span class="song-duration">
...
<footer>
    <div class="container">
        <div class="row">
            <?php $v46461888546602501291iterator = $listCategory_footer; $v46461888546602501291incr = 0; $v46461888546602501291loop = new stdClass(); $v46461888546602501291loop->length = count($v46461888546602501291iterator); $v46461888546602501291loop->index = 1; $v46461888546602501291loop->index0 = 1; $v46461888546602501291loop->revindex = $v46461888546602501291loop->length; $v46461888546602501291loop->revindex0 = $v46461888546602501291loop->length - 1; ?><?php foreach ($v46461888546602501291iterator as $index => $itemFooterMenu) { ?><?php $v46461888546602501291loop->first = ($v46461888546602501291incr == 0); $v46461888546602501291loop->index = $v46461888546602501291incr + 1; $v46461888546602501291loop->index0 = $v46461888546602501291incr; $v46461888546602501291loop->revindex = $v46461888546602501291loop->length - $v46461888546602501291incr; $v46461888546602501291loop->revindex0 = $v46461888546602501291loop->length - ($v46461888546602501291incr + 1); $v46461888546602501291loop->last = ($v46461888546602501291incr == ($v46461888546602501291loop->length - 1)); ?>
                <?php if ($index % 5 == 0) { ?>
                    <div class="col-md-2 col-sm-3 col-xs-6">
                    <ul class="list1">
                <?php } ?>
                <li><a href="<?php echo $itemFooterMenu['link']; ?>"><?php echo $itemFooterMenu['title']; ?></a></li>
                <?php if ($index % 5 == 4 || $v46461888546602501291loop->last) { ?>
                    </ul>
                    </div>
                <?php } ?>
            <?php $v46461888546602501291incr++; } ?>
