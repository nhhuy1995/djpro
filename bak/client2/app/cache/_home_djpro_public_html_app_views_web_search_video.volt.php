...
<div id="content">
    ...
    <div class="bg-cmmusic">
        <div class="container">
            <ul class="breadcrumbs">
                ...
                <li><a href="/tim-kiem/video.html?q=<?php echo $keyword; ?>"><?php echo $_GET['q']; ?></a></li>
            </ul>
        </div>
        <div class="container">
            <div class="row">
    ...
    <?php $v73052276670492057331iterator = $item['listartist']; $v73052276670492057331incr = 0; $v73052276670492057331loop = new stdClass(); $v73052276670492057331loop->length = count($v73052276670492057331iterator); $v73052276670492057331loop->index = 1; $v73052276670492057331loop->index0 = 1; $v73052276670492057331loop->revindex = $v73052276670492057331loop->length; $v73052276670492057331loop->revindex0 = $v73052276670492057331loop->length - 1; ?><?php foreach ($v73052276670492057331iterator as $itemchild) { ?><?php $v73052276670492057331loop->first = ($v73052276670492057331incr == 0); $v73052276670492057331loop->index = $v73052276670492057331incr + 1; $v73052276670492057331loop->index0 = $v73052276670492057331incr; $v73052276670492057331loop->revindex = $v73052276670492057331loop->length - $v73052276670492057331incr; $v73052276670492057331loop->revindex0 = $v73052276670492057331loop->length - ($v73052276670492057331incr + 1); $v73052276670492057331loop->last = ($v73052276670492057331incr == ($v73052276670492057331loop->length - 1)); ?>
    <a class="subtitle" href="<?php echo $itemchild['link']; ?>"
       title="<?php echo $itemchild['username']; ?>"><?php echo $itemchild['username']; ?></a><?php if (!$v73052276670492057331loop->last) { ?><span class="bull" style="font-size:12px;">Ft </span><?php } ?>
    <?php $v73052276670492057331incr++; } ?>
...
<footer>
    <div class="container">
        <div class="row">
            <?php $v73052276670492057331iterator = $listCategory_footer; $v73052276670492057331incr = 0; $v73052276670492057331loop = new stdClass(); $v73052276670492057331loop->length = count($v73052276670492057331iterator); $v73052276670492057331loop->index = 1; $v73052276670492057331loop->index0 = 1; $v73052276670492057331loop->revindex = $v73052276670492057331loop->length; $v73052276670492057331loop->revindex0 = $v73052276670492057331loop->length - 1; ?><?php foreach ($v73052276670492057331iterator as $index => $itemFooterMenu) { ?><?php $v73052276670492057331loop->first = ($v73052276670492057331incr == 0); $v73052276670492057331loop->index = $v73052276670492057331incr + 1; $v73052276670492057331loop->index0 = $v73052276670492057331incr; $v73052276670492057331loop->revindex = $v73052276670492057331loop->length - $v73052276670492057331incr; $v73052276670492057331loop->revindex0 = $v73052276670492057331loop->length - ($v73052276670492057331incr + 1); $v73052276670492057331loop->last = ($v73052276670492057331incr == ($v73052276670492057331loop->length - 1)); ?>
                <?php if ($index % 5 == 0) { ?>
                    <div class="col-md-2 col-sm-3 col-xs-6">
                    <ul class="list1">
                <?php } ?>
                <li><a href="<?php echo $itemFooterMenu['link']; ?>"><?php echo $itemFooterMenu['title']; ?></a></li>
                <?php if ($index % 5 == 4 || $v73052276670492057331loop->last) { ?>
                    </ul>
                    </div>
                <?php } ?>
            <?php $v73052276670492057331incr++; } ?>
