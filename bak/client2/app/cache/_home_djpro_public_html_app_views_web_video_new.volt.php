...
<div id="content">
    ...
    <?php $v112310337055430526011iterator = $item['listartist']; $v112310337055430526011incr = 0; $v112310337055430526011loop = new stdClass(); $v112310337055430526011loop->length = count($v112310337055430526011iterator); $v112310337055430526011loop->index = 1; $v112310337055430526011loop->index0 = 1; $v112310337055430526011loop->revindex = $v112310337055430526011loop->length; $v112310337055430526011loop->revindex0 = $v112310337055430526011loop->length - 1; ?><?php foreach ($v112310337055430526011iterator as $itemchild) { ?><?php $v112310337055430526011loop->first = ($v112310337055430526011incr == 0); $v112310337055430526011loop->index = $v112310337055430526011incr + 1; $v112310337055430526011loop->index0 = $v112310337055430526011incr; $v112310337055430526011loop->revindex = $v112310337055430526011loop->length - $v112310337055430526011incr; $v112310337055430526011loop->revindex0 = $v112310337055430526011loop->length - ($v112310337055430526011incr + 1); $v112310337055430526011loop->last = ($v112310337055430526011incr == ($v112310337055430526011loop->length - 1)); ?>
    <a class="subtitle" href="<?php echo $itemchild['link']; ?>"
       title="<?php echo $itemchild['username']; ?>"><?php echo $itemchild['username']; ?></a><?php if (!$v112310337055430526011loop->last) { ?><span class="bull" style="font-size:12px;">Ft </span><?php } ?>
    <?php $v112310337055430526011incr++; } ?>
...
<footer>
    <div class="container">
        <div class="row">
            <?php $v112310337055430526011iterator = $listCategory_footer; $v112310337055430526011incr = 0; $v112310337055430526011loop = new stdClass(); $v112310337055430526011loop->length = count($v112310337055430526011iterator); $v112310337055430526011loop->index = 1; $v112310337055430526011loop->index0 = 1; $v112310337055430526011loop->revindex = $v112310337055430526011loop->length; $v112310337055430526011loop->revindex0 = $v112310337055430526011loop->length - 1; ?><?php foreach ($v112310337055430526011iterator as $index => $itemFooterMenu) { ?><?php $v112310337055430526011loop->first = ($v112310337055430526011incr == 0); $v112310337055430526011loop->index = $v112310337055430526011incr + 1; $v112310337055430526011loop->index0 = $v112310337055430526011incr; $v112310337055430526011loop->revindex = $v112310337055430526011loop->length - $v112310337055430526011incr; $v112310337055430526011loop->revindex0 = $v112310337055430526011loop->length - ($v112310337055430526011incr + 1); $v112310337055430526011loop->last = ($v112310337055430526011incr == ($v112310337055430526011loop->length - 1)); ?>
                <?php if ($index % 5 == 0) { ?>
                    <div class="col-md-2 col-sm-3 col-xs-6">
                    <ul class="list1">
                <?php } ?>
                <li><a href="<?php echo $itemFooterMenu['link']; ?>"><?php echo $itemFooterMenu['title']; ?></a></li>
                <?php if ($index % 5 == 4 || $v112310337055430526011loop->last) { ?>
                    </ul>
                    </div>
                <?php } ?>
            <?php $v112310337055430526011incr++; } ?>
