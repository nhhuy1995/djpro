    ...
    <div class="bg-news">
        <div class="container">
            <ul class="breadcrumbs">
                ...
                <li><a href="<?php echo $catinfo->link; ?>"><?php echo $catinfo->name; ?></a></li>
            </ul>
        </div>
        <div class="container">
            <div class="row">
                            ...
                            <div class="thumbnail-news col-md-6 col-sm-12">
                                <figure>
                                    <a href="<?php echo $item['link']; ?>" title="<?php echo $item['name']; ?>">
                                        <img src="<?php echo $item['priavatar']; ?>" title="<?php echo $item['name']; ?>" alt="<?php echo $item['name']; ?>">
                                    </a>
                                </figure>
                                <div class="caption">
                                    ...
                                    <p class="date">
                                        ...
                                        <i class="fa fa-clock-o"></i> <?php echo date('d/m/y | H:i:s', $item['datecreate']); ?>
                                    </p>
                                </div>
                            </div>
                        <?php } ?>
...
<footer>
    <div class="container">
        <div class="row">
            <?php $v79934820733571871231iterator = $listCategory_footer; $v79934820733571871231incr = 0; $v79934820733571871231loop = new stdClass(); $v79934820733571871231loop->length = count($v79934820733571871231iterator); $v79934820733571871231loop->index = 1; $v79934820733571871231loop->index0 = 1; $v79934820733571871231loop->revindex = $v79934820733571871231loop->length; $v79934820733571871231loop->revindex0 = $v79934820733571871231loop->length - 1; ?><?php foreach ($v79934820733571871231iterator as $index => $itemFooterMenu) { ?><?php $v79934820733571871231loop->first = ($v79934820733571871231incr == 0); $v79934820733571871231loop->index = $v79934820733571871231incr + 1; $v79934820733571871231loop->index0 = $v79934820733571871231incr; $v79934820733571871231loop->revindex = $v79934820733571871231loop->length - $v79934820733571871231incr; $v79934820733571871231loop->revindex0 = $v79934820733571871231loop->length - ($v79934820733571871231incr + 1); $v79934820733571871231loop->last = ($v79934820733571871231incr == ($v79934820733571871231loop->length - 1)); ?>
                <?php if ($index % 5 == 0) { ?>
                    <div class="col-md-2 col-sm-3 col-xs-6">
                    <ul class="list1">
                <?php } ?>
                <li><a href="<?php echo $itemFooterMenu['link']; ?>"><?php echo $itemFooterMenu['title']; ?></a></li>
                <?php if ($index % 5 == 4 || $v79934820733571871231loop->last) { ?>
                    </ul>
                    </div>
                <?php } ?>
            <?php $v79934820733571871231incr++; } ?>
