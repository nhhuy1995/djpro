...
<footer>
    <div class="container">
        <div class="row">
            <?php $v119880313647153423491iterator = $listCategory_footer; $v119880313647153423491incr = 0; $v119880313647153423491loop = new stdClass(); $v119880313647153423491loop->length = count($v119880313647153423491iterator); $v119880313647153423491loop->index = 1; $v119880313647153423491loop->index0 = 1; $v119880313647153423491loop->revindex = $v119880313647153423491loop->length; $v119880313647153423491loop->revindex0 = $v119880313647153423491loop->length - 1; ?><?php foreach ($v119880313647153423491iterator as $index => $itemFooterMenu) { ?><?php $v119880313647153423491loop->first = ($v119880313647153423491incr == 0); $v119880313647153423491loop->index = $v119880313647153423491incr + 1; $v119880313647153423491loop->index0 = $v119880313647153423491incr; $v119880313647153423491loop->revindex = $v119880313647153423491loop->length - $v119880313647153423491incr; $v119880313647153423491loop->revindex0 = $v119880313647153423491loop->length - ($v119880313647153423491incr + 1); $v119880313647153423491loop->last = ($v119880313647153423491incr == ($v119880313647153423491loop->length - 1)); ?>
                <?php if ($index % 5 == 0) { ?>
                    <div class="col-md-2 col-sm-3 col-xs-6">
                    <ul class="list1">
                <?php } ?>
                <li><a href="<?php echo $itemFooterMenu['link']; ?>"><?php echo $itemFooterMenu['title']; ?></a></li>
                <?php if ($index % 5 == 4 || $v119880313647153423491loop->last) { ?>
                    </ul>
                    </div>
                <?php } ?>
            <?php $v119880313647153423491incr++; } ?>
