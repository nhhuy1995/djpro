                        ...
                        <?php foreach ($listdata as $item) { ?>
                            <div class="thumbnail-news col-md-6 col-sm-12">
                                ...
                                <div class="caption">
                                    ...
                                    <p class="date"><i
                                                class="fa fa-clock-o"></i> <?php echo date('d/m/y | H:i:s', $item['datecreate']); ?>
                                    </p>
                                </div>
                            </div>
                        <?php } ?>
...
<footer>
    <div class="container">
        <div class="row">
            <?php $v110289924328699579171iterator = $listCategory_footer; $v110289924328699579171incr = 0; $v110289924328699579171loop = new stdClass(); $v110289924328699579171loop->length = count($v110289924328699579171iterator); $v110289924328699579171loop->index = 1; $v110289924328699579171loop->index0 = 1; $v110289924328699579171loop->revindex = $v110289924328699579171loop->length; $v110289924328699579171loop->revindex0 = $v110289924328699579171loop->length - 1; ?><?php foreach ($v110289924328699579171iterator as $index => $itemFooterMenu) { ?><?php $v110289924328699579171loop->first = ($v110289924328699579171incr == 0); $v110289924328699579171loop->index = $v110289924328699579171incr + 1; $v110289924328699579171loop->index0 = $v110289924328699579171incr; $v110289924328699579171loop->revindex = $v110289924328699579171loop->length - $v110289924328699579171incr; $v110289924328699579171loop->revindex0 = $v110289924328699579171loop->length - ($v110289924328699579171incr + 1); $v110289924328699579171loop->last = ($v110289924328699579171incr == ($v110289924328699579171loop->length - 1)); ?>
                <?php if ($index % 5 == 0) { ?>
                    <div class="col-md-2 col-sm-3 col-xs-6">
                    <ul class="list1">
                <?php } ?>
                <li><a href="<?php echo $itemFooterMenu['link']; ?>"><?php echo $itemFooterMenu['title']; ?></a></li>
                <?php if ($index % 5 == 4 || $v110289924328699579171loop->last) { ?>
                    </ul>
                    </div>
                <?php } ?>
            <?php $v110289924328699579171incr++; } ?>
