...
<div id="content">
                    ...
                    <div class="tabs tabs-style-linemove">
                        ...
                        <div class="content-wrap">
                            <section id="section-linemove-1" class="content-current">
                                <div class="td_heading"><h2><span class="while"><a href="/nhac-da-xoa.html?t=audio">Bài hát</a> (<span id="clkeyword"><?php echo $countaudio; ?></span>)<i class="fa fa-angle-right"></i></span>
                                    </h2></div>
                                <?php if ($listmedia) { ?>
    ...
    <?php $v164455312461808551031iterator = $item['listartist']; $v164455312461808551031incr = 0; $v164455312461808551031loop = new stdClass(); $v164455312461808551031loop->length = count($v164455312461808551031iterator); $v164455312461808551031loop->index = 1; $v164455312461808551031loop->index0 = 1; $v164455312461808551031loop->revindex = $v164455312461808551031loop->length; $v164455312461808551031loop->revindex0 = $v164455312461808551031loop->length - 1; ?><?php foreach ($v164455312461808551031iterator as $itemchild) { ?><?php $v164455312461808551031loop->first = ($v164455312461808551031incr == 0); $v164455312461808551031loop->index = $v164455312461808551031incr + 1; $v164455312461808551031loop->index0 = $v164455312461808551031incr; $v164455312461808551031loop->revindex = $v164455312461808551031loop->length - $v164455312461808551031incr; $v164455312461808551031loop->revindex0 = $v164455312461808551031loop->length - ($v164455312461808551031incr + 1); $v164455312461808551031loop->last = ($v164455312461808551031incr == ($v164455312461808551031loop->length - 1)); ?>
    <a class="subtitle" href="<?php echo $itemchild['link']; ?>"
       title="<?php echo $itemchild['username']; ?>"><?php echo $itemchild['username']; ?></a><?php if (!$v164455312461808551031loop->last) { ?><span class="bull" style="font-size:12px;">Ft </span><?php } ?>
    <?php $v164455312461808551031incr++; } ?>
    ...
    <?php } ?>
                                ...
                                <?php } else { ?>
                                    <p>Chưa cập nhật!</p>
                                <?php } ?>
                                <div class="td_heading"><h2><span class="while"><a href="/nhac-da-xoa.html?t=video">Video</a> (<span id="clkeyword"><?php echo $countvideo; ?></span>)<i
                                                    class="fa fa-angle-right"></i></span></h2></div>
                                <?php if ($listvideo) { ?>
                                    <div class="row">
...
<footer>
    <div class="container">
        <div class="row">
            <?php $v164455312461808551031iterator = $listCategory_footer; $v164455312461808551031incr = 0; $v164455312461808551031loop = new stdClass(); $v164455312461808551031loop->length = count($v164455312461808551031iterator); $v164455312461808551031loop->index = 1; $v164455312461808551031loop->index0 = 1; $v164455312461808551031loop->revindex = $v164455312461808551031loop->length; $v164455312461808551031loop->revindex0 = $v164455312461808551031loop->length - 1; ?><?php foreach ($v164455312461808551031iterator as $index => $itemFooterMenu) { ?><?php $v164455312461808551031loop->first = ($v164455312461808551031incr == 0); $v164455312461808551031loop->index = $v164455312461808551031incr + 1; $v164455312461808551031loop->index0 = $v164455312461808551031incr; $v164455312461808551031loop->revindex = $v164455312461808551031loop->length - $v164455312461808551031incr; $v164455312461808551031loop->revindex0 = $v164455312461808551031loop->length - ($v164455312461808551031incr + 1); $v164455312461808551031loop->last = ($v164455312461808551031incr == ($v164455312461808551031loop->length - 1)); ?>
                <?php if ($index % 5 == 0) { ?>
                    <div class="col-md-2 col-sm-3 col-xs-6">
                    <ul class="list1">
                <?php } ?>
                <li><a href="<?php echo $itemFooterMenu['link']; ?>"><?php echo $itemFooterMenu['title']; ?></a></li>
                <?php if ($index % 5 == 4 || $v164455312461808551031loop->last) { ?>
                    </ul>
                    </div>
                <?php } ?>
            <?php $v164455312461808551031incr++; } ?>
