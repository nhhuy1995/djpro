    ...
    <div class="bg-BXH">
        <div class="container">
            <ul class="breadcrumbs">
                ...
                <li><a href="/bai-hat-de-cu.html">TOP đề cử</a></li>
            </ul>
        </div>
        <div class="container">
            <div class="row">
                ...
                <div class="col-ldh-9 col-sm-8">
                    ...
                    <div class="td_heading"><h2><span class="while">TOP để cử bởi thành viên<i
                    ...
                    <div class="tabs tabs-style-iconbox">
                        <nav>
                            <ul>
                                ...
                                <li class=""><a href="/bai-hat-de-cu.html" class="icon icon-baihat"><span>Bài hát</span></a>
                                </li>
                                <li class=""><a href="/bai-hat-de-cu.html?t=video" class="icon icon-video"><span>Video</span></a></li>
                                <li class="<?php if ($_GET['t'] == 'topic') { ?> tab-current <?php } ?>"><a href="/bai-hat-de-cu.html?t=topic" class="icon icon-chude"><span>Chủ đề</span></a></li>
                                <li class="<?php if ($_GET['t'] == 'album') { ?> tab-current <?php } ?>"><a href="/bai-hat-de-cu.html?t=album" class="icon icon-album"><span>Album</span></a></li>
                                <li class="<?php if ($_GET['t'] == 'playlist') { ?> tab-current <?php } ?>"><a href="/bai-hat-de-cu.html?t=playlist" class="icon icon-playlist"><span>Playlist</span></a></li>
                            </ul>
                        </nav>
                        <div class="content-wrap">
                            <?php if ($this->length($listAlbum) == 1) { ?> <?php $cl_listAlbum = 'style="height:200px"'; ?> <?php } ?>
                            <section id="section-linemove-4" <?php echo $cl_listAlbum; ?> class="content-current">
                                ...
                                <article class="chart-row <?php echo $cl; ?>">
                                    <div class="row-primary">
                                        ...
                                        <div class="row-title">
                                            ...
                                            <h3>
                                                <?php if ($item['artist']) { ?>
                                                <?php $v161596847346962149272iterator = $item['artist']; $v161596847346962149272incr = 0; $v161596847346962149272loop = new stdClass(); $v161596847346962149272loop->length = count($v161596847346962149272iterator); $v161596847346962149272loop->index = 1; $v161596847346962149272loop->index0 = 1; $v161596847346962149272loop->revindex = $v161596847346962149272loop->length; $v161596847346962149272loop->revindex0 = $v161596847346962149272loop->length - 1; ?><?php foreach ($v161596847346962149272iterator as $itemchild) { ?><?php $v161596847346962149272loop->first = ($v161596847346962149272incr == 0); $v161596847346962149272loop->index = $v161596847346962149272incr + 1; $v161596847346962149272loop->index0 = $v161596847346962149272incr; $v161596847346962149272loop->revindex = $v161596847346962149272loop->length - $v161596847346962149272incr; $v161596847346962149272loop->revindex0 = $v161596847346962149272loop->length - ($v161596847346962149272incr + 1); $v161596847346962149272loop->last = ($v161596847346962149272incr == ($v161596847346962149272loop->length - 1)); ?>
                                                <a href="<?php echo $itemchild['link']; ?>"
                                                   title="<?php echo $itemchild['username']; ?>"><?php echo $itemchild['username']; ?></a>
                                                <?php if (!$v161596847346962149272loop->last) { ?><span style="font-weight: normal;">ft</span><?php } ?>
                                                    <?php $v161596847346962149272incr++; } ?>
                                                <?php } ?>
                                            </h3>
                                            <span><i class="fa fa-headphones"></i> <?php echo $item['nomination']; ?> </span>
                                        </div>
                                        ...
                                        <div class="row-watch">
                                           <span class="<?php echo $clparent; ?>">
                                                <a class="tooltip-top <?php echo $clchildren; ?>" data-original-title="Thêm vào"
...
<footer>
    <div class="container">
        <div class="row">
            <?php $v161596847346962149271iterator = $listCategory_footer; $v161596847346962149271incr = 0; $v161596847346962149271loop = new stdClass(); $v161596847346962149271loop->length = count($v161596847346962149271iterator); $v161596847346962149271loop->index = 1; $v161596847346962149271loop->index0 = 1; $v161596847346962149271loop->revindex = $v161596847346962149271loop->length; $v161596847346962149271loop->revindex0 = $v161596847346962149271loop->length - 1; ?><?php foreach ($v161596847346962149271iterator as $index => $itemFooterMenu) { ?><?php $v161596847346962149271loop->first = ($v161596847346962149271incr == 0); $v161596847346962149271loop->index = $v161596847346962149271incr + 1; $v161596847346962149271loop->index0 = $v161596847346962149271incr; $v161596847346962149271loop->revindex = $v161596847346962149271loop->length - $v161596847346962149271incr; $v161596847346962149271loop->revindex0 = $v161596847346962149271loop->length - ($v161596847346962149271incr + 1); $v161596847346962149271loop->last = ($v161596847346962149271incr == ($v161596847346962149271loop->length - 1)); ?>
                <?php if ($index % 5 == 0) { ?>
                    <div class="col-md-2 col-sm-3 col-xs-6">
                    <ul class="list1">
                <?php } ?>
                <li><a href="<?php echo $itemFooterMenu['link']; ?>"><?php echo $itemFooterMenu['title']; ?></a></li>
                <?php if ($index % 5 == 4 || $v161596847346962149271loop->last) { ?>
                    </ul>
                    </div>
                <?php } ?>
            <?php $v161596847346962149271incr++; } ?>
