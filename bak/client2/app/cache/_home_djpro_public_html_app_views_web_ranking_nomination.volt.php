            ...
            <div class="row">
                ...
                <div class="col-ldh-9 col-sm-8">
                    ...
                    <div class="tabs tabs-style-iconbox">
                        <nav>
                            <ul>
                                <li class="tab-current"><a href="/bai-hat-de-cu.html" class="icon icon-baihat"><span>Bài hát</span></a>
                                </li>
                        ...
                        <div class="content-wrap">
                            <?php if ($this->length($listAudio) == 1) { ?> <?php $cl_listAudio = 'style="height:200px"'; ?> <?php } ?>
                            <section id="section-linemove-1" <?php echo $cl_listAudio; ?> class="content-current">
                                ...
                                <article class="chart-row <?php echo $cl; ?>">
                                    <div class="row-primary">
                                        ...
                                        <div class="row-title">
                                            ...
                                            <h3>
                                                <?php if ($item['artist']) { ?>
                                                <?php $v403136954752009582iterator = $item['artist']; $v403136954752009582incr = 0; $v403136954752009582loop = new stdClass(); $v403136954752009582loop->length = count($v403136954752009582iterator); $v403136954752009582loop->index = 1; $v403136954752009582loop->index0 = 1; $v403136954752009582loop->revindex = $v403136954752009582loop->length; $v403136954752009582loop->revindex0 = $v403136954752009582loop->length - 1; ?><?php foreach ($v403136954752009582iterator as $itemchild) { ?><?php $v403136954752009582loop->first = ($v403136954752009582incr == 0); $v403136954752009582loop->index = $v403136954752009582incr + 1; $v403136954752009582loop->index0 = $v403136954752009582incr; $v403136954752009582loop->revindex = $v403136954752009582loop->length - $v403136954752009582incr; $v403136954752009582loop->revindex0 = $v403136954752009582loop->length - ($v403136954752009582incr + 1); $v403136954752009582loop->last = ($v403136954752009582incr == ($v403136954752009582loop->length - 1)); ?>
                                                <a href="<?php echo $itemchild['link']; ?>"
                                                   title="<?php echo $itemchild['username']; ?>"><?php echo $itemchild['username']; ?></a>
                                                <?php if (!$v403136954752009582loop->last) { ?><span style="font-weight: normal;">ft</span><?php } ?>
                                                    <?php $v403136954752009582incr++; } ?>
                                                <?php } ?>
                                            </h3>
...
<footer>
    <div class="container">
        <div class="row">
            <?php $v403136954752009581iterator = $listCategory_footer; $v403136954752009581incr = 0; $v403136954752009581loop = new stdClass(); $v403136954752009581loop->length = count($v403136954752009581iterator); $v403136954752009581loop->index = 1; $v403136954752009581loop->index0 = 1; $v403136954752009581loop->revindex = $v403136954752009581loop->length; $v403136954752009581loop->revindex0 = $v403136954752009581loop->length - 1; ?><?php foreach ($v403136954752009581iterator as $index => $itemFooterMenu) { ?><?php $v403136954752009581loop->first = ($v403136954752009581incr == 0); $v403136954752009581loop->index = $v403136954752009581incr + 1; $v403136954752009581loop->index0 = $v403136954752009581incr; $v403136954752009581loop->revindex = $v403136954752009581loop->length - $v403136954752009581incr; $v403136954752009581loop->revindex0 = $v403136954752009581loop->length - ($v403136954752009581incr + 1); $v403136954752009581loop->last = ($v403136954752009581incr == ($v403136954752009581loop->length - 1)); ?>
                <?php if ($index % 5 == 0) { ?>
                    <div class="col-md-2 col-sm-3 col-xs-6">
                    <ul class="list1">
                <?php } ?>
                <li><a href="<?php echo $itemFooterMenu['link']; ?>"><?php echo $itemFooterMenu['title']; ?></a></li>
                <?php if ($index % 5 == 4 || $v403136954752009581loop->last) { ?>
                    </ul>
                    </div>
                <?php } ?>
            <?php $v403136954752009581incr++; } ?>
