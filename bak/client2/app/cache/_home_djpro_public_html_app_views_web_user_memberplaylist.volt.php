...
<div id="content">
            ...
            <div class="row">
                <div class="col-ldh-9 col-sm-8">
                    <div class="tabs tabs-style-linemove">
                        <nav>
                            <ul>
                                <li class=""><a href="<?php echo $uinfo->link; ?>"
                                ...
                                <li class="tab-current"><a href="<?php echo $uinfo->link; ?>?t=playlist"
    ...
    <?php $v41884189735526392971iterator = $item['listartist']; $v41884189735526392971incr = 0; $v41884189735526392971loop = new stdClass(); $v41884189735526392971loop->length = count($v41884189735526392971iterator); $v41884189735526392971loop->index = 1; $v41884189735526392971loop->index0 = 1; $v41884189735526392971loop->revindex = $v41884189735526392971loop->length; $v41884189735526392971loop->revindex0 = $v41884189735526392971loop->length - 1; ?><?php foreach ($v41884189735526392971iterator as $itemchild) { ?><?php $v41884189735526392971loop->first = ($v41884189735526392971incr == 0); $v41884189735526392971loop->index = $v41884189735526392971incr + 1; $v41884189735526392971loop->index0 = $v41884189735526392971incr; $v41884189735526392971loop->revindex = $v41884189735526392971loop->length - $v41884189735526392971incr; $v41884189735526392971loop->revindex0 = $v41884189735526392971loop->length - ($v41884189735526392971incr + 1); $v41884189735526392971loop->last = ($v41884189735526392971incr == ($v41884189735526392971loop->length - 1)); ?>
    <a class="subtitle" href="<?php echo $itemchild['link']; ?>"
       title="<?php echo $itemchild['username']; ?>"><?php echo $itemchild['username']; ?></a><?php if (!$v41884189735526392971loop->last) { ?><span class="bull" style="font-size:12px;">Ft </span><?php } ?>
    <?php $v41884189735526392971incr++; } ?>
...
<footer>
    <div class="container">
        <div class="row">
            <?php $v41884189735526392971iterator = $listCategory_footer; $v41884189735526392971incr = 0; $v41884189735526392971loop = new stdClass(); $v41884189735526392971loop->length = count($v41884189735526392971iterator); $v41884189735526392971loop->index = 1; $v41884189735526392971loop->index0 = 1; $v41884189735526392971loop->revindex = $v41884189735526392971loop->length; $v41884189735526392971loop->revindex0 = $v41884189735526392971loop->length - 1; ?><?php foreach ($v41884189735526392971iterator as $index => $itemFooterMenu) { ?><?php $v41884189735526392971loop->first = ($v41884189735526392971incr == 0); $v41884189735526392971loop->index = $v41884189735526392971incr + 1; $v41884189735526392971loop->index0 = $v41884189735526392971incr; $v41884189735526392971loop->revindex = $v41884189735526392971loop->length - $v41884189735526392971incr; $v41884189735526392971loop->revindex0 = $v41884189735526392971loop->length - ($v41884189735526392971incr + 1); $v41884189735526392971loop->last = ($v41884189735526392971incr == ($v41884189735526392971loop->length - 1)); ?>
                <?php if ($index % 5 == 0) { ?>
                    <div class="col-md-2 col-sm-3 col-xs-6">
                    <ul class="list1">
                <?php } ?>
                <li><a href="<?php echo $itemFooterMenu['link']; ?>"><?php echo $itemFooterMenu['title']; ?></a></li>
                <?php if ($index % 5 == 4 || $v41884189735526392971loop->last) { ?>
                    </ul>
                    </div>
                <?php } ?>
            <?php $v41884189735526392971incr++; } ?>
