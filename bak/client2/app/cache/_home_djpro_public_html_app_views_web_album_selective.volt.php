...
<div id="content">
    <div class="bg-cmmusic">
        <div class="container">
            <ul class="breadcrumbs">
                ...
                <li><a href="/album-chon-loc.html">Album chọn lọc</a></li>
            </ul>
        </div>
        <div class="container">
            <div class="row">
                <div class="col-ldh-9 col-sm-8">
                    <div class="td_headingw"><h2><a href="/album-chon-loc.html">ALBUM CHỌN LỌC</a><i
                                    class="fa fa-angle-right"></i></h2></div>
                    <div class="row">
                        <?php foreach ($listAlbum_selective as $item) { ?>
    ...
    <?php $v45957928182895620291iterator = $item['listartist']; $v45957928182895620291incr = 0; $v45957928182895620291loop = new stdClass(); $v45957928182895620291loop->length = count($v45957928182895620291iterator); $v45957928182895620291loop->index = 1; $v45957928182895620291loop->index0 = 1; $v45957928182895620291loop->revindex = $v45957928182895620291loop->length; $v45957928182895620291loop->revindex0 = $v45957928182895620291loop->length - 1; ?><?php foreach ($v45957928182895620291iterator as $itemchild) { ?><?php $v45957928182895620291loop->first = ($v45957928182895620291incr == 0); $v45957928182895620291loop->index = $v45957928182895620291incr + 1; $v45957928182895620291loop->index0 = $v45957928182895620291incr; $v45957928182895620291loop->revindex = $v45957928182895620291loop->length - $v45957928182895620291incr; $v45957928182895620291loop->revindex0 = $v45957928182895620291loop->length - ($v45957928182895620291incr + 1); $v45957928182895620291loop->last = ($v45957928182895620291incr == ($v45957928182895620291loop->length - 1)); ?>
    <a class="subtitle" href="<?php echo $itemchild['link']; ?>"
       title="<?php echo $itemchild['username']; ?>"><?php echo $itemchild['username']; ?></a><?php if (!$v45957928182895620291loop->last) { ?><span class="bull" style="font-size:12px;">Ft </span><?php } ?>
    <?php $v45957928182895620291incr++; } ?>
...
<footer>
    <div class="container">
        <div class="row">
            <?php $v45957928182895620291iterator = $listCategory_footer; $v45957928182895620291incr = 0; $v45957928182895620291loop = new stdClass(); $v45957928182895620291loop->length = count($v45957928182895620291iterator); $v45957928182895620291loop->index = 1; $v45957928182895620291loop->index0 = 1; $v45957928182895620291loop->revindex = $v45957928182895620291loop->length; $v45957928182895620291loop->revindex0 = $v45957928182895620291loop->length - 1; ?><?php foreach ($v45957928182895620291iterator as $index => $itemFooterMenu) { ?><?php $v45957928182895620291loop->first = ($v45957928182895620291incr == 0); $v45957928182895620291loop->index = $v45957928182895620291incr + 1; $v45957928182895620291loop->index0 = $v45957928182895620291incr; $v45957928182895620291loop->revindex = $v45957928182895620291loop->length - $v45957928182895620291incr; $v45957928182895620291loop->revindex0 = $v45957928182895620291loop->length - ($v45957928182895620291incr + 1); $v45957928182895620291loop->last = ($v45957928182895620291incr == ($v45957928182895620291loop->length - 1)); ?>
                <?php if ($index % 5 == 0) { ?>
                    <div class="col-md-2 col-sm-3 col-xs-6">
                    <ul class="list1">
                <?php } ?>
                <li><a href="<?php echo $itemFooterMenu['link']; ?>"><?php echo $itemFooterMenu['title']; ?></a></li>
                <?php if ($index % 5 == 4 || $v45957928182895620291loop->last) { ?>
                    </ul>
                    </div>
                <?php } ?>
            <?php $v45957928182895620291incr++; } ?>
