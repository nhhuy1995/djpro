...
<div id="content">
        ...
        <div class="container">
            <div class="row">
                <div class="col-ldh-9 col-sm-8">
                    <div class="row">
                        <?php foreach ($listVideo_selective as $item) { ?>
                            <div class="col-md-3 col-sm-3 col-xs-6">
                                <div class="block-music">
                                    <div class="cover-outer-align">
                                        <a href="<?php echo $item['link']; ?>" title="<?php echo $item['name']; ?>">
                                            <img class="img-responsive" src="<?php echo $item['priavatar']; ?>" alt=""/>
                                        </a>
    ...
    <?php $v167369754115363475391iterator = $item['listartist']; $v167369754115363475391incr = 0; $v167369754115363475391loop = new stdClass(); $v167369754115363475391loop->length = count($v167369754115363475391iterator); $v167369754115363475391loop->index = 1; $v167369754115363475391loop->index0 = 1; $v167369754115363475391loop->revindex = $v167369754115363475391loop->length; $v167369754115363475391loop->revindex0 = $v167369754115363475391loop->length - 1; ?><?php foreach ($v167369754115363475391iterator as $itemchild) { ?><?php $v167369754115363475391loop->first = ($v167369754115363475391incr == 0); $v167369754115363475391loop->index = $v167369754115363475391incr + 1; $v167369754115363475391loop->index0 = $v167369754115363475391incr; $v167369754115363475391loop->revindex = $v167369754115363475391loop->length - $v167369754115363475391incr; $v167369754115363475391loop->revindex0 = $v167369754115363475391loop->length - ($v167369754115363475391incr + 1); $v167369754115363475391loop->last = ($v167369754115363475391incr == ($v167369754115363475391loop->length - 1)); ?>
    <a class="subtitle" href="<?php echo $itemchild['link']; ?>"
       title="<?php echo $itemchild['username']; ?>"><?php echo $itemchild['username']; ?></a><?php if (!$v167369754115363475391loop->last) { ?><span class="bull" style="font-size:12px;">Ft </span><?php } ?>
    <?php $v167369754115363475391incr++; } ?>
...
<footer>
    <div class="container">
        <div class="row">
            <?php $v167369754115363475391iterator = $listCategory_footer; $v167369754115363475391incr = 0; $v167369754115363475391loop = new stdClass(); $v167369754115363475391loop->length = count($v167369754115363475391iterator); $v167369754115363475391loop->index = 1; $v167369754115363475391loop->index0 = 1; $v167369754115363475391loop->revindex = $v167369754115363475391loop->length; $v167369754115363475391loop->revindex0 = $v167369754115363475391loop->length - 1; ?><?php foreach ($v167369754115363475391iterator as $index => $itemFooterMenu) { ?><?php $v167369754115363475391loop->first = ($v167369754115363475391incr == 0); $v167369754115363475391loop->index = $v167369754115363475391incr + 1; $v167369754115363475391loop->index0 = $v167369754115363475391incr; $v167369754115363475391loop->revindex = $v167369754115363475391loop->length - $v167369754115363475391incr; $v167369754115363475391loop->revindex0 = $v167369754115363475391loop->length - ($v167369754115363475391incr + 1); $v167369754115363475391loop->last = ($v167369754115363475391incr == ($v167369754115363475391loop->length - 1)); ?>
                <?php if ($index % 5 == 0) { ?>
                    <div class="col-md-2 col-sm-3 col-xs-6">
                    <ul class="list1">
                <?php } ?>
                <li><a href="<?php echo $itemFooterMenu['link']; ?>"><?php echo $itemFooterMenu['title']; ?></a></li>
                <?php if ($index % 5 == 4 || $v167369754115363475391loop->last) { ?>
                    </ul>
                    </div>
                <?php } ?>
            <?php $v167369754115363475391incr++; } ?>
