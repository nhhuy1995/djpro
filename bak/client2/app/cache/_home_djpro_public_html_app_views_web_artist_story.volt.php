                    ...
                    <div class="info-artist fluid">
                        ...
                        <div class="info-summary">
                            ...
                            <?php if ($object->description) { ?>
                                <p><?php echo $object->description; ?> <a href="<?php echo $object->link; ?>?t=info">Tiểu
                                        sử <?php echo $object->username; ?></a></p>
                            <?php } ?>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                    ...
                    <div class="tabs tabs-style-iconbox">
                        <nav>
                            <ul>
                                ...
                                <li class="tabs_artist"><a href="<?php echo $object->link; ?>?t=audio"
                                ...
                                <li class="tabs_artist tab-current" id="story"><a class="icon icon-tieusu"
                                                                                  href="<?php echo $object->link; ?>?t=info"><span>Tiểu sử</span></a>
                                </li>
                            </ul>
                        </nav>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-9 col-xs-7 col-sm-7">
                                    <?php if (isset($object->type)) { ?>
                                        <?php $v31336665192942167841iterator = $object->type; $v31336665192942167841incr = 0; $v31336665192942167841loop = new stdClass(); $v31336665192942167841loop->length = count($v31336665192942167841iterator); $v31336665192942167841loop->index = 1; $v31336665192942167841loop->index0 = 1; $v31336665192942167841loop->revindex = $v31336665192942167841loop->length; $v31336665192942167841loop->revindex0 = $v31336665192942167841loop->length - 1; ?><?php foreach ($v31336665192942167841iterator as $item) { ?><?php $v31336665192942167841loop->first = ($v31336665192942167841incr == 0); $v31336665192942167841loop->index = $v31336665192942167841incr + 1; $v31336665192942167841loop->index0 = $v31336665192942167841incr; $v31336665192942167841loop->revindex = $v31336665192942167841loop->length - $v31336665192942167841incr; $v31336665192942167841loop->revindex0 = $v31336665192942167841loop->length - ($v31336665192942167841incr + 1); $v31336665192942167841loop->last = ($v31336665192942167841incr == ($v31336665192942167841loop->length - 1)); ?>
                                            <?php echo $artisttype[$item]; ?><?php if (!$v31336665192942167841loop->last) { ?>, <?php } ?>
                                        <?php $v31336665192942167841incr++; } ?>
                                    <?php } else { ?>
                                        Đang cập nhật
                                    <?php } ?>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-9 col-xs-7 col-sm-7">
                                    <?php if (isset($listCate)) { ?>
                                        <?php $v31336665192942167841iterator = $listCate; $v31336665192942167841incr = 0; $v31336665192942167841loop = new stdClass(); $v31336665192942167841loop->length = count($v31336665192942167841iterator); $v31336665192942167841loop->index = 1; $v31336665192942167841loop->index0 = 1; $v31336665192942167841loop->revindex = $v31336665192942167841loop->length; $v31336665192942167841loop->revindex0 = $v31336665192942167841loop->length - 1; ?><?php foreach ($v31336665192942167841iterator as $item) { ?><?php $v31336665192942167841loop->first = ($v31336665192942167841incr == 0); $v31336665192942167841loop->index = $v31336665192942167841incr + 1; $v31336665192942167841loop->index0 = $v31336665192942167841incr; $v31336665192942167841loop->revindex = $v31336665192942167841loop->length - $v31336665192942167841incr; $v31336665192942167841loop->revindex0 = $v31336665192942167841loop->length - ($v31336665192942167841incr + 1); $v31336665192942167841loop->last = ($v31336665192942167841incr == ($v31336665192942167841loop->length - 1)); ?>
                                            <?php echo $item['name']; ?><?php if (!$v31336665192942167841loop->last) { ?>, <?php } ?>
                                        <?php $v31336665192942167841incr++; } ?>
                                    <?php } else { ?>
                                        Đang cập nhật
                                    <?php } ?>
                ...
                <div class="col-ldh-3 col-sm-4">
                    <div class="sidebar">
                        ...
                        <ul class="dsartist">
                            <?php $v31336665192942167841iterator = $listartist; $v31336665192942167841incr = 0; $v31336665192942167841loop = new stdClass(); $v31336665192942167841loop->length = count($v31336665192942167841iterator); $v31336665192942167841loop->index = 1; $v31336665192942167841loop->index0 = 1; $v31336665192942167841loop->revindex = $v31336665192942167841loop->length; $v31336665192942167841loop->revindex0 = $v31336665192942167841loop->length - 1; ?><?php foreach ($v31336665192942167841iterator as $item) { ?><?php $v31336665192942167841loop->first = ($v31336665192942167841incr == 0); $v31336665192942167841loop->index = $v31336665192942167841incr + 1; $v31336665192942167841loop->index0 = $v31336665192942167841incr; $v31336665192942167841loop->revindex = $v31336665192942167841loop->length - $v31336665192942167841incr; $v31336665192942167841loop->revindex0 = $v31336665192942167841loop->length - ($v31336665192942167841incr + 1); $v31336665192942167841loop->last = ($v31336665192942167841incr == ($v31336665192942167841loop->length - 1)); ?>
                                <li>
...
<footer>
    <div class="container">
        <div class="row">
            <?php $v31336665192942167841iterator = $listCategory_footer; $v31336665192942167841incr = 0; $v31336665192942167841loop = new stdClass(); $v31336665192942167841loop->length = count($v31336665192942167841iterator); $v31336665192942167841loop->index = 1; $v31336665192942167841loop->index0 = 1; $v31336665192942167841loop->revindex = $v31336665192942167841loop->length; $v31336665192942167841loop->revindex0 = $v31336665192942167841loop->length - 1; ?><?php foreach ($v31336665192942167841iterator as $index => $itemFooterMenu) { ?><?php $v31336665192942167841loop->first = ($v31336665192942167841incr == 0); $v31336665192942167841loop->index = $v31336665192942167841incr + 1; $v31336665192942167841loop->index0 = $v31336665192942167841incr; $v31336665192942167841loop->revindex = $v31336665192942167841loop->length - $v31336665192942167841incr; $v31336665192942167841loop->revindex0 = $v31336665192942167841loop->length - ($v31336665192942167841incr + 1); $v31336665192942167841loop->last = ($v31336665192942167841incr == ($v31336665192942167841loop->length - 1)); ?>
                <?php if ($index % 5 == 0) { ?>
                    <div class="col-md-2 col-sm-3 col-xs-6">
                    <ul class="list1">
                <?php } ?>
                <li><a href="<?php echo $itemFooterMenu['link']; ?>"><?php echo $itemFooterMenu['title']; ?></a></li>
                <?php if ($index % 5 == 4 || $v31336665192942167841loop->last) { ?>
                    </ul>
                    </div>
                <?php } ?>
            <?php $v31336665192942167841incr++; } ?>
