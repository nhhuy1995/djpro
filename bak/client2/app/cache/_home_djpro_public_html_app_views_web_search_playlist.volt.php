...
<footer>
    <div class="container">
        <div class="row">
            <?php $v5869005039091673281iterator = $listCategory_footer; $v5869005039091673281incr = 0; $v5869005039091673281loop = new stdClass(); $v5869005039091673281loop->length = count($v5869005039091673281iterator); $v5869005039091673281loop->index = 1; $v5869005039091673281loop->index0 = 1; $v5869005039091673281loop->revindex = $v5869005039091673281loop->length; $v5869005039091673281loop->revindex0 = $v5869005039091673281loop->length - 1; ?><?php foreach ($v5869005039091673281iterator as $index => $itemFooterMenu) { ?><?php $v5869005039091673281loop->first = ($v5869005039091673281incr == 0); $v5869005039091673281loop->index = $v5869005039091673281incr + 1; $v5869005039091673281loop->index0 = $v5869005039091673281incr; $v5869005039091673281loop->revindex = $v5869005039091673281loop->length - $v5869005039091673281incr; $v5869005039091673281loop->revindex0 = $v5869005039091673281loop->length - ($v5869005039091673281incr + 1); $v5869005039091673281loop->last = ($v5869005039091673281incr == ($v5869005039091673281loop->length - 1)); ?>
                <?php if ($index % 5 == 0) { ?>
                    <div class="col-md-2 col-sm-3 col-xs-6">
                    <ul class="list1">
                <?php } ?>
                <li><a href="<?php echo $itemFooterMenu['link']; ?>"><?php echo $itemFooterMenu['title']; ?></a></li>
                <?php if ($index % 5 == 4 || $v5869005039091673281loop->last) { ?>
                    </ul>
                    </div>
                <?php } ?>
            <?php $v5869005039091673281incr++; } ?>
