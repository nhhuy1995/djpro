...
<div id="content">
            ...
            <div class="row">
                <div class="col-ldh-9 col-sm-8">
                    <div class="tabs tabs-style-linemove">
                        <nav>
                            <ul>
                                <li class="tab-current"><a href="<?php echo $uinfo->link; ?>"
                                                           class="icon icon-all"><span>Tất cả</span></a></li>
                                <li class=""><a href="<?php echo $uinfo->link; ?>?t=audio" class="icon icon-baihat"><span>Bài hát đã đăng</span></a>
                                </li>
                                <li class=""><a href="<?php echo $uinfo->link; ?>?t=playlist"
                                                class="icon icon-playlist"><span>Playlist đã đăng</span></a></li>
                                <li class=""><a href="<?php echo $uinfo->link; ?>?t=video"
                        ...
                        <div class="content-wrap">
                            <section id="section-linemove-1" class="content-current">
                                <div class="td_heading">
                                    <h2>
                                        <span class="while"><a href="<?php echo $uinfo->link; ?>?t=audio">Bài hát</a> (<span id="clkeyword"><?php echo $countaudio; ?></span>)<i class="fa fa-angle-right"></i></span>
                                    </h2>
                                </div>
                                <?php if ($listmedia) { ?>
                                ...
                                <?php } else { ?>
                                    <p>Chưa cập nhật!</p>
                                <?php } ?>
                                <div class="td_heading"><h2><span class="while"><a href="<?php echo $uinfo->link; ?>?t=playlist">Playlist</a> (<span id="clkeyword"><?php echo $countplaylist; ?></span>) <i class="fa fa-angle-right"></i></span></h2></div>
                                <?php if ($listplaylist) { ?>
                                    <div class="row">
    ...
    <?php $v153375667441928107671iterator = $item['listartist']; $v153375667441928107671incr = 0; $v153375667441928107671loop = new stdClass(); $v153375667441928107671loop->length = count($v153375667441928107671iterator); $v153375667441928107671loop->index = 1; $v153375667441928107671loop->index0 = 1; $v153375667441928107671loop->revindex = $v153375667441928107671loop->length; $v153375667441928107671loop->revindex0 = $v153375667441928107671loop->length - 1; ?><?php foreach ($v153375667441928107671iterator as $itemchild) { ?><?php $v153375667441928107671loop->first = ($v153375667441928107671incr == 0); $v153375667441928107671loop->index = $v153375667441928107671incr + 1; $v153375667441928107671loop->index0 = $v153375667441928107671incr; $v153375667441928107671loop->revindex = $v153375667441928107671loop->length - $v153375667441928107671incr; $v153375667441928107671loop->revindex0 = $v153375667441928107671loop->length - ($v153375667441928107671incr + 1); $v153375667441928107671loop->last = ($v153375667441928107671incr == ($v153375667441928107671loop->length - 1)); ?>
    <a class="subtitle" href="<?php echo $itemchild['link']; ?>"
       title="<?php echo $itemchild['username']; ?>"><?php echo $itemchild['username']; ?></a><?php if (!$v153375667441928107671loop->last) { ?><span class="bull" style="font-size:12px;">Ft </span><?php } ?>
    <?php $v153375667441928107671incr++; } ?>
    ...
    <?php } ?>
                                ...
                                <?php } else { ?>
                                    <p>Chưa cập nhật!</p>
                                <?php } ?>
                                <div class="td_heading"><h2><span class="while"><a href="<?php echo $uinfo->link; ?>?t=video">Video</a> (<span id="clkeyword"><?php echo $countvideo; ?></span>)<i
                    ...
                    <div class="shadow">
                        ...
                        <div class="summary">
                            ...
                            <ul class="menuSub">
                                ...
                                <li><i class="fa fa-birthday-cake"></i> Ngày sinh: <?php echo $uinfo->days; ?>/<?php echo $uinfo->month; ?>/<?php echo $uinfo->year; ?></li>
...
<footer>
    <div class="container">
        <div class="row">
            <?php $v153375667441928107671iterator = $listCategory_footer; $v153375667441928107671incr = 0; $v153375667441928107671loop = new stdClass(); $v153375667441928107671loop->length = count($v153375667441928107671iterator); $v153375667441928107671loop->index = 1; $v153375667441928107671loop->index0 = 1; $v153375667441928107671loop->revindex = $v153375667441928107671loop->length; $v153375667441928107671loop->revindex0 = $v153375667441928107671loop->length - 1; ?><?php foreach ($v153375667441928107671iterator as $index => $itemFooterMenu) { ?><?php $v153375667441928107671loop->first = ($v153375667441928107671incr == 0); $v153375667441928107671loop->index = $v153375667441928107671incr + 1; $v153375667441928107671loop->index0 = $v153375667441928107671incr; $v153375667441928107671loop->revindex = $v153375667441928107671loop->length - $v153375667441928107671incr; $v153375667441928107671loop->revindex0 = $v153375667441928107671loop->length - ($v153375667441928107671incr + 1); $v153375667441928107671loop->last = ($v153375667441928107671incr == ($v153375667441928107671loop->length - 1)); ?>
                <?php if ($index % 5 == 0) { ?>
                    <div class="col-md-2 col-sm-3 col-xs-6">
                    <ul class="list1">
                <?php } ?>
                <li><a href="<?php echo $itemFooterMenu['link']; ?>"><?php echo $itemFooterMenu['title']; ?></a></li>
                <?php if ($index % 5 == 4 || $v153375667441928107671loop->last) { ?>
                    </ul>
                    </div>
                <?php } ?>
            <?php $v153375667441928107671incr++; } ?>
