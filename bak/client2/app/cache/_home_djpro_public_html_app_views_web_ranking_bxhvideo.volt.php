                    ...
                    <div class="tabs tabs-style-iconbox">
                        <nav>
                            <ul>
                                ...
                                <li class="tab-current"><a href="/bxh.html?t=video"
                                ...
                                <article class="chart-row <?php echo $cl; ?>">
                                    <div class="row-primary">
                                        ...
                                        <div class="row-title">
                                            ...
                                            <h3>
                                                <?php if ($item['artist']) { ?>
                                                <?php $v85857190467494573712iterator = $item['artist']; $v85857190467494573712incr = 0; $v85857190467494573712loop = new stdClass(); $v85857190467494573712loop->length = count($v85857190467494573712iterator); $v85857190467494573712loop->index = 1; $v85857190467494573712loop->index0 = 1; $v85857190467494573712loop->revindex = $v85857190467494573712loop->length; $v85857190467494573712loop->revindex0 = $v85857190467494573712loop->length - 1; ?><?php foreach ($v85857190467494573712iterator as $itemchild) { ?><?php $v85857190467494573712loop->first = ($v85857190467494573712incr == 0); $v85857190467494573712loop->index = $v85857190467494573712incr + 1; $v85857190467494573712loop->index0 = $v85857190467494573712incr; $v85857190467494573712loop->revindex = $v85857190467494573712loop->length - $v85857190467494573712incr; $v85857190467494573712loop->revindex0 = $v85857190467494573712loop->length - ($v85857190467494573712incr + 1); $v85857190467494573712loop->last = ($v85857190467494573712incr == ($v85857190467494573712loop->length - 1)); ?>
                                                <a href="<?php echo $itemchild['link']; ?>"
                                                   title="<?php echo $itemchild['username']; ?>"><?php echo $itemchild['username']; ?></a>
                                                <?php if (!$v85857190467494573712loop->last) { ?><span
                                                        style="font-weight: normal;">ft</span><?php } ?>
                                                    <?php $v85857190467494573712incr++; } ?>
                                                <?php } ?>
                                            </h3>
...
<footer>
    <div class="container">
        <div class="row">
            <?php $v85857190467494573711iterator = $listCategory_footer; $v85857190467494573711incr = 0; $v85857190467494573711loop = new stdClass(); $v85857190467494573711loop->length = count($v85857190467494573711iterator); $v85857190467494573711loop->index = 1; $v85857190467494573711loop->index0 = 1; $v85857190467494573711loop->revindex = $v85857190467494573711loop->length; $v85857190467494573711loop->revindex0 = $v85857190467494573711loop->length - 1; ?><?php foreach ($v85857190467494573711iterator as $index => $itemFooterMenu) { ?><?php $v85857190467494573711loop->first = ($v85857190467494573711incr == 0); $v85857190467494573711loop->index = $v85857190467494573711incr + 1; $v85857190467494573711loop->index0 = $v85857190467494573711incr; $v85857190467494573711loop->revindex = $v85857190467494573711loop->length - $v85857190467494573711incr; $v85857190467494573711loop->revindex0 = $v85857190467494573711loop->length - ($v85857190467494573711incr + 1); $v85857190467494573711loop->last = ($v85857190467494573711incr == ($v85857190467494573711loop->length - 1)); ?>
                <?php if ($index % 5 == 0) { ?>
                    <div class="col-md-2 col-sm-3 col-xs-6">
                    <ul class="list1">
                <?php } ?>
                <li><a href="<?php echo $itemFooterMenu['link']; ?>"><?php echo $itemFooterMenu['title']; ?></a></li>
                <?php if ($index % 5 == 4 || $v85857190467494573711loop->last) { ?>
                    </ul>
                    </div>
                <?php } ?>
            <?php $v85857190467494573711incr++; } ?>
