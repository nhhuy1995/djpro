...
<div id="content">
    <div class="bg-cmmusic">
        <div class="container">
            <ul class="breadcrumbs">
                ...
                <li><a href="/tim-kiem/chu-de.html?q=<?php echo $keyword; ?>"><?php echo $_GET['q']; ?></a></li>
            </ul>
        </div>
        <div class="container">
            <div class="row">
                <div class="col-ldh-9 col-sm-8">
                    <div class="td_headingw"><h2>Danh sách chủ đề theo
    ...
    <?php $v73024600098646637251iterator = $item['listartist']; $v73024600098646637251incr = 0; $v73024600098646637251loop = new stdClass(); $v73024600098646637251loop->length = count($v73024600098646637251iterator); $v73024600098646637251loop->index = 1; $v73024600098646637251loop->index0 = 1; $v73024600098646637251loop->revindex = $v73024600098646637251loop->length; $v73024600098646637251loop->revindex0 = $v73024600098646637251loop->length - 1; ?><?php foreach ($v73024600098646637251iterator as $itemchild) { ?><?php $v73024600098646637251loop->first = ($v73024600098646637251incr == 0); $v73024600098646637251loop->index = $v73024600098646637251incr + 1; $v73024600098646637251loop->index0 = $v73024600098646637251incr; $v73024600098646637251loop->revindex = $v73024600098646637251loop->length - $v73024600098646637251incr; $v73024600098646637251loop->revindex0 = $v73024600098646637251loop->length - ($v73024600098646637251incr + 1); $v73024600098646637251loop->last = ($v73024600098646637251incr == ($v73024600098646637251loop->length - 1)); ?>
    <a class="subtitle" href="<?php echo $itemchild['link']; ?>"
       title="<?php echo $itemchild['username']; ?>"><?php echo $itemchild['username']; ?></a><?php if (!$v73024600098646637251loop->last) { ?><span class="bull" style="font-size:12px;">Ft </span><?php } ?>
    <?php $v73024600098646637251incr++; } ?>
...
<footer>
    <div class="container">
        <div class="row">
            <?php $v73024600098646637251iterator = $listCategory_footer; $v73024600098646637251incr = 0; $v73024600098646637251loop = new stdClass(); $v73024600098646637251loop->length = count($v73024600098646637251iterator); $v73024600098646637251loop->index = 1; $v73024600098646637251loop->index0 = 1; $v73024600098646637251loop->revindex = $v73024600098646637251loop->length; $v73024600098646637251loop->revindex0 = $v73024600098646637251loop->length - 1; ?><?php foreach ($v73024600098646637251iterator as $index => $itemFooterMenu) { ?><?php $v73024600098646637251loop->first = ($v73024600098646637251incr == 0); $v73024600098646637251loop->index = $v73024600098646637251incr + 1; $v73024600098646637251loop->index0 = $v73024600098646637251incr; $v73024600098646637251loop->revindex = $v73024600098646637251loop->length - $v73024600098646637251incr; $v73024600098646637251loop->revindex0 = $v73024600098646637251loop->length - ($v73024600098646637251incr + 1); $v73024600098646637251loop->last = ($v73024600098646637251incr == ($v73024600098646637251loop->length - 1)); ?>
                <?php if ($index % 5 == 0) { ?>
                    <div class="col-md-2 col-sm-3 col-xs-6">
                    <ul class="list1">
                <?php } ?>
                <li><a href="<?php echo $itemFooterMenu['link']; ?>"><?php echo $itemFooterMenu['title']; ?></a></li>
                <?php if ($index % 5 == 4 || $v73024600098646637251loop->last) { ?>
                    </ul>
                    </div>
                <?php } ?>
            <?php $v73024600098646637251incr++; } ?>
