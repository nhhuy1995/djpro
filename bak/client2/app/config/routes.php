...
$router->add("/s/nhac-da-duyet.html", array(
    'controller' => 'musicofmy',
    'action' => 'audioon'
));
$router->add("/v/nhac-da-duyet.html", array(
    'controller' => 'musicofmy',
    'action' => 'videoon'
));
$router->add("/p/nhac-da-duyet.html", array(
    'controller' => 'musicofmy',
    'action' => 'playliston'
));
...
$router->add("/s/nhac-cho-duyet.html", array(
    'controller' => 'musicofmy',
    'action' => 'audiooff'
));
$router->add("/v/nhac-cho-duyet.html", array(
    'controller' => 'musicofmy',
    'action' => 'videooff'
));
$router->add("/p/nhac-cho-duyet.html", array(
    'controller' => 'musicofmy',
    'action' => 'playlistoff'
));
## nhạc đã xóa
...
$router->add("/s/nhac-da-xoa.html", array(
    'controller' => 'musicofmy',
    'action' => 'audiodelete'
));
$router->add("/v/nhac-da-xoa.html", array(
    'controller' => 'musicofmy',
    'action' => 'videodelete'
));
$router->add("/p/nhac-da-xoa.html", array(
    'controller' => 'musicofmy',
