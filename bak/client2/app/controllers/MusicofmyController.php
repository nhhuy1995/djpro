...
class MusicofmyController extends ControllerBase
{
    ...
    public function indexonAction()
    {
        ...
        unset($data);
        $this->view->title = "Danh sách nhạc đã duyệt của tôi ";
    }
    ...
    public function indexoffAction()
    {
        ...
        $this->view->uinfo = $uinfo;
        unset($data);
        $this->view->title = "Danh sách nhạc chờ duyệt của tôi ";
    }
    ...
    public function indexdeleteAction()
    {
        ...
        $this->view->uinfo = $uinfo;
        unset($data);
        $this->view->title = "Danh sách nhạc đã xóa của tôi ";
    }
    ...
    function musicofmy($type, $status)
    {
        ...
        $this->view->uinfo = $uinfo;
        $this->view->title = $title_header.$title_status;
    }
}
