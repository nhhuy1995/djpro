/*! WolfjPlayer v2.2.1 */ ! function(a, b) {
        ...
        function(a, b) {
            jPlayerPlaylist = function(b, c, d) {
                ...
                _createListItem: function(b) {
                    ...
                    return d += "<a href='javascript:;' class='" + this.options.playlistOptions.itemClass + "' tabindex='1'>" + b.title + (b.artist ? " <span class='jp-artist'>" + WolfjPlayerParams.byText + " " + b.artist + "</span>" : "") + "</a>", d += "<span class='wolf-jp-song-url'>", b.download ? d += "<a class='free-dl' title='" + WolfjPlayerParams.downloadText + "' target='_blank' href='" + b.download + "'></a>" : ( b.addplaylist && (d += "<a target='_blank' title='" + WolfjPlayerParams.addplaylistText + "' href='" + b.addplaylist + "' class='addplaylist'></a>"), b.like && (d += "<a target='_blank' title='" + WolfjPlayerParams.likeText + "' href='" + b.like + "' class='like'></a>"), b.decu && (d += "<a target='_blank' title='" + WolfjPlayerParams.decuText + "' href='" + b.decu + "' class='decu'></a>"), b.taive && (d += "<a target='_blank' title='" + WolfjPlayerParams.taiveText + "' href='" + b.taive + "' class='taive'></a>"), b.share && (d += "<a target='_blank' title='" + WolfjPlayerParams.shareText + "' href='" + b.share + "' class='share'></a>"), b.popup && (d += "<a target='_blank' title='" + WolfjPlayerParams.popupText + "' href='" + b.popup + "' class='popup'></a>")), d += "</span>", d += "</div></li>"
                },
...
WolfjPlayerUi = function(a) {
    "use strict";
    return {
        playlistContainer: a(".wolf-jplayer-playlist-container"),
        overlay: a(".wolf-jplayer-loader-overlay"),
        loader: a(".wolf-jplayer-loader"),
        Playlist: a(".wolf-jplayer-playlist"),
        clock: 0,
        timer: null,
        isMobile: navigator.userAgent.match(/(iPad)|(iPhone)|(iPod)|(Android)|(PlayBook)|(BB10)|(BlackBerry)|(Opera Mini)|(IEMobile)|(webOS)|(MeeGo)/i),
        init: function() {
            var b = this;
            this.loaderOverlay(), this.Playlist.find("span.close-wolf-jp-share").click(function() {
                a(this).parent().parent().parent().fadeOut()
            }), a(".wolf-jp-share-icon").click(function() {
                var b = a(this).parent().parent().parent();
                b.find(".wolf-jp-overlay").fadeIn()
            }), a(".wolf-share-jp-popup").click(function() {
                var b = window.open(a(this).attr("href"), "null", "height=350,width=570, top=150, left=150");
                return window.focus && b.focus(), !1
        ...
        loaderOverlay: function() {
            ...
            b.timer = setInterval(function() {
                b.clock++, 1 === b.clock && a(".wolf-jplayer-loader").fadeIn(), 8 === b.clock && b.hideOverlay()
            }, 1e3)
        },
        responsive: function() {
            this.Playlist.length && this.Playlist.each(function() {
                var b = a(this).width();
                425 > b ? (a(this).addClass("wolf-jplayer-small-controls"), 235 > b ? a(this).addClass("wolf-jplayer-very-small-controls") : a(this).removeClass("wolf-jplayer-very-small-controls")) : a(this).removeClass("wolf-jplayer-small-controls")
            })
        },
        hideOverlay: function() {
            var a = this;
            a.loader.fadeOut("fast", function() {
                a.overlay.fadeOut("slow", function() {
                    clearInterval(a.timer)
                })
            })
        },
        customScrollbar: function() {
            this.Playlist.length && "1" === WolfjPlayerParams.scrollBar && this.Playlist.each(function() {
                var b = a(this).find(".jp-playlist");
                setTimeout(function() {
                    b.mCustomScrollbar({
                        theme: "light"
                    })
        ...
        pageLoad: function() {
            var b = this;
            this.isMobile || this.customScrollbar(), setTimeout(function() {
                b.hideOverlay()
            }, 1e3), a(window).trigger("resize")
        }
    }
}(jQuery),
        function(a) {
            "use strict";
            WolfjPlayerUi.init(), a(window).load(function() {
