...
class GdThumb extends ThumbBase
{
    ...
    /*Hanv*/
    public function crop2($cropWidth, $cropHeight = null)
    {
        if (!is_numeric($cropWidth)) {
            throw new InvalidArgumentException('$cropWidth must be numeric');
        }
        ...
        $size = $this->currentDimensions['width'] > $this->currentDimensions['height'] ? $this->currentDimensions['height'] : $this->currentDimensions['width'];
