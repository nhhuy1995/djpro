    ...
    public function callbackgoogleAction()
    {
        ...
        if (isset($_GET['code'])) {
            ...
            if (isset($o->_id)) {
                ...
                $this->response->redirect('/trang-chu.html');
            } else {
                $newuser = array(
    ...
    public function callbackfbAction()
    {
        ...
        if (isset($userinfo->id)) {
            ...
            if (isset($o->_id)) {
                ...
                $data = json_decode($json, true);
                $this->session->set('uinfo', $data);
                return $this->response->redirect('/trang-chu.html');
            } else {
                $newuser = array(
                    '_id' => strval(strtotime('now')),
                    'prefix' => $userinfo->id,
        ...
        } else return $this->response->redirect('/trang-chu.html');
    }
...
//        else $uinfo->birthday = date('d/m/Y', $uinfo->birthday);
        ...
        $this->view->title = "Thành viên - " . $uinfo->username;
    }
        ...
        if ($this->request->isPost()) {
            if(strlen($password) < 6) $msg = array('status' => 0, 'msg' => "Mật khẩu phải từ 6 kí tự trở lên");
                ...
                if ($o->_id) {
                    ...
                    $msg = array('status' => 1, 'msg' => "Khôi phục mật khẩu thành công. Click vào <a href='/trang-chu.html' style='color:blue;'>đây</a> để về trang chủ");
    ...
    public function playlistAction()
    {
        ...
        $this->view->listplaylist = $data;
        $this->view->title = 'Playlist của tôi';
    }
