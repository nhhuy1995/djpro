...
class MusicController extends ControllerBase
{
    ...
    public function viewAction()
    {
        ...
        if ($quality == static::$Quality_128K) $media_url = $o->media_link_128k;
        if ($quality == static::$Quality_320K) $media_url = $o->media_link_320k;
    ...
    public function selectiveAction()
    {
        ...
        $this->view->title = 'Bài hát chọn lọc';
