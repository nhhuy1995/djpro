                ...
                <div class="col-ldh-9 col-sm-8">
                    ...
                    <div class="tabs tabs-style-iconbox">
                        ...
                        <div class="content-wrap">
                            {% if listVideo|length ==1 %} {%  set cl_listVideo = 'style="height:200px"' %} {% endif %}
                            <section id="section-linemove-2" {{ cl_listVideo }} class="content-current">
                                {% for key,item in listVideo %}
                                ...
                                <article class="chart-row {{ cl }}">
                                    <div class="row-primary">
                                        ...
                                        <div class="row-imagevd"><a href="{{ item['link'] }}"
                                                                  title="{{ item['name'] }}"><img
                                        ...
                                        <div class="row-watch">
                                           <span class="{{ clparent }}">
                                            ...
                                            <a class="tooltip-top" data-original-title="Tải về"
                                               href="/download.html?id={{ item['_id'] }}">
