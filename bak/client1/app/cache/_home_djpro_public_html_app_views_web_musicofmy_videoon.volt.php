...
<div id="content">
    ...
    <?php $v21419392086676579601iterator = $item['listartist']; $v21419392086676579601incr = 0; $v21419392086676579601loop = new stdClass(); $v21419392086676579601loop->length = count($v21419392086676579601iterator); $v21419392086676579601loop->index = 1; $v21419392086676579601loop->index0 = 1; $v21419392086676579601loop->revindex = $v21419392086676579601loop->length; $v21419392086676579601loop->revindex0 = $v21419392086676579601loop->length - 1; ?><?php foreach ($v21419392086676579601iterator as $itemchild) { ?><?php $v21419392086676579601loop->first = ($v21419392086676579601incr == 0); $v21419392086676579601loop->index = $v21419392086676579601incr + 1; $v21419392086676579601loop->index0 = $v21419392086676579601incr; $v21419392086676579601loop->revindex = $v21419392086676579601loop->length - $v21419392086676579601incr; $v21419392086676579601loop->revindex0 = $v21419392086676579601loop->length - ($v21419392086676579601incr + 1); $v21419392086676579601loop->last = ($v21419392086676579601incr == ($v21419392086676579601loop->length - 1)); ?>
    <a class="subtitle" href="<?php echo $itemchild['link']; ?>"
       title="<?php echo $itemchild['username']; ?>"><?php echo $itemchild['username']; ?></a><?php if (!$v21419392086676579601loop->last) { ?><span class="bull" style="font-size:12px;">Ft </span><?php } ?>
    <?php $v21419392086676579601incr++; } ?>
...
<footer>
    <div class="container">
        <div class="row">
            <?php $v21419392086676579601iterator = $listCategory_footer; $v21419392086676579601incr = 0; $v21419392086676579601loop = new stdClass(); $v21419392086676579601loop->length = count($v21419392086676579601iterator); $v21419392086676579601loop->index = 1; $v21419392086676579601loop->index0 = 1; $v21419392086676579601loop->revindex = $v21419392086676579601loop->length; $v21419392086676579601loop->revindex0 = $v21419392086676579601loop->length - 1; ?><?php foreach ($v21419392086676579601iterator as $index => $itemFooterMenu) { ?><?php $v21419392086676579601loop->first = ($v21419392086676579601incr == 0); $v21419392086676579601loop->index = $v21419392086676579601incr + 1; $v21419392086676579601loop->index0 = $v21419392086676579601incr; $v21419392086676579601loop->revindex = $v21419392086676579601loop->length - $v21419392086676579601incr; $v21419392086676579601loop->revindex0 = $v21419392086676579601loop->length - ($v21419392086676579601incr + 1); $v21419392086676579601loop->last = ($v21419392086676579601incr == ($v21419392086676579601loop->length - 1)); ?>
                <?php if ($index % 5 == 0) { ?>
                    <div class="col-md-2 col-sm-3 col-xs-6">
                    <ul class="list1">
                <?php } ?>
                <li><a href="<?php echo $itemFooterMenu['link']; ?>"><?php echo $itemFooterMenu['title']; ?></a></li>
                <?php if ($index % 5 == 4 || $v21419392086676579601loop->last) { ?>
                    </ul>
                    </div>
                <?php } ?>
            <?php $v21419392086676579601incr++; } ?>
