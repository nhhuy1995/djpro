                ...
                <div class="col-ldh-9 col-sm-8">
                    ...
                    <div data-special-type="app" class="player-container">
                        <ul id="playlist" class="song-list">
                            <?php foreach ($listAudio_selective as $item) { ?>
                                <li>
...
<footer>
    <div class="container">
        <div class="row">
            <?php $v166583716942867040931iterator = $listCategory_footer; $v166583716942867040931incr = 0; $v166583716942867040931loop = new stdClass(); $v166583716942867040931loop->length = count($v166583716942867040931iterator); $v166583716942867040931loop->index = 1; $v166583716942867040931loop->index0 = 1; $v166583716942867040931loop->revindex = $v166583716942867040931loop->length; $v166583716942867040931loop->revindex0 = $v166583716942867040931loop->length - 1; ?><?php foreach ($v166583716942867040931iterator as $index => $itemFooterMenu) { ?><?php $v166583716942867040931loop->first = ($v166583716942867040931incr == 0); $v166583716942867040931loop->index = $v166583716942867040931incr + 1; $v166583716942867040931loop->index0 = $v166583716942867040931incr; $v166583716942867040931loop->revindex = $v166583716942867040931loop->length - $v166583716942867040931incr; $v166583716942867040931loop->revindex0 = $v166583716942867040931loop->length - ($v166583716942867040931incr + 1); $v166583716942867040931loop->last = ($v166583716942867040931incr == ($v166583716942867040931loop->length - 1)); ?>
                <?php if ($index % 5 == 0) { ?>
                    <div class="col-md-2 col-sm-3 col-xs-6">
                    <ul class="list1">
                <?php } ?>
                <li><a href="<?php echo $itemFooterMenu['link']; ?>"><?php echo $itemFooterMenu['title']; ?></a></li>
                <?php if ($index % 5 == 4 || $v166583716942867040931loop->last) { ?>
                    </ul>
                    </div>
                <?php } ?>
            <?php $v166583716942867040931incr++; } ?>
