...
//                enableRemoveControls: true,
                ...
                displayItemAction: function (elem) {
                    return '<span class="wolf-jp-song-url">'
                            <?php if ($session['_id']) { ?>
                            + '<a class="addplaylist" href="javascript:void(0)" title="Thêm vào playlist" onclick="showFormAddPlaylist(' + elem.id + ');"></a>'
                            ...
                            <?php } else { ?>
                            + '<a class="addplaylist" href="javascript:void(0)" title="Thêm vào playlist" onclick="showlogin()"></a>'
                        ...
                        if (re.status == 200) {
                            ...
                            if (data.content != '') {
                                ...
                                var html = '<h2 class="name_lyric"><b>Lời bài hát: ' + data.name + '</b></h2>' +
                                        '<p class="name_post">Lời đăng bởi: <a rel="nofollow" href="' + data.userinfo.link + '" title="' + data.userinfo.username + '">' + data.userinfo.username + '</a></p>';
                                ...
                                var htmlQuality = '<div class="triangle"></div>' +
                                        '<ul>';
                                if (re.media_link_320k != undefined) html += '<li><a href="javascript:void(0)" data-media-src="<?php echo $re->media_link_320k; ?>">320 kb</a></li>';
                                if (re.media_link_128k != undefined) html += '<li><a href="javascript:void(0)" data-media-src="<?php echo $re->media_link_128k; ?>">128 kb</a></li>';
                                if (re.media_link_64k != undefined) html += '<li><a href="javascript:void(0)" data-media-src="<?php echo $re->media_link_64k; ?>">64 kb</a></li>';
                                html += '</ul>';
                        ...
                        <div class="col-md-7 col-sm-12">
                            <div class="info-song-top">
                                ...
                                <div class="info-pd-top">
                                    ...
                                    <p>
                                    <p class="boutdislike"><i class="fa fa-user"></i> Người gửi: <a
                                                href="<?php echo $object->usercreatelink; ?>" style="color: #c73030;"
                                                title="<?php echo $object->usercreate; ?>"><?php echo $object->usercreate; ?></a>
                                        (<?php echo $object->usercreate_namerole; ?>) </p>
                                                ...
                                                <li class="drop">
                                                    ...
                                                    <div class="dropdownContain">
                                                        <div class="dropOut">
                                                            ...
                                                            <ul>
                                                                <li><a href="javascript:void(0)">320 kb</a></li>
                                                                <li><a href="javascript:void(0)">128 kb</a></li>
                                                                <li><a href="javascript:void(0)">64 kb</a></li>
                                                            </ul>
                                                        </div>
                                                    </div>
