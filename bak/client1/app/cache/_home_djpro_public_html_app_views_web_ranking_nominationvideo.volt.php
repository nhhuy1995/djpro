                    ...
                    <div class="tabs tabs-style-iconbox">
                        <nav>
                            <ul>
                                ...
                                <li class="tab-current"><a href="/bai-hat-de-cu.html?t=video" class="icon icon-video"><span>Video</span></a></li>
                                <li class=""><a href="/bai-hat-de-cu.html?t=topic" class="icon icon-chude"><span>Chủ đề</span></a></li>
                                <li class=""><a href="/bai-hat-de-cu.html?t=album" class="icon icon-album"><span>Album</span></a></li>
                                <li class=""><a href="/bai-hat-de-cu.html?t=playlist" class="icon icon-playlist"><span>Playlist</span></a></li>
                            </ul>
                        </nav>
                        <div class="content-wrap">
                            <?php if ($this->length($listVideo) == 1) { ?> <?php $cl_listVideo = 'style="height:200px"'; ?> <?php } ?>
                            <section id="section-linemove-2" <?php echo $cl_listVideo; ?> class="content-current">
                                ...
                                <article class="chart-row <?php echo $cl; ?>">
                                    <div class="row-primary">
                                        ...
                                        <div class="row-title">
                                            ...
                                            <h3>
                                                <?php if ($item['artist']) { ?>
                                                <?php $v161917107924386472852iterator = $item['artist']; $v161917107924386472852incr = 0; $v161917107924386472852loop = new stdClass(); $v161917107924386472852loop->length = count($v161917107924386472852iterator); $v161917107924386472852loop->index = 1; $v161917107924386472852loop->index0 = 1; $v161917107924386472852loop->revindex = $v161917107924386472852loop->length; $v161917107924386472852loop->revindex0 = $v161917107924386472852loop->length - 1; ?><?php foreach ($v161917107924386472852iterator as $itemchild) { ?><?php $v161917107924386472852loop->first = ($v161917107924386472852incr == 0); $v161917107924386472852loop->index = $v161917107924386472852incr + 1; $v161917107924386472852loop->index0 = $v161917107924386472852incr; $v161917107924386472852loop->revindex = $v161917107924386472852loop->length - $v161917107924386472852incr; $v161917107924386472852loop->revindex0 = $v161917107924386472852loop->length - ($v161917107924386472852incr + 1); $v161917107924386472852loop->last = ($v161917107924386472852incr == ($v161917107924386472852loop->length - 1)); ?>
                                                <a href="<?php echo $itemchild['link']; ?>"
                                                   title="<?php echo $itemchild['username']; ?>"><?php echo $itemchild['username']; ?></a>
                                                <?php if (!$v161917107924386472852loop->last) { ?><span style="font-weight: normal;">ft</span><?php } ?>
                                                    <?php $v161917107924386472852incr++; } ?>
                                                <?php } ?>
                                            </h3>
                                        ...
                                        <div class="row-watch">
                                           <span class="<?php echo $clparent; ?>">
                                            ...
                                            <a class="tooltip-top" data-original-title="Tải về"
                                               href="/download.html?id=<?php echo $item['_id']; ?>">
...
<footer>
    <div class="container">
        <div class="row">
            <?php $v161917107924386472851iterator = $listCategory_footer; $v161917107924386472851incr = 0; $v161917107924386472851loop = new stdClass(); $v161917107924386472851loop->length = count($v161917107924386472851iterator); $v161917107924386472851loop->index = 1; $v161917107924386472851loop->index0 = 1; $v161917107924386472851loop->revindex = $v161917107924386472851loop->length; $v161917107924386472851loop->revindex0 = $v161917107924386472851loop->length - 1; ?><?php foreach ($v161917107924386472851iterator as $index => $itemFooterMenu) { ?><?php $v161917107924386472851loop->first = ($v161917107924386472851incr == 0); $v161917107924386472851loop->index = $v161917107924386472851incr + 1; $v161917107924386472851loop->index0 = $v161917107924386472851incr; $v161917107924386472851loop->revindex = $v161917107924386472851loop->length - $v161917107924386472851incr; $v161917107924386472851loop->revindex0 = $v161917107924386472851loop->length - ($v161917107924386472851incr + 1); $v161917107924386472851loop->last = ($v161917107924386472851incr == ($v161917107924386472851loop->length - 1)); ?>
                <?php if ($index % 5 == 0) { ?>
                    <div class="col-md-2 col-sm-3 col-xs-6">
                    <ul class="list1">
                <?php } ?>
                <li><a href="<?php echo $itemFooterMenu['link']; ?>"><?php echo $itemFooterMenu['title']; ?></a></li>
                <?php if ($index % 5 == 4 || $v161917107924386472851loop->last) { ?>
                    </ul>
                    </div>
                <?php } ?>
            <?php $v161917107924386472851incr++; } ?>
