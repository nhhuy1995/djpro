...
<div id="content">
    <div class="bg-cmmusic">
        <div class="container">
            <ul class="breadcrumbs">
                ...
                <li><a href="/playlist-chon-loc.html">Playlist chọn lọc</a></li>
            </ul>
        </div>
        <div class="container">
            <div class="row">
                <div class="col-ldh-9 col-sm-8">
                    ...
                    <div class="row">
                        <?php foreach ($listPlaylist_selective as $item) { ?>
    ...
    <?php $v114961656877956685901iterator = $item['listartist']; $v114961656877956685901incr = 0; $v114961656877956685901loop = new stdClass(); $v114961656877956685901loop->length = count($v114961656877956685901iterator); $v114961656877956685901loop->index = 1; $v114961656877956685901loop->index0 = 1; $v114961656877956685901loop->revindex = $v114961656877956685901loop->length; $v114961656877956685901loop->revindex0 = $v114961656877956685901loop->length - 1; ?><?php foreach ($v114961656877956685901iterator as $itemchild) { ?><?php $v114961656877956685901loop->first = ($v114961656877956685901incr == 0); $v114961656877956685901loop->index = $v114961656877956685901incr + 1; $v114961656877956685901loop->index0 = $v114961656877956685901incr; $v114961656877956685901loop->revindex = $v114961656877956685901loop->length - $v114961656877956685901incr; $v114961656877956685901loop->revindex0 = $v114961656877956685901loop->length - ($v114961656877956685901incr + 1); $v114961656877956685901loop->last = ($v114961656877956685901incr == ($v114961656877956685901loop->length - 1)); ?>
    <a class="subtitle" href="<?php echo $itemchild['link']; ?>"
       title="<?php echo $itemchild['username']; ?>"><?php echo $itemchild['username']; ?></a><?php if (!$v114961656877956685901loop->last) { ?><span class="bull" style="font-size:12px;">Ft </span><?php } ?>
    <?php $v114961656877956685901incr++; } ?>
...
<footer>
    <div class="container">
        <div class="row">
            <?php $v114961656877956685901iterator = $listCategory_footer; $v114961656877956685901incr = 0; $v114961656877956685901loop = new stdClass(); $v114961656877956685901loop->length = count($v114961656877956685901iterator); $v114961656877956685901loop->index = 1; $v114961656877956685901loop->index0 = 1; $v114961656877956685901loop->revindex = $v114961656877956685901loop->length; $v114961656877956685901loop->revindex0 = $v114961656877956685901loop->length - 1; ?><?php foreach ($v114961656877956685901iterator as $index => $itemFooterMenu) { ?><?php $v114961656877956685901loop->first = ($v114961656877956685901incr == 0); $v114961656877956685901loop->index = $v114961656877956685901incr + 1; $v114961656877956685901loop->index0 = $v114961656877956685901incr; $v114961656877956685901loop->revindex = $v114961656877956685901loop->length - $v114961656877956685901incr; $v114961656877956685901loop->revindex0 = $v114961656877956685901loop->length - ($v114961656877956685901incr + 1); $v114961656877956685901loop->last = ($v114961656877956685901incr == ($v114961656877956685901loop->length - 1)); ?>
                <?php if ($index % 5 == 0) { ?>
                    <div class="col-md-2 col-sm-3 col-xs-6">
                    <ul class="list1">
                <?php } ?>
                <li><a href="<?php echo $itemFooterMenu['link']; ?>"><?php echo $itemFooterMenu['title']; ?></a></li>
                <?php if ($index % 5 == 4 || $v114961656877956685901loop->last) { ?>
                    </ul>
                    </div>
                <?php } ?>
            <?php $v114961656877956685901incr++; } ?>
