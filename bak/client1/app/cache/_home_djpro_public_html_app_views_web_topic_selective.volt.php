...
<div id="content">
        ...
        <div class="container">
            <div class="row">
                <div class="col-ldh-9 col-sm-8">
                    <div class="td_headingw"><h2><a href="/chu-de-chon-loc.html">CHỦ ĐỀ CHỌN LỌC</a><i
                                    class="fa fa-angle-right"></i></h2></div>
                    <div class="row">
                        <?php foreach ($listTopic_selective as $item) { ?>
    ...
    <?php $v125452155151336157071iterator = $item['listartist']; $v125452155151336157071incr = 0; $v125452155151336157071loop = new stdClass(); $v125452155151336157071loop->length = count($v125452155151336157071iterator); $v125452155151336157071loop->index = 1; $v125452155151336157071loop->index0 = 1; $v125452155151336157071loop->revindex = $v125452155151336157071loop->length; $v125452155151336157071loop->revindex0 = $v125452155151336157071loop->length - 1; ?><?php foreach ($v125452155151336157071iterator as $itemchild) { ?><?php $v125452155151336157071loop->first = ($v125452155151336157071incr == 0); $v125452155151336157071loop->index = $v125452155151336157071incr + 1; $v125452155151336157071loop->index0 = $v125452155151336157071incr; $v125452155151336157071loop->revindex = $v125452155151336157071loop->length - $v125452155151336157071incr; $v125452155151336157071loop->revindex0 = $v125452155151336157071loop->length - ($v125452155151336157071incr + 1); $v125452155151336157071loop->last = ($v125452155151336157071incr == ($v125452155151336157071loop->length - 1)); ?>
    <a class="subtitle" href="<?php echo $itemchild['link']; ?>"
       title="<?php echo $itemchild['username']; ?>"><?php echo $itemchild['username']; ?></a><?php if (!$v125452155151336157071loop->last) { ?><span class="bull" style="font-size:12px;">Ft </span><?php } ?>
    <?php $v125452155151336157071incr++; } ?>
...
<footer>
    <div class="container">
        <div class="row">
            <?php $v125452155151336157071iterator = $listCategory_footer; $v125452155151336157071incr = 0; $v125452155151336157071loop = new stdClass(); $v125452155151336157071loop->length = count($v125452155151336157071iterator); $v125452155151336157071loop->index = 1; $v125452155151336157071loop->index0 = 1; $v125452155151336157071loop->revindex = $v125452155151336157071loop->length; $v125452155151336157071loop->revindex0 = $v125452155151336157071loop->length - 1; ?><?php foreach ($v125452155151336157071iterator as $index => $itemFooterMenu) { ?><?php $v125452155151336157071loop->first = ($v125452155151336157071incr == 0); $v125452155151336157071loop->index = $v125452155151336157071incr + 1; $v125452155151336157071loop->index0 = $v125452155151336157071incr; $v125452155151336157071loop->revindex = $v125452155151336157071loop->length - $v125452155151336157071incr; $v125452155151336157071loop->revindex0 = $v125452155151336157071loop->length - ($v125452155151336157071incr + 1); $v125452155151336157071loop->last = ($v125452155151336157071incr == ($v125452155151336157071loop->length - 1)); ?>
                <?php if ($index % 5 == 0) { ?>
                    <div class="col-md-2 col-sm-3 col-xs-6">
                    <ul class="list1">
                <?php } ?>
                <li><a href="<?php echo $itemFooterMenu['link']; ?>"><?php echo $itemFooterMenu['title']; ?></a></li>
                <?php if ($index % 5 == 4 || $v125452155151336157071loop->last) { ?>
                    </ul>
                    </div>
                <?php } ?>
            <?php $v125452155151336157071incr++; } ?>
