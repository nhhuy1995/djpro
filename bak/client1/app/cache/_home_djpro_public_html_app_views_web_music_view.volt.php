        ...
        $("#jquery_jplayer").jPlayer({
            ready: function () {
                $(this).jPlayer("setMedia", {
                    ...
                    m4a: "<?php echo $object->media_url; ?>",

                }).jPlayer("play"); // Attempt to auto play the media
            },

            cssSelectorAncestor: "#jp_container",
            swfPath: "/web/playlist/jplayer",
                            ...
                            <div class="info-song-top">
                                ...
                                <div class="info-pd-top">
                                    ...
                                    <p class="boutdislike"><i class="fa fa-user"></i> Người gửi:
                                        <a href="<?php echo $object->usercreatelink; ?>" style="<?php if (isset($object->usercreate_namerole)) { ?> color: #c73030;<?php } else { ?> color: #176093;<?php } ?>" title="<?php echo $object->usercreate; ?>"><?php echo $object->usercreate; ?></a>
                        ...
                        <div class="wolf-jplayer-playlist">
                            ...
                            <div id="jplayer_container" class="jplayer_container">
                                ...
                                <div id="jp_container" class="jp-audio">
                                    ...
                                    <div class="gl"></div>-->
                                    <a href="<?php echo $object->link; ?>" class="wolf-jp-popup" title="Nghe cửa sổ mới"></a>
                                                        ...
                                                        <div class="dropOut">
                                                            ...
                                                            <ul>
                                                                <?php if ($object->media_link_320k) { ?>
                                                                    <li><a class="media_quality_select" href="javascript:;" data-media-src="<?php echo $object->media_link_320k; ?>">320 kb</a></li>
                                                                <?php } ?>
                                                                <?php if ($object->media_link_128k) { ?>
                                                                    <li><a class="media_quality_select" href="javascript:;" data-media-src="<?php echo $object->media_link_128k; ?>">128 kb</a></li>
                                                                <?php } ?>
                                                                <?php if ($object->media_link_64k) { ?>
                                                                    <li><a class="media_quality_select" href="javascript:;" data-media-src="<?php echo $object->media_link_64k; ?>">64 kb</a></li>
                                                                <?php } ?>
                                                            </ul>
                                                        </div>
                                                    </div>
                        ...
                        <?php if ($session['_id']) { ?>
                            <ul class="media-func">
                                <li><i class="fa fa-plus"></i> <a href="javascript:void(0)"
                                                                  onclick="showFormAddPlaylist();">Thêm vào playlist</a>
                                </li>
                                <li><i class="fa fa-download"></i> <a href="/download.html?id=<?php echo $object->_id; ?>">Tải
                                        về</a>
                                </li>
                                ...
                                <li><i class="fa fa-share-alt"></i> <a href="javascript:void(0)" onclick="share_facebook()">Chia sẻ</a></li>
                            </ul>
                        <?php } else { ?>
                            <ul class="media-func ">
            ...
            new CBPFWTabs(el);
                    ...
                    <div class="row slide-cmmusic">
                        <div class="featuredNavigation">
                            <a href="javascript:void(0)" class="prev left recommended-item-control" title="Prev" id="prev"><i
                                        class="fa fa-angle-left"></i></a>
                            <a href="javascript:void(0)" class="next right recommended-item-control" title="Next" id="next"><i
