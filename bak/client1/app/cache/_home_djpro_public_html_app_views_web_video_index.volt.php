...
<div id="content">
    ...
    <?php $v3971198976864099271iterator = $item['listartist']; $v3971198976864099271incr = 0; $v3971198976864099271loop = new stdClass(); $v3971198976864099271loop->length = count($v3971198976864099271iterator); $v3971198976864099271loop->index = 1; $v3971198976864099271loop->index0 = 1; $v3971198976864099271loop->revindex = $v3971198976864099271loop->length; $v3971198976864099271loop->revindex0 = $v3971198976864099271loop->length - 1; ?><?php foreach ($v3971198976864099271iterator as $itemchild) { ?><?php $v3971198976864099271loop->first = ($v3971198976864099271incr == 0); $v3971198976864099271loop->index = $v3971198976864099271incr + 1; $v3971198976864099271loop->index0 = $v3971198976864099271incr; $v3971198976864099271loop->revindex = $v3971198976864099271loop->length - $v3971198976864099271incr; $v3971198976864099271loop->revindex0 = $v3971198976864099271loop->length - ($v3971198976864099271incr + 1); $v3971198976864099271loop->last = ($v3971198976864099271incr == ($v3971198976864099271loop->length - 1)); ?>
    <a class="subtitle" href="<?php echo $itemchild['link']; ?>"
       title="<?php echo $itemchild['username']; ?>"><?php echo $itemchild['username']; ?></a><?php if (!$v3971198976864099271loop->last) { ?><span class="bull" style="font-size:12px;">Ft </span><?php } ?>
    <?php $v3971198976864099271incr++; } ?>
    ...
    <?php } ?>
                    ...
                    <div class="row">
                        <?php foreach ($listvideoselective as $item) { ?>
                            <div class="col-md-3 col-sm-3 col-xs-6">
                                <div class="block-music">
                                    <div class="cover-outer-align">
                                        <a href="<?php echo $item['link']; ?>" title="<?php echo $item['name']; ?>">
...
<footer>
    <div class="container">
        <div class="row">
            <?php $v3971198976864099271iterator = $listCategory_footer; $v3971198976864099271incr = 0; $v3971198976864099271loop = new stdClass(); $v3971198976864099271loop->length = count($v3971198976864099271iterator); $v3971198976864099271loop->index = 1; $v3971198976864099271loop->index0 = 1; $v3971198976864099271loop->revindex = $v3971198976864099271loop->length; $v3971198976864099271loop->revindex0 = $v3971198976864099271loop->length - 1; ?><?php foreach ($v3971198976864099271iterator as $index => $itemFooterMenu) { ?><?php $v3971198976864099271loop->first = ($v3971198976864099271incr == 0); $v3971198976864099271loop->index = $v3971198976864099271incr + 1; $v3971198976864099271loop->index0 = $v3971198976864099271incr; $v3971198976864099271loop->revindex = $v3971198976864099271loop->length - $v3971198976864099271incr; $v3971198976864099271loop->revindex0 = $v3971198976864099271loop->length - ($v3971198976864099271incr + 1); $v3971198976864099271loop->last = ($v3971198976864099271incr == ($v3971198976864099271loop->length - 1)); ?>
                <?php if ($index % 5 == 0) { ?>
                    <div class="col-md-2 col-sm-3 col-xs-6">
                    <ul class="list1">
                <?php } ?>
                <li><a href="<?php echo $itemFooterMenu['link']; ?>"><?php echo $itemFooterMenu['title']; ?></a></li>
                <?php if ($index % 5 == 4 || $v3971198976864099271loop->last) { ?>
                    </ul>
                    </div>
                <?php } ?>
            <?php $v3971198976864099271incr++; } ?>
