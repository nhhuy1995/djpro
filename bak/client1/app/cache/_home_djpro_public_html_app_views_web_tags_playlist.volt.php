...
<div id="content">
    ...
    <?php $v164499565490585995451iterator = $item['listartist']; $v164499565490585995451incr = 0; $v164499565490585995451loop = new stdClass(); $v164499565490585995451loop->length = count($v164499565490585995451iterator); $v164499565490585995451loop->index = 1; $v164499565490585995451loop->index0 = 1; $v164499565490585995451loop->revindex = $v164499565490585995451loop->length; $v164499565490585995451loop->revindex0 = $v164499565490585995451loop->length - 1; ?><?php foreach ($v164499565490585995451iterator as $itemchild) { ?><?php $v164499565490585995451loop->first = ($v164499565490585995451incr == 0); $v164499565490585995451loop->index = $v164499565490585995451incr + 1; $v164499565490585995451loop->index0 = $v164499565490585995451incr; $v164499565490585995451loop->revindex = $v164499565490585995451loop->length - $v164499565490585995451incr; $v164499565490585995451loop->revindex0 = $v164499565490585995451loop->length - ($v164499565490585995451incr + 1); $v164499565490585995451loop->last = ($v164499565490585995451incr == ($v164499565490585995451loop->length - 1)); ?>
    <a class="subtitle" href="<?php echo $itemchild['link']; ?>"
       title="<?php echo $itemchild['username']; ?>"><?php echo $itemchild['username']; ?></a><?php if (!$v164499565490585995451loop->last) { ?><span class="bull" style="font-size:12px;">Ft </span><?php } ?>
    <?php $v164499565490585995451incr++; } ?>
...
<footer>
    <div class="container">
        <div class="row">
            <?php $v164499565490585995451iterator = $listCategory_footer; $v164499565490585995451incr = 0; $v164499565490585995451loop = new stdClass(); $v164499565490585995451loop->length = count($v164499565490585995451iterator); $v164499565490585995451loop->index = 1; $v164499565490585995451loop->index0 = 1; $v164499565490585995451loop->revindex = $v164499565490585995451loop->length; $v164499565490585995451loop->revindex0 = $v164499565490585995451loop->length - 1; ?><?php foreach ($v164499565490585995451iterator as $index => $itemFooterMenu) { ?><?php $v164499565490585995451loop->first = ($v164499565490585995451incr == 0); $v164499565490585995451loop->index = $v164499565490585995451incr + 1; $v164499565490585995451loop->index0 = $v164499565490585995451incr; $v164499565490585995451loop->revindex = $v164499565490585995451loop->length - $v164499565490585995451incr; $v164499565490585995451loop->revindex0 = $v164499565490585995451loop->length - ($v164499565490585995451incr + 1); $v164499565490585995451loop->last = ($v164499565490585995451incr == ($v164499565490585995451loop->length - 1)); ?>
                <?php if ($index % 5 == 0) { ?>
                    <div class="col-md-2 col-sm-3 col-xs-6">
                    <ul class="list1">
                <?php } ?>
                <li><a href="<?php echo $itemFooterMenu['link']; ?>"><?php echo $itemFooterMenu['title']; ?></a></li>
                <?php if ($index % 5 == 4 || $v164499565490585995451loop->last) { ?>
                    </ul>
                    </div>
                <?php } ?>
            <?php $v164499565490585995451incr++; } ?>
