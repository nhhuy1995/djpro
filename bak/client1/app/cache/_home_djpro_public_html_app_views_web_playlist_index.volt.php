...
<div id="content">
    ...
    <?php $v117513606011419612501iterator = $item['listartist']; $v117513606011419612501incr = 0; $v117513606011419612501loop = new stdClass(); $v117513606011419612501loop->length = count($v117513606011419612501iterator); $v117513606011419612501loop->index = 1; $v117513606011419612501loop->index0 = 1; $v117513606011419612501loop->revindex = $v117513606011419612501loop->length; $v117513606011419612501loop->revindex0 = $v117513606011419612501loop->length - 1; ?><?php foreach ($v117513606011419612501iterator as $itemchild) { ?><?php $v117513606011419612501loop->first = ($v117513606011419612501incr == 0); $v117513606011419612501loop->index = $v117513606011419612501incr + 1; $v117513606011419612501loop->index0 = $v117513606011419612501incr; $v117513606011419612501loop->revindex = $v117513606011419612501loop->length - $v117513606011419612501incr; $v117513606011419612501loop->revindex0 = $v117513606011419612501loop->length - ($v117513606011419612501incr + 1); $v117513606011419612501loop->last = ($v117513606011419612501incr == ($v117513606011419612501loop->length - 1)); ?>
    <a class="subtitle" href="<?php echo $itemchild['link']; ?>"
       title="<?php echo $itemchild['username']; ?>"><?php echo $itemchild['username']; ?></a><?php if (!$v117513606011419612501loop->last) { ?><span class="bull" style="font-size:12px;">Ft </span><?php } ?>
    <?php $v117513606011419612501incr++; } ?>
    ...
    <?php } ?>
                    ...
                    <div class="td_headingw"><h2><a href="/playlist-chon-loc.html">Playlist chọn lọc</a><i
                                    class="fa fa-angle-right"></i></h2></div>
                    <div class="row">
                        <?php foreach ($listplselective as $item) { ?>
                            <div class="col-md-3 col-sm-4 col-xs-6">
                                <div class="block-music">
                                    <div class="cover-outer-align">
                                        <a href="<?php echo $item['link']; ?>" title="<?php echo $item['name']; ?>">
...
<footer>
    <div class="container">
        <div class="row">
            <?php $v117513606011419612501iterator = $listCategory_footer; $v117513606011419612501incr = 0; $v117513606011419612501loop = new stdClass(); $v117513606011419612501loop->length = count($v117513606011419612501iterator); $v117513606011419612501loop->index = 1; $v117513606011419612501loop->index0 = 1; $v117513606011419612501loop->revindex = $v117513606011419612501loop->length; $v117513606011419612501loop->revindex0 = $v117513606011419612501loop->length - 1; ?><?php foreach ($v117513606011419612501iterator as $index => $itemFooterMenu) { ?><?php $v117513606011419612501loop->first = ($v117513606011419612501incr == 0); $v117513606011419612501loop->index = $v117513606011419612501incr + 1; $v117513606011419612501loop->index0 = $v117513606011419612501incr; $v117513606011419612501loop->revindex = $v117513606011419612501loop->length - $v117513606011419612501incr; $v117513606011419612501loop->revindex0 = $v117513606011419612501loop->length - ($v117513606011419612501incr + 1); $v117513606011419612501loop->last = ($v117513606011419612501incr == ($v117513606011419612501loop->length - 1)); ?>
                <?php if ($index % 5 == 0) { ?>
                    <div class="col-md-2 col-sm-3 col-xs-6">
                    <ul class="list1">
                <?php } ?>
                <li><a href="<?php echo $itemFooterMenu['link']; ?>"><?php echo $itemFooterMenu['title']; ?></a></li>
                <?php if ($index % 5 == 4 || $v117513606011419612501loop->last) { ?>
                    </ul>
                    </div>
                <?php } ?>
            <?php $v117513606011419612501incr++; } ?>
