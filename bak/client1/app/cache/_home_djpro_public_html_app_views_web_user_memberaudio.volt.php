                    ...
                    <div class="tabs tabs-style-linemove">
                        <nav>
                            <ul>
                                ...
                                <li class="tab-current"><a href="<?php echo $uinfo->link; ?>?t=audio" class="icon icon-baihat"><span>Bài hát đã đăng</span></a>
                                </li>
                        ...
                        <div class="content-wrap">
                            <section id="section-linemove-2" class="" style="display: block">
...
<footer>
    <div class="container">
        <div class="row">
            <?php $v162550692215139252811iterator = $listCategory_footer; $v162550692215139252811incr = 0; $v162550692215139252811loop = new stdClass(); $v162550692215139252811loop->length = count($v162550692215139252811iterator); $v162550692215139252811loop->index = 1; $v162550692215139252811loop->index0 = 1; $v162550692215139252811loop->revindex = $v162550692215139252811loop->length; $v162550692215139252811loop->revindex0 = $v162550692215139252811loop->length - 1; ?><?php foreach ($v162550692215139252811iterator as $index => $itemFooterMenu) { ?><?php $v162550692215139252811loop->first = ($v162550692215139252811incr == 0); $v162550692215139252811loop->index = $v162550692215139252811incr + 1; $v162550692215139252811loop->index0 = $v162550692215139252811incr; $v162550692215139252811loop->revindex = $v162550692215139252811loop->length - $v162550692215139252811incr; $v162550692215139252811loop->revindex0 = $v162550692215139252811loop->length - ($v162550692215139252811incr + 1); $v162550692215139252811loop->last = ($v162550692215139252811incr == ($v162550692215139252811loop->length - 1)); ?>
                <?php if ($index % 5 == 0) { ?>
                    <div class="col-md-2 col-sm-3 col-xs-6">
                    <ul class="list1">
                <?php } ?>
                <li><a href="<?php echo $itemFooterMenu['link']; ?>"><?php echo $itemFooterMenu['title']; ?></a></li>
                <?php if ($index % 5 == 4 || $v162550692215139252811loop->last) { ?>
                    </ul>
                    </div>
                <?php } ?>
            <?php $v162550692215139252811incr++; } ?>
