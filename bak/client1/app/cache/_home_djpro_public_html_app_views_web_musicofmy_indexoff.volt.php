...
<div id="content">
            ...
            <div class="row">
                ...
                <div class="col-ldh-9 col-sm-8">
                    ...
                    <div class="tabs tabs-style-linemove">
                        <nav>
                            <ul>
                                <li class="tab-current"><a href="/nhac-cho-duyet.html"
                        ...
                        <div class="content-wrap">
                            <section id="section-linemove-1" class="content-current">
                                <div class="td_heading"><h2><span class="while"><a href="/nhac-cho-duyet.html?t=audio">Bài hát</a> (<span id="clkeyword"><?php echo $countaudio; ?></span>)<i class="fa fa-angle-right"></i></span>
                                    </h2></div>
                                <?php if ($listmedia) { ?>
                                ...
                                <?php } else { ?>
                                    <p>Chưa cập nhật!</p>
                                <?php } ?>
                                <div class="td_heading"><h2><span class="while"><a href="/nhac-cho-duyet.html?t=playlist">Playlist</a> (<span id="clkeyword"><?php echo $countplaylist; ?></span>)<i
    ...
    <?php $v91352995577263318791iterator = $item['listartist']; $v91352995577263318791incr = 0; $v91352995577263318791loop = new stdClass(); $v91352995577263318791loop->length = count($v91352995577263318791iterator); $v91352995577263318791loop->index = 1; $v91352995577263318791loop->index0 = 1; $v91352995577263318791loop->revindex = $v91352995577263318791loop->length; $v91352995577263318791loop->revindex0 = $v91352995577263318791loop->length - 1; ?><?php foreach ($v91352995577263318791iterator as $itemchild) { ?><?php $v91352995577263318791loop->first = ($v91352995577263318791incr == 0); $v91352995577263318791loop->index = $v91352995577263318791incr + 1; $v91352995577263318791loop->index0 = $v91352995577263318791incr; $v91352995577263318791loop->revindex = $v91352995577263318791loop->length - $v91352995577263318791incr; $v91352995577263318791loop->revindex0 = $v91352995577263318791loop->length - ($v91352995577263318791incr + 1); $v91352995577263318791loop->last = ($v91352995577263318791incr == ($v91352995577263318791loop->length - 1)); ?>
    <a class="subtitle" href="<?php echo $itemchild['link']; ?>"
       title="<?php echo $itemchild['username']; ?>"><?php echo $itemchild['username']; ?></a><?php if (!$v91352995577263318791loop->last) { ?><span class="bull" style="font-size:12px;">Ft </span><?php } ?>
    <?php $v91352995577263318791incr++; } ?>
    ...
    <?php } ?>
                                ...
                                <?php } else { ?>
                                    <p>Chưa cập nhật!</p>
                                <?php } ?>
                                <div class="td_heading"><h2><span class="while"><a href="/nhac-cho-duyet.html?t=video">Video</a> (<span id="clkeyword"><?php echo $countvideo; ?></span>)<i
                                                    class="fa fa-angle-right"></i></span></h2></div>
                                <?php if ($listvideo) { ?>
                                    <div class="row">
...
<footer>
    <div class="container">
        <div class="row">
            <?php $v91352995577263318791iterator = $listCategory_footer; $v91352995577263318791incr = 0; $v91352995577263318791loop = new stdClass(); $v91352995577263318791loop->length = count($v91352995577263318791iterator); $v91352995577263318791loop->index = 1; $v91352995577263318791loop->index0 = 1; $v91352995577263318791loop->revindex = $v91352995577263318791loop->length; $v91352995577263318791loop->revindex0 = $v91352995577263318791loop->length - 1; ?><?php foreach ($v91352995577263318791iterator as $index => $itemFooterMenu) { ?><?php $v91352995577263318791loop->first = ($v91352995577263318791incr == 0); $v91352995577263318791loop->index = $v91352995577263318791incr + 1; $v91352995577263318791loop->index0 = $v91352995577263318791incr; $v91352995577263318791loop->revindex = $v91352995577263318791loop->length - $v91352995577263318791incr; $v91352995577263318791loop->revindex0 = $v91352995577263318791loop->length - ($v91352995577263318791incr + 1); $v91352995577263318791loop->last = ($v91352995577263318791incr == ($v91352995577263318791loop->length - 1)); ?>
                <?php if ($index % 5 == 0) { ?>
                    <div class="col-md-2 col-sm-3 col-xs-6">
                    <ul class="list1">
                <?php } ?>
                <li><a href="<?php echo $itemFooterMenu['link']; ?>"><?php echo $itemFooterMenu['title']; ?></a></li>
                <?php if ($index % 5 == 4 || $v91352995577263318791loop->last) { ?>
                    </ul>
                    </div>
                <?php } ?>
            <?php $v91352995577263318791incr++; } ?>
