                                    ...
                                    <article class="chart-row <?php echo $cl; ?>">
                                        <div class="row-primary">
                                            ...
                                            <div class="row-image"><a href="<?php echo $item['link']; ?>"
                                                            ...
                                                            src="<?php echo $item['priavatar']; ?>" alt="<?php echo $item['name']; ?>"/></a></div>
                                            <div class="row-title">
                                                ...
                                                <h3>
                                                     <?php $v117113128937582782462iterator = $item['artist']; $v117113128937582782462incr = 0; $v117113128937582782462loop = new stdClass(); $v117113128937582782462loop->length = count($v117113128937582782462iterator); $v117113128937582782462loop->index = 1; $v117113128937582782462loop->index0 = 1; $v117113128937582782462loop->revindex = $v117113128937582782462loop->length; $v117113128937582782462loop->revindex0 = $v117113128937582782462loop->length - 1; ?><?php foreach ($v117113128937582782462iterator as $itemchild) { ?><?php $v117113128937582782462loop->first = ($v117113128937582782462incr == 0); $v117113128937582782462loop->index = $v117113128937582782462incr + 1; $v117113128937582782462loop->index0 = $v117113128937582782462incr; $v117113128937582782462loop->revindex = $v117113128937582782462loop->length - $v117113128937582782462incr; $v117113128937582782462loop->revindex0 = $v117113128937582782462loop->length - ($v117113128937582782462incr + 1); $v117113128937582782462loop->last = ($v117113128937582782462incr == ($v117113128937582782462loop->length - 1)); ?>
                                                        <a href="<?php echo $itemchild['link']; ?>" title="<?php echo $itemchild['username']; ?>"><?php echo $itemchild['username']; ?></a>
                                                    <?php if (!$v117113128937582782462loop->last) { ?><span style="font-weight: normal;">ft</span><?php } ?>
                                                    <?php $v117113128937582782462incr++; } ?>
                                                </h3>
...
<footer>
    <div class="container">
        <div class="row">
            <?php $v117113128937582782461iterator = $listCategory_footer; $v117113128937582782461incr = 0; $v117113128937582782461loop = new stdClass(); $v117113128937582782461loop->length = count($v117113128937582782461iterator); $v117113128937582782461loop->index = 1; $v117113128937582782461loop->index0 = 1; $v117113128937582782461loop->revindex = $v117113128937582782461loop->length; $v117113128937582782461loop->revindex0 = $v117113128937582782461loop->length - 1; ?><?php foreach ($v117113128937582782461iterator as $index => $itemFooterMenu) { ?><?php $v117113128937582782461loop->first = ($v117113128937582782461incr == 0); $v117113128937582782461loop->index = $v117113128937582782461incr + 1; $v117113128937582782461loop->index0 = $v117113128937582782461incr; $v117113128937582782461loop->revindex = $v117113128937582782461loop->length - $v117113128937582782461incr; $v117113128937582782461loop->revindex0 = $v117113128937582782461loop->length - ($v117113128937582782461incr + 1); $v117113128937582782461loop->last = ($v117113128937582782461incr == ($v117113128937582782461loop->length - 1)); ?>
                <?php if ($index % 5 == 0) { ?>
                    <div class="col-md-2 col-sm-3 col-xs-6">
                    <ul class="list1">
                <?php } ?>
                <li><a href="<?php echo $itemFooterMenu['link']; ?>"><?php echo $itemFooterMenu['title']; ?></a></li>
                <?php if ($index % 5 == 4 || $v117113128937582782461loop->last) { ?>
                    </ul>
                    </div>
                <?php } ?>
            <?php $v117113128937582782461incr++; } ?>
