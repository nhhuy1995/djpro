...
<div id="content">
    ...
    <div class="bg-cmmusic">
        <div class="container">
            <ul class="breadcrumbs">
                ...
                <li><a href="<?php echo $link; ?>"><?php echo $object->name; ?></a></li>
            </ul>
        </div>
        <div class="container">
            <div class="row">
                <div class="col-ldh-9 col-sm-8">
                    <div class="td_headingw"><h2><a href="<?php echo $link; ?>"><?php echo $object->name; ?></a><i
    ...
    <?php $v113360198899977786051iterator = $item['listartist']; $v113360198899977786051incr = 0; $v113360198899977786051loop = new stdClass(); $v113360198899977786051loop->length = count($v113360198899977786051iterator); $v113360198899977786051loop->index = 1; $v113360198899977786051loop->index0 = 1; $v113360198899977786051loop->revindex = $v113360198899977786051loop->length; $v113360198899977786051loop->revindex0 = $v113360198899977786051loop->length - 1; ?><?php foreach ($v113360198899977786051iterator as $itemchild) { ?><?php $v113360198899977786051loop->first = ($v113360198899977786051incr == 0); $v113360198899977786051loop->index = $v113360198899977786051incr + 1; $v113360198899977786051loop->index0 = $v113360198899977786051incr; $v113360198899977786051loop->revindex = $v113360198899977786051loop->length - $v113360198899977786051incr; $v113360198899977786051loop->revindex0 = $v113360198899977786051loop->length - ($v113360198899977786051incr + 1); $v113360198899977786051loop->last = ($v113360198899977786051incr == ($v113360198899977786051loop->length - 1)); ?>
    <a class="subtitle" href="<?php echo $itemchild['link']; ?>"
       title="<?php echo $itemchild['username']; ?>"><?php echo $itemchild['username']; ?></a><?php if (!$v113360198899977786051loop->last) { ?><span class="bull" style="font-size:12px;">Ft </span><?php } ?>
    <?php $v113360198899977786051incr++; } ?>
    ...
    <div class="container">
        <div class="row">
            <?php $v113360198899977786051iterator = $listCategory_footer; $v113360198899977786051incr = 0; $v113360198899977786051loop = new stdClass(); $v113360198899977786051loop->length = count($v113360198899977786051iterator); $v113360198899977786051loop->index = 1; $v113360198899977786051loop->index0 = 1; $v113360198899977786051loop->revindex = $v113360198899977786051loop->length; $v113360198899977786051loop->revindex0 = $v113360198899977786051loop->length - 1; ?><?php foreach ($v113360198899977786051iterator as $index => $itemFooterMenu) { ?><?php $v113360198899977786051loop->first = ($v113360198899977786051incr == 0); $v113360198899977786051loop->index = $v113360198899977786051incr + 1; $v113360198899977786051loop->index0 = $v113360198899977786051incr; $v113360198899977786051loop->revindex = $v113360198899977786051loop->length - $v113360198899977786051incr; $v113360198899977786051loop->revindex0 = $v113360198899977786051loop->length - ($v113360198899977786051incr + 1); $v113360198899977786051loop->last = ($v113360198899977786051incr == ($v113360198899977786051loop->length - 1)); ?>
                <?php if ($index % 5 == 0) { ?>
                    <div class="col-md-2 col-sm-3 col-xs-6">
                    <ul class="list1">
                <?php } ?>
                <li><a href="<?php echo $itemFooterMenu['link']; ?>"><?php echo $itemFooterMenu['title']; ?></a></li>
                <?php if ($index % 5 == 4 || $v113360198899977786051loop->last) { ?>
                    </ul>
                    </div>
                <?php } ?>
            <?php $v113360198899977786051incr++; } ?>
