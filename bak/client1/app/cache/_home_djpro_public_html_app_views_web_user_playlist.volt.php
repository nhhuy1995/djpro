    ...
    <div class="bg-cmmusic">
        <div class="container">
            <ul class="breadcrumbs">
                ...
                <li><a href="/playlist-cua-toi.html">Playlist của tôi</a></li>
            </ul>
        </div>
        <div class="container">
            <div class="row">
...
<footer>
    <div class="container">
        <div class="row">
            <?php $v646817635148424091iterator = $listCategory_footer; $v646817635148424091incr = 0; $v646817635148424091loop = new stdClass(); $v646817635148424091loop->length = count($v646817635148424091iterator); $v646817635148424091loop->index = 1; $v646817635148424091loop->index0 = 1; $v646817635148424091loop->revindex = $v646817635148424091loop->length; $v646817635148424091loop->revindex0 = $v646817635148424091loop->length - 1; ?><?php foreach ($v646817635148424091iterator as $index => $itemFooterMenu) { ?><?php $v646817635148424091loop->first = ($v646817635148424091incr == 0); $v646817635148424091loop->index = $v646817635148424091incr + 1; $v646817635148424091loop->index0 = $v646817635148424091incr; $v646817635148424091loop->revindex = $v646817635148424091loop->length - $v646817635148424091incr; $v646817635148424091loop->revindex0 = $v646817635148424091loop->length - ($v646817635148424091incr + 1); $v646817635148424091loop->last = ($v646817635148424091incr == ($v646817635148424091loop->length - 1)); ?>
                <?php if ($index % 5 == 0) { ?>
                    <div class="col-md-2 col-sm-3 col-xs-6">
                    <ul class="list1">
                <?php } ?>
                <li><a href="<?php echo $itemFooterMenu['link']; ?>"><?php echo $itemFooterMenu['title']; ?></a></li>
                <?php if ($index % 5 == 4 || $v646817635148424091loop->last) { ?>
                    </ul>
                    </div>
                <?php } ?>
            <?php $v646817635148424091incr++; } ?>
