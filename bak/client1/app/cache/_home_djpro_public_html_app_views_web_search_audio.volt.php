    ...
    <div class="artists">
        <div class="container">
            <ul class="breadcrumbs">
                ...
                <li><a href="/tim-kiem/nhac.html?q=<?php echo $keyword; ?>"><?php echo $_GET['q']; ?></a></li>
            </ul>
        </div>
        <div class="container">
            <div class="row">
...
<footer>
    <div class="container">
        <div class="row">
            <?php $v72736216166452476481iterator = $listCategory_footer; $v72736216166452476481incr = 0; $v72736216166452476481loop = new stdClass(); $v72736216166452476481loop->length = count($v72736216166452476481iterator); $v72736216166452476481loop->index = 1; $v72736216166452476481loop->index0 = 1; $v72736216166452476481loop->revindex = $v72736216166452476481loop->length; $v72736216166452476481loop->revindex0 = $v72736216166452476481loop->length - 1; ?><?php foreach ($v72736216166452476481iterator as $index => $itemFooterMenu) { ?><?php $v72736216166452476481loop->first = ($v72736216166452476481incr == 0); $v72736216166452476481loop->index = $v72736216166452476481incr + 1; $v72736216166452476481loop->index0 = $v72736216166452476481incr; $v72736216166452476481loop->revindex = $v72736216166452476481loop->length - $v72736216166452476481incr; $v72736216166452476481loop->revindex0 = $v72736216166452476481loop->length - ($v72736216166452476481incr + 1); $v72736216166452476481loop->last = ($v72736216166452476481incr == ($v72736216166452476481loop->length - 1)); ?>
                <?php if ($index % 5 == 0) { ?>
                    <div class="col-md-2 col-sm-3 col-xs-6">
                    <ul class="list1">
                <?php } ?>
                <li><a href="<?php echo $itemFooterMenu['link']; ?>"><?php echo $itemFooterMenu['title']; ?></a></li>
                <?php if ($index % 5 == 4 || $v72736216166452476481loop->last) { ?>
                    </ul>
                    </div>
                <?php } ?>
            <?php $v72736216166452476481incr++; } ?>
