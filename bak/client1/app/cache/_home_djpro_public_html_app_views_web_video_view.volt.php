                                         ...
                                         <span class="boutdislike" style="color: white;">
                                            <i class="fa fa-user"></i> Người gửi:
                                             <a href="<?php echo $object->usercreatelink; ?>" style="color: #c73030;"
                                                title="<?php echo $object->usercreate; ?>">
                                                 <?php echo $object->usercreate; ?></a> (<?php echo $object->usercreate_namerole; ?>)
                                        </span>
                                    </p>
                                </div>
                            </div>
                    ...
                    <?php } else { ?>
                        ...
                        >
                            ...
                            <?php if ($object->link_video_1080) { ?>
                                <source src="<?php echo $object->link_video_1080; ?>" type='video/mp4' label='1080p HD'/>
                            <?php } ?>
                            <?php if ($object->link_video_720) { ?>
                                <source src="<?php echo $object->link_video_720; ?>" type='video/mp4' label='720p HD'/>
                            <?php } ?>
        ...
        $.get("/incoming/addplaylist", {name: name, type: "video"}, function (re) {
            ...
            if (re.status == 200) {
                html +=
                        ...
                        '<div class="playlist-list-item">' +
                        '<div class="playlist-list-name">' +
                        '<a title="Thêm vào playlist" onclick="addSoongToPlaylist(+results._id+)" href="javascript:void(0);">' +
