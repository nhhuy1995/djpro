                    ...
                    <div class="tabs tabs-style-iconbox">
                        <nav>
                            <ul>
                                ...
                                <li class="<?php if ($_GET['t'] == 'topic') { ?> tab-current <?php } ?>"><a href="/top100.html?t=topic" class="icon icon-chude"><span>Chủ đề</span></a>
                                </li>
                                <li class="<?php if ($_GET['t'] == 'album') { ?> tab-current <?php } ?>"><a href="/top100.html?t=album" class="icon icon-album"><span>Album</span></a>
                                </li>
                                <li class="<?php if ($_GET['t'] == 'playlist') { ?> tab-current <?php } ?>"><a href="/top100.html?t=playlist" class="icon icon-playlist"><span>Playlist</span></a>
                            </ul>
                        </nav>
                                ...
                                <article class="chart-row <?php echo $cl; ?>">
                                    <div class="row-primary">
                                        ...
                                        <div class="row-title">
                                            ...
                                            <h3>
                                                <?php if ($item['artist']) { ?>
                                                <?php $v71428743598780787752iterator = $item['artist']; $v71428743598780787752incr = 0; $v71428743598780787752loop = new stdClass(); $v71428743598780787752loop->length = count($v71428743598780787752iterator); $v71428743598780787752loop->index = 1; $v71428743598780787752loop->index0 = 1; $v71428743598780787752loop->revindex = $v71428743598780787752loop->length; $v71428743598780787752loop->revindex0 = $v71428743598780787752loop->length - 1; ?><?php foreach ($v71428743598780787752iterator as $itemchild) { ?><?php $v71428743598780787752loop->first = ($v71428743598780787752incr == 0); $v71428743598780787752loop->index = $v71428743598780787752incr + 1; $v71428743598780787752loop->index0 = $v71428743598780787752incr; $v71428743598780787752loop->revindex = $v71428743598780787752loop->length - $v71428743598780787752incr; $v71428743598780787752loop->revindex0 = $v71428743598780787752loop->length - ($v71428743598780787752incr + 1); $v71428743598780787752loop->last = ($v71428743598780787752incr == ($v71428743598780787752loop->length - 1)); ?>
                                                <a href="<?php echo $itemchild['link']; ?>"
                                                   title="<?php echo $itemchild['username']; ?>"><?php echo $itemchild['username']; ?></a>
                                                <?php if (!$v71428743598780787752loop->last) { ?><span
                                                        style="font-weight: normal;">ft</span><?php } ?>
                                                    <?php $v71428743598780787752incr++; } ?>
                                                <?php } ?>
                                            </h3>
...
<footer>
    <div class="container">
        <div class="row">
            <?php $v71428743598780787751iterator = $listCategory_footer; $v71428743598780787751incr = 0; $v71428743598780787751loop = new stdClass(); $v71428743598780787751loop->length = count($v71428743598780787751iterator); $v71428743598780787751loop->index = 1; $v71428743598780787751loop->index0 = 1; $v71428743598780787751loop->revindex = $v71428743598780787751loop->length; $v71428743598780787751loop->revindex0 = $v71428743598780787751loop->length - 1; ?><?php foreach ($v71428743598780787751iterator as $index => $itemFooterMenu) { ?><?php $v71428743598780787751loop->first = ($v71428743598780787751incr == 0); $v71428743598780787751loop->index = $v71428743598780787751incr + 1; $v71428743598780787751loop->index0 = $v71428743598780787751incr; $v71428743598780787751loop->revindex = $v71428743598780787751loop->length - $v71428743598780787751incr; $v71428743598780787751loop->revindex0 = $v71428743598780787751loop->length - ($v71428743598780787751incr + 1); $v71428743598780787751loop->last = ($v71428743598780787751incr == ($v71428743598780787751loop->length - 1)); ?>
                <?php if ($index % 5 == 0) { ?>
                    <div class="col-md-2 col-sm-3 col-xs-6">
                    <ul class="list1">
                <?php } ?>
                <li><a href="<?php echo $itemFooterMenu['link']; ?>"><?php echo $itemFooterMenu['title']; ?></a></li>
                <?php if ($index % 5 == 4 || $v71428743598780787751loop->last) { ?>
                    </ul>
                    </div>
                <?php } ?>
            <?php $v71428743598780787751incr++; } ?>
