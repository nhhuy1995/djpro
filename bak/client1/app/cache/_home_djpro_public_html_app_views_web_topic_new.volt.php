...
<div id="content">
    ...
    <?php $v125287028766005708811iterator = $item['listartist']; $v125287028766005708811incr = 0; $v125287028766005708811loop = new stdClass(); $v125287028766005708811loop->length = count($v125287028766005708811iterator); $v125287028766005708811loop->index = 1; $v125287028766005708811loop->index0 = 1; $v125287028766005708811loop->revindex = $v125287028766005708811loop->length; $v125287028766005708811loop->revindex0 = $v125287028766005708811loop->length - 1; ?><?php foreach ($v125287028766005708811iterator as $itemchild) { ?><?php $v125287028766005708811loop->first = ($v125287028766005708811incr == 0); $v125287028766005708811loop->index = $v125287028766005708811incr + 1; $v125287028766005708811loop->index0 = $v125287028766005708811incr; $v125287028766005708811loop->revindex = $v125287028766005708811loop->length - $v125287028766005708811incr; $v125287028766005708811loop->revindex0 = $v125287028766005708811loop->length - ($v125287028766005708811incr + 1); $v125287028766005708811loop->last = ($v125287028766005708811incr == ($v125287028766005708811loop->length - 1)); ?>
    <a class="subtitle" href="<?php echo $itemchild['link']; ?>"
       title="<?php echo $itemchild['username']; ?>"><?php echo $itemchild['username']; ?></a><?php if (!$v125287028766005708811loop->last) { ?><span class="bull" style="font-size:12px;">Ft </span><?php } ?>
    <?php $v125287028766005708811incr++; } ?>
...
<footer>
    <div class="container">
        <div class="row">
            <?php $v125287028766005708811iterator = $listCategory_footer; $v125287028766005708811incr = 0; $v125287028766005708811loop = new stdClass(); $v125287028766005708811loop->length = count($v125287028766005708811iterator); $v125287028766005708811loop->index = 1; $v125287028766005708811loop->index0 = 1; $v125287028766005708811loop->revindex = $v125287028766005708811loop->length; $v125287028766005708811loop->revindex0 = $v125287028766005708811loop->length - 1; ?><?php foreach ($v125287028766005708811iterator as $index => $itemFooterMenu) { ?><?php $v125287028766005708811loop->first = ($v125287028766005708811incr == 0); $v125287028766005708811loop->index = $v125287028766005708811incr + 1; $v125287028766005708811loop->index0 = $v125287028766005708811incr; $v125287028766005708811loop->revindex = $v125287028766005708811loop->length - $v125287028766005708811incr; $v125287028766005708811loop->revindex0 = $v125287028766005708811loop->length - ($v125287028766005708811incr + 1); $v125287028766005708811loop->last = ($v125287028766005708811incr == ($v125287028766005708811loop->length - 1)); ?>
                <?php if ($index % 5 == 0) { ?>
                    <div class="col-md-2 col-sm-3 col-xs-6">
                    <ul class="list1">
                <?php } ?>
                <li><a href="<?php echo $itemFooterMenu['link']; ?>"><?php echo $itemFooterMenu['title']; ?></a></li>
                <?php if ($index % 5 == 4 || $v125287028766005708811loop->last) { ?>
                    </ul>
                    </div>
                <?php } ?>
            <?php $v125287028766005708811incr++; } ?>
