...
<footer>
    <div class="container">
        <div class="row">
            <?php $v33361976738878675961iterator = $listCategory_footer; $v33361976738878675961incr = 0; $v33361976738878675961loop = new stdClass(); $v33361976738878675961loop->length = count($v33361976738878675961iterator); $v33361976738878675961loop->index = 1; $v33361976738878675961loop->index0 = 1; $v33361976738878675961loop->revindex = $v33361976738878675961loop->length; $v33361976738878675961loop->revindex0 = $v33361976738878675961loop->length - 1; ?><?php foreach ($v33361976738878675961iterator as $index => $itemFooterMenu) { ?><?php $v33361976738878675961loop->first = ($v33361976738878675961incr == 0); $v33361976738878675961loop->index = $v33361976738878675961incr + 1; $v33361976738878675961loop->index0 = $v33361976738878675961incr; $v33361976738878675961loop->revindex = $v33361976738878675961loop->length - $v33361976738878675961incr; $v33361976738878675961loop->revindex0 = $v33361976738878675961loop->length - ($v33361976738878675961incr + 1); $v33361976738878675961loop->last = ($v33361976738878675961incr == ($v33361976738878675961loop->length - 1)); ?>
                <?php if ($index % 5 == 0) { ?>
                    <div class="col-md-2 col-sm-3 col-xs-6">
                    <ul class="list1">
                <?php } ?>
                <li><a href="<?php echo $itemFooterMenu['link']; ?>"><?php echo $itemFooterMenu['title']; ?></a></li>
                <?php if ($index % 5 == 4 || $v33361976738878675961loop->last) { ?>
                    </ul>
                    </div>
                <?php } ?>
            <?php $v33361976738878675961incr++; } ?>
