...
<div id="content">
    <div class="bg-cmmusic">
        <div class="container">
            <ul class="breadcrumbs">
                ...
                <li><a href="/album-moi.html">Album mới nhất</a></li>
            </ul>
        </div>
        <div class="container">
            <div class="row">
                <div class="col-ldh-9 col-sm-8">
                    <div class="td_headingw"><h2><a href="/album.html">Album mới nhất</a><i class="fa fa-angle-right"></i></h2>
                    </div>
                    <div class="row">
    ...
    <?php $v127026575103853982271iterator = $item['listartist']; $v127026575103853982271incr = 0; $v127026575103853982271loop = new stdClass(); $v127026575103853982271loop->length = count($v127026575103853982271iterator); $v127026575103853982271loop->index = 1; $v127026575103853982271loop->index0 = 1; $v127026575103853982271loop->revindex = $v127026575103853982271loop->length; $v127026575103853982271loop->revindex0 = $v127026575103853982271loop->length - 1; ?><?php foreach ($v127026575103853982271iterator as $itemchild) { ?><?php $v127026575103853982271loop->first = ($v127026575103853982271incr == 0); $v127026575103853982271loop->index = $v127026575103853982271incr + 1; $v127026575103853982271loop->index0 = $v127026575103853982271incr; $v127026575103853982271loop->revindex = $v127026575103853982271loop->length - $v127026575103853982271incr; $v127026575103853982271loop->revindex0 = $v127026575103853982271loop->length - ($v127026575103853982271incr + 1); $v127026575103853982271loop->last = ($v127026575103853982271incr == ($v127026575103853982271loop->length - 1)); ?>
    <a class="subtitle" href="<?php echo $itemchild['link']; ?>"
       title="<?php echo $itemchild['username']; ?>"><?php echo $itemchild['username']; ?></a><?php if (!$v127026575103853982271loop->last) { ?><span class="bull" style="font-size:12px;">Ft </span><?php } ?>
    <?php $v127026575103853982271incr++; } ?>
...
<footer>
    <div class="container">
        <div class="row">
            <?php $v127026575103853982271iterator = $listCategory_footer; $v127026575103853982271incr = 0; $v127026575103853982271loop = new stdClass(); $v127026575103853982271loop->length = count($v127026575103853982271iterator); $v127026575103853982271loop->index = 1; $v127026575103853982271loop->index0 = 1; $v127026575103853982271loop->revindex = $v127026575103853982271loop->length; $v127026575103853982271loop->revindex0 = $v127026575103853982271loop->length - 1; ?><?php foreach ($v127026575103853982271iterator as $index => $itemFooterMenu) { ?><?php $v127026575103853982271loop->first = ($v127026575103853982271incr == 0); $v127026575103853982271loop->index = $v127026575103853982271incr + 1; $v127026575103853982271loop->index0 = $v127026575103853982271incr; $v127026575103853982271loop->revindex = $v127026575103853982271loop->length - $v127026575103853982271incr; $v127026575103853982271loop->revindex0 = $v127026575103853982271loop->length - ($v127026575103853982271incr + 1); $v127026575103853982271loop->last = ($v127026575103853982271incr == ($v127026575103853982271loop->length - 1)); ?>
                <?php if ($index % 5 == 0) { ?>
                    <div class="col-md-2 col-sm-3 col-xs-6">
                    <ul class="list1">
                <?php } ?>
                <li><a href="<?php echo $itemFooterMenu['link']; ?>"><?php echo $itemFooterMenu['title']; ?></a></li>
                <?php if ($index % 5 == 4 || $v127026575103853982271loop->last) { ?>
                    </ul>
                    </div>
                <?php } ?>
            <?php $v127026575103853982271incr++; } ?>
