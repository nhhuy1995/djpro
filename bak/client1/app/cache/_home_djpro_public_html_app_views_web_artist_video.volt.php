...
<div id="content">
                    ...
                    <div class="tabs tabs-style-iconbox">
                        <nav>
                            <ul>
                                ...
                                <li class="tabs_artist tab-current"><a href="<?php echo $object->link; ?>?t=video"
    ...
    <?php $v31377346924723496061iterator = $item['listartist']; $v31377346924723496061incr = 0; $v31377346924723496061loop = new stdClass(); $v31377346924723496061loop->length = count($v31377346924723496061iterator); $v31377346924723496061loop->index = 1; $v31377346924723496061loop->index0 = 1; $v31377346924723496061loop->revindex = $v31377346924723496061loop->length; $v31377346924723496061loop->revindex0 = $v31377346924723496061loop->length - 1; ?><?php foreach ($v31377346924723496061iterator as $itemchild) { ?><?php $v31377346924723496061loop->first = ($v31377346924723496061incr == 0); $v31377346924723496061loop->index = $v31377346924723496061incr + 1; $v31377346924723496061loop->index0 = $v31377346924723496061incr; $v31377346924723496061loop->revindex = $v31377346924723496061loop->length - $v31377346924723496061incr; $v31377346924723496061loop->revindex0 = $v31377346924723496061loop->length - ($v31377346924723496061incr + 1); $v31377346924723496061loop->last = ($v31377346924723496061incr == ($v31377346924723496061loop->length - 1)); ?>
    <a class="subtitle" href="<?php echo $itemchild['link']; ?>"
       title="<?php echo $itemchild['username']; ?>"><?php echo $itemchild['username']; ?></a><?php if (!$v31377346924723496061loop->last) { ?><span class="bull" style="font-size:12px;">Ft </span><?php } ?>
    <?php $v31377346924723496061incr++; } ?>
...
<footer>
    <div class="container">
        <div class="row">
            <?php $v31377346924723496061iterator = $listCategory_footer; $v31377346924723496061incr = 0; $v31377346924723496061loop = new stdClass(); $v31377346924723496061loop->length = count($v31377346924723496061iterator); $v31377346924723496061loop->index = 1; $v31377346924723496061loop->index0 = 1; $v31377346924723496061loop->revindex = $v31377346924723496061loop->length; $v31377346924723496061loop->revindex0 = $v31377346924723496061loop->length - 1; ?><?php foreach ($v31377346924723496061iterator as $index => $itemFooterMenu) { ?><?php $v31377346924723496061loop->first = ($v31377346924723496061incr == 0); $v31377346924723496061loop->index = $v31377346924723496061incr + 1; $v31377346924723496061loop->index0 = $v31377346924723496061incr; $v31377346924723496061loop->revindex = $v31377346924723496061loop->length - $v31377346924723496061incr; $v31377346924723496061loop->revindex0 = $v31377346924723496061loop->length - ($v31377346924723496061incr + 1); $v31377346924723496061loop->last = ($v31377346924723496061incr == ($v31377346924723496061loop->length - 1)); ?>
                <?php if ($index % 5 == 0) { ?>
                    <div class="col-md-2 col-sm-3 col-xs-6">
                    <ul class="list1">
                <?php } ?>
                <li><a href="<?php echo $itemFooterMenu['link']; ?>"><?php echo $itemFooterMenu['title']; ?></a></li>
                <?php if ($index % 5 == 4 || $v31377346924723496061loop->last) { ?>
                    </ul>
                    </div>
                <?php } ?>
            <?php $v31377346924723496061incr++; } ?>
