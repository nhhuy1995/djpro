...
<div id="content">
                    ...
                    <div class="tabs tabs-style-linemove">
                        <nav>
                            <ul>
                                ...
                                <li class="tab-current"><a href="<?php echo $uinfo->link; ?>?t=video"
                                                class="icon icon-video"><span>Video đã đăng</span></a></li>
                            </ul>
                        </nav>
                        <div class="content-wrap">
                            <section id="section-linemove-4" class="" style="display: block">
    ...
    <?php $v162866752719178833661iterator = $item['listartist']; $v162866752719178833661incr = 0; $v162866752719178833661loop = new stdClass(); $v162866752719178833661loop->length = count($v162866752719178833661iterator); $v162866752719178833661loop->index = 1; $v162866752719178833661loop->index0 = 1; $v162866752719178833661loop->revindex = $v162866752719178833661loop->length; $v162866752719178833661loop->revindex0 = $v162866752719178833661loop->length - 1; ?><?php foreach ($v162866752719178833661iterator as $itemchild) { ?><?php $v162866752719178833661loop->first = ($v162866752719178833661incr == 0); $v162866752719178833661loop->index = $v162866752719178833661incr + 1; $v162866752719178833661loop->index0 = $v162866752719178833661incr; $v162866752719178833661loop->revindex = $v162866752719178833661loop->length - $v162866752719178833661incr; $v162866752719178833661loop->revindex0 = $v162866752719178833661loop->length - ($v162866752719178833661incr + 1); $v162866752719178833661loop->last = ($v162866752719178833661incr == ($v162866752719178833661loop->length - 1)); ?>
    <a class="subtitle" href="<?php echo $itemchild['link']; ?>"
       title="<?php echo $itemchild['username']; ?>"><?php echo $itemchild['username']; ?></a><?php if (!$v162866752719178833661loop->last) { ?><span class="bull" style="font-size:12px;">Ft </span><?php } ?>
    <?php $v162866752719178833661incr++; } ?>
...
<footer>
    <div class="container">
        <div class="row">
            <?php $v162866752719178833661iterator = $listCategory_footer; $v162866752719178833661incr = 0; $v162866752719178833661loop = new stdClass(); $v162866752719178833661loop->length = count($v162866752719178833661iterator); $v162866752719178833661loop->index = 1; $v162866752719178833661loop->index0 = 1; $v162866752719178833661loop->revindex = $v162866752719178833661loop->length; $v162866752719178833661loop->revindex0 = $v162866752719178833661loop->length - 1; ?><?php foreach ($v162866752719178833661iterator as $index => $itemFooterMenu) { ?><?php $v162866752719178833661loop->first = ($v162866752719178833661incr == 0); $v162866752719178833661loop->index = $v162866752719178833661incr + 1; $v162866752719178833661loop->index0 = $v162866752719178833661incr; $v162866752719178833661loop->revindex = $v162866752719178833661loop->length - $v162866752719178833661incr; $v162866752719178833661loop->revindex0 = $v162866752719178833661loop->length - ($v162866752719178833661incr + 1); $v162866752719178833661loop->last = ($v162866752719178833661incr == ($v162866752719178833661loop->length - 1)); ?>
                <?php if ($index % 5 == 0) { ?>
                    <div class="col-md-2 col-sm-3 col-xs-6">
                    <ul class="list1">
                <?php } ?>
                <li><a href="<?php echo $itemFooterMenu['link']; ?>"><?php echo $itemFooterMenu['title']; ?></a></li>
                <?php if ($index % 5 == 4 || $v162866752719178833661loop->last) { ?>
                    </ul>
                    </div>
                <?php } ?>
            <?php $v162866752719178833661incr++; } ?>
