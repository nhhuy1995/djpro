...
<div id="content">
    ...
    <?php $v165754530319793576651iterator = $item['listartist']; $v165754530319793576651incr = 0; $v165754530319793576651loop = new stdClass(); $v165754530319793576651loop->length = count($v165754530319793576651iterator); $v165754530319793576651loop->index = 1; $v165754530319793576651loop->index0 = 1; $v165754530319793576651loop->revindex = $v165754530319793576651loop->length; $v165754530319793576651loop->revindex0 = $v165754530319793576651loop->length - 1; ?><?php foreach ($v165754530319793576651iterator as $itemchild) { ?><?php $v165754530319793576651loop->first = ($v165754530319793576651incr == 0); $v165754530319793576651loop->index = $v165754530319793576651incr + 1; $v165754530319793576651loop->index0 = $v165754530319793576651incr; $v165754530319793576651loop->revindex = $v165754530319793576651loop->length - $v165754530319793576651incr; $v165754530319793576651loop->revindex0 = $v165754530319793576651loop->length - ($v165754530319793576651incr + 1); $v165754530319793576651loop->last = ($v165754530319793576651incr == ($v165754530319793576651loop->length - 1)); ?>
    <a class="subtitle" href="<?php echo $itemchild['link']; ?>"
       title="<?php echo $itemchild['username']; ?>"><?php echo $itemchild['username']; ?></a><?php if (!$v165754530319793576651loop->last) { ?><span class="bull" style="font-size:12px;">Ft </span><?php } ?>
    <?php $v165754530319793576651incr++; } ?>
    ...
    <?php } ?>
                    ...
                    <div class="row">
                        <?php foreach ($listalbumselective as $item) { ?>
                            <div class="col-md-3 col-sm-4 col-xs-6">
                                <div class="block-music">
                                    <div class="cover-outer-align">
                                        <a href="<?php echo $item['link']; ?>">
...
<footer>
    <div class="container">
        <div class="row">
            <?php $v165754530319793576651iterator = $listCategory_footer; $v165754530319793576651incr = 0; $v165754530319793576651loop = new stdClass(); $v165754530319793576651loop->length = count($v165754530319793576651iterator); $v165754530319793576651loop->index = 1; $v165754530319793576651loop->index0 = 1; $v165754530319793576651loop->revindex = $v165754530319793576651loop->length; $v165754530319793576651loop->revindex0 = $v165754530319793576651loop->length - 1; ?><?php foreach ($v165754530319793576651iterator as $index => $itemFooterMenu) { ?><?php $v165754530319793576651loop->first = ($v165754530319793576651incr == 0); $v165754530319793576651loop->index = $v165754530319793576651incr + 1; $v165754530319793576651loop->index0 = $v165754530319793576651incr; $v165754530319793576651loop->revindex = $v165754530319793576651loop->length - $v165754530319793576651incr; $v165754530319793576651loop->revindex0 = $v165754530319793576651loop->length - ($v165754530319793576651incr + 1); $v165754530319793576651loop->last = ($v165754530319793576651incr == ($v165754530319793576651loop->length - 1)); ?>
                <?php if ($index % 5 == 0) { ?>
                    <div class="col-md-2 col-sm-3 col-xs-6">
                    <ul class="list1">
                <?php } ?>
                <li><a href="<?php echo $itemFooterMenu['link']; ?>"><?php echo $itemFooterMenu['title']; ?></a></li>
                <?php if ($index % 5 == 4 || $v165754530319793576651loop->last) { ?>
                    </ul>
                    </div>
                <?php } ?>
            <?php $v165754530319793576651incr++; } ?>
