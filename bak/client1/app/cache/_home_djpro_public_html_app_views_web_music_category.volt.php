...
<footer>
    <div class="container">
        <div class="row">
            <?php $v79796844912248406311iterator = $listCategory_footer; $v79796844912248406311incr = 0; $v79796844912248406311loop = new stdClass(); $v79796844912248406311loop->length = count($v79796844912248406311iterator); $v79796844912248406311loop->index = 1; $v79796844912248406311loop->index0 = 1; $v79796844912248406311loop->revindex = $v79796844912248406311loop->length; $v79796844912248406311loop->revindex0 = $v79796844912248406311loop->length - 1; ?><?php foreach ($v79796844912248406311iterator as $index => $itemFooterMenu) { ?><?php $v79796844912248406311loop->first = ($v79796844912248406311incr == 0); $v79796844912248406311loop->index = $v79796844912248406311incr + 1; $v79796844912248406311loop->index0 = $v79796844912248406311incr; $v79796844912248406311loop->revindex = $v79796844912248406311loop->length - $v79796844912248406311incr; $v79796844912248406311loop->revindex0 = $v79796844912248406311loop->length - ($v79796844912248406311incr + 1); $v79796844912248406311loop->last = ($v79796844912248406311incr == ($v79796844912248406311loop->length - 1)); ?>
                <?php if ($index % 5 == 0) { ?>
                    <div class="col-md-2 col-sm-3 col-xs-6">
                    <ul class="list1">
                <?php } ?>
                <li><a href="<?php echo $itemFooterMenu['link']; ?>"><?php echo $itemFooterMenu['title']; ?></a></li>
                <?php if ($index % 5 == 4 || $v79796844912248406311loop->last) { ?>
                    </ul>
                    </div>
                <?php } ?>
            <?php $v79796844912248406311incr++; } ?>
