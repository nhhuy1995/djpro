...
<div id="content">
            ...
            <div class="row">
                ...
                <div class="col-ldh-9 col-sm-8">
                    ...
                    <div class="td_heading"><h2><span class="while">Danh sách nhạc theo tags
                                “<a href="<?php echo $link_view_tags_audio; ?>"><span id="clkeyword"><?php echo $object->name; ?></span></a>”
                                (<?php echo $countaudio; ?>)
                    ...
                    <div class="td_heading"><h2><span class="while">Danh sách album theo tags
                                “<a href="<?php echo $link_view_tags_album; ?>"><span id="clkeyword"><?php echo $object->name; ?></span></a>”
                                (<?php echo $countalbum; ?>)
                                <i class="fa fa-angle-right"></i></span>
                        </h2>
                    </div>
    ...
    <?php $v154270530650635623031iterator = $item['listartist']; $v154270530650635623031incr = 0; $v154270530650635623031loop = new stdClass(); $v154270530650635623031loop->length = count($v154270530650635623031iterator); $v154270530650635623031loop->index = 1; $v154270530650635623031loop->index0 = 1; $v154270530650635623031loop->revindex = $v154270530650635623031loop->length; $v154270530650635623031loop->revindex0 = $v154270530650635623031loop->length - 1; ?><?php foreach ($v154270530650635623031iterator as $itemchild) { ?><?php $v154270530650635623031loop->first = ($v154270530650635623031incr == 0); $v154270530650635623031loop->index = $v154270530650635623031incr + 1; $v154270530650635623031loop->index0 = $v154270530650635623031incr; $v154270530650635623031loop->revindex = $v154270530650635623031loop->length - $v154270530650635623031incr; $v154270530650635623031loop->revindex0 = $v154270530650635623031loop->length - ($v154270530650635623031incr + 1); $v154270530650635623031loop->last = ($v154270530650635623031incr == ($v154270530650635623031loop->length - 1)); ?>
    <a class="subtitle" href="<?php echo $itemchild['link']; ?>"
       title="<?php echo $itemchild['username']; ?>"><?php echo $itemchild['username']; ?></a><?php if (!$v154270530650635623031loop->last) { ?><span class="bull" style="font-size:12px;">Ft </span><?php } ?>
    <?php $v154270530650635623031incr++; } ?>
    ...
    <?php } ?>
                    ...
                    <div class="td_heading">
                        <h2><span class="while">Danh sách playlist theo tags
                                “<a href="<?php echo $link_view_tags_playlist; ?>"><span id="clkeyword"><?php echo $object->name; ?></span></a>”
    ...
    <?php } ?>
                    ...
                    <div class="td_heading"><h2><span class="while">Danh sách chủ đề tags
                                “<a href="<?php echo $link_view_tags_topic; ?>"><span id="clkeyword"><?php echo $object->name; ?></span></a>”
                                (<?php echo $counttopic; ?>)
                                <i class="fa fa-angle-right"></i></span>
                        </h2>
                    </div>
    ...
    <?php } ?>
                    ...
                    <div class="td_heading"><h2>
                            <span class="while">Danh sách video theo tags
                                “<a href="<?php echo $link_view_tags_video; ?>"><span id="clkeyword"><?php echo $object->name; ?></span></a>”
                                (<?php echo $countvideo; ?>)
                                <i class="fa fa-angle-right"></i></span>
                        </h2>
                    </div>
    ...
    <?php } ?>
                    ...
                    <div class="td_heading"><h2>
                            <span class="while">Danh sách tin tức theo tags
                                “<a href="<?php echo $link_view_tags_news; ?>"><span id="clkeyword"><?php echo $object->name; ?></span></a>”
                                (<?php echo $countnews; ?>)
                                <i class="fa fa-angle-right"></i></span>
                        </h2>
                    </div>
                    ...
                    <?php if ($listimages) { ?>
                        <div class="td_heading"><h2>
                            <span class="while">Danh sách ảnh theo tags
                                “<a href="<?php echo $link_view_tags_images; ?>"><span id="clkeyword"><?php echo $object->name; ?></span></a>”
                                (<?php echo $countimages; ?>)
                                <i class="fa fa-angle-right"></i></span>
                            </h2>
                        </div>
                        <div class="row">
...
<footer>
    <div class="container">
        <div class="row">
            <?php $v154270530650635623031iterator = $listCategory_footer; $v154270530650635623031incr = 0; $v154270530650635623031loop = new stdClass(); $v154270530650635623031loop->length = count($v154270530650635623031iterator); $v154270530650635623031loop->index = 1; $v154270530650635623031loop->index0 = 1; $v154270530650635623031loop->revindex = $v154270530650635623031loop->length; $v154270530650635623031loop->revindex0 = $v154270530650635623031loop->length - 1; ?><?php foreach ($v154270530650635623031iterator as $index => $itemFooterMenu) { ?><?php $v154270530650635623031loop->first = ($v154270530650635623031incr == 0); $v154270530650635623031loop->index = $v154270530650635623031incr + 1; $v154270530650635623031loop->index0 = $v154270530650635623031incr; $v154270530650635623031loop->revindex = $v154270530650635623031loop->length - $v154270530650635623031incr; $v154270530650635623031loop->revindex0 = $v154270530650635623031loop->length - ($v154270530650635623031incr + 1); $v154270530650635623031loop->last = ($v154270530650635623031incr == ($v154270530650635623031loop->length - 1)); ?>
                <?php if ($index % 5 == 0) { ?>
                    <div class="col-md-2 col-sm-3 col-xs-6">
                    <ul class="list1">
                <?php } ?>
                <li><a href="<?php echo $itemFooterMenu['link']; ?>"><?php echo $itemFooterMenu['title']; ?></a></li>
                <?php if ($index % 5 == 4 || $v154270530650635623031loop->last) { ?>
                    </ul>
                    </div>
                <?php } ?>
            <?php $v154270530650635623031incr++; } ?>
